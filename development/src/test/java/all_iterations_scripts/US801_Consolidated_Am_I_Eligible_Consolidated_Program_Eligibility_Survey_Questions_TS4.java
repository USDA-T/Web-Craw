...
public class US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS4 {
	public WebDriver mydriver;
	String MyUrl;
	String NAICS;

	@Before
	public void US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS4_Setup()
			throws Exception {
		mydriver = new FirefoxDriver();
		//       https://staging-certify.sba.gov/
	...
	@Test
	public void US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS4_MainTest()
			throws Exception {
		...
		System.out.println(
				"User is NOT eligible for Any of the programs (Due to NO for Qs3) 8(a), WOSB, EDWOSB & Hob-zone");
		...
		if (mydriver.getPageSource().contains("Is the firm organized for profit")) {
			...
			Thread.sleep(4000);
			mydriver.findElement(By.xpath(".//*[@id='for_profit']/div[1]/div[1]/div/button[2]")).click();
	...
	@After
	public void US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS4_End_Test()
			throws Exception {
		mydriver.quit();
	}
