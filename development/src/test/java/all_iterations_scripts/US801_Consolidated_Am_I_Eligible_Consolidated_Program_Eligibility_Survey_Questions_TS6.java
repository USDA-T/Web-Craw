...
public class US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS6 {
	public WebDriver mydriver;
	String MyUrl;
	String NAICS;

	@Before
	public void US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS6_Setup()
			throws Exception {
	...
	@Test
	public void US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS6_MainTest()
			throws Exception {
		...
		System.out.println(
				"User is NOT eligible for Any of the programs (Due to NO for Qs5) 8(a), WOSB, EDWOSB & Hob-zone");
		...
		if (mydriver.getPageSource().contains("Does the firm have a place of business in the U.S.")) {
			...
			Thread.sleep(4000);
			mydriver.findElement(By.xpath(".//*[@id='us_business']/div[1]/div[1]/div/button[2]")).click();
	...
	@After
	public void US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS6_End_Test()
			throws Exception {
		mydriver.quit();
	}
