...
public class US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS9 {
	...
	public void US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS9_MainTest()
		...
		if (mydriver.getPageSource().contains("Are the qualifying individual")) {
			...
			Thread.sleep(4000);
			mydriver.findElement(By.xpath(".//*[@id='women_owning_business']/div[1]/div[1]/div/button[1]")).click();
			Thread.sleep(3000);
			...
			if (mydriver.getPageSource().contains("Are the qualifying individual")) {
				...
				mydriver.findElement(
						By.xpath(".//*[@id='economically_disadvantaged_wosb']/div[1]/div[1]/div/button[1]")).click();
			} else {
		...
		if (mydriver.getPageSource().contains("interested in participating in SBA small")) {
			...
			Thread.sleep(4000);
			mydriver.findElement(By.xpath(".//*[@id='economically_disadvantaged_8a']/div[1]/div[1]/div/button[1]"))
					.click();
			Thread.sleep(3000);

			Thread.sleep(4000);
			// Locate the 11th question and select yes and verify the More
			// Detail meaning of the question.
			...
			if (mydriver.getPageSource().contains("Do you identify as one of the following")) {
				...
				More_Details_Qs13 = mydriver
						.findElement(By.xpath(".//*[@id='socially_disadvantaged']/div[1]/div[2]/p[1]")).getText();
				System.out.println("The Detail meaning for question 13th is" + More_Details_Qs13);
				Thread.sleep(4000);
				mydriver.findElement(By.xpath(".//*[@id='socially_disadvantaged']/div[1]/div[1]/div/button[1]"))
						.click();
			} else {
			...
			if (mydriver.getPageSource().contains("Do you consider yourself socially disadvantaged because")) {
				...
				More_Details_Qs14 = mydriver
						.findElement(By.xpath(".//*[@id='socially_disadvantaged_chronic']/div[1]/div[2]/p[1]"))
						.getText();
				System.out.println("The Detail meaning for question 14th is" + More_Details_Qs14);
				Thread.sleep(4000);
				mydriver.findElement(By.xpath(".//*[@id='socially_disadvantaged_chronic']/div[1]/div[1]/div/button[1]"))
						.click();
			} else {
				System.out.println("14th question was Not validated Error");
			}
			Thread.sleep(4000);
			// Locate the next question (13) and select NO and verify the More
			// Detail meaning of the question.
			...
			if (mydriver.getPageSource().contains("Has the firm previously been certified as an")) {
				...
				More_Details_Qs15 = mydriver.findElement(By.xpath(".//*[@id='eighta_certified']/div[1]/div[2]"))
						.getText();
			...
			Thread.sleep(4000);
			// Locate the next question (14) and select NO and verify the More
			// Detail meaning of the question.

			if (mydriver.getPageSource().contains("claiming social and economic")) {
				System.out.println("Claiming EDWOSB question was validated");
				String More_Details;
				More_Details = mydriver.findElement(By.xpath(".//*[@id='eighta_one_time_used']/div[1]/div[2]"))
						.getText();
			...
			Thread.sleep(4000);
			// Locate the next question (15) and select YES and verify the More
			// Detail meaning of the question.
			...
			if (mydriver.getPageSource().contains("Is the firm�s business address located in a HUBZone")) {
				...
				System.out.println("The Detail meaning for question 15th is" + More_Details);
				Thread.sleep(4000);
				mydriver.findElement(By.xpath(".//*[@id='address_in_hubzone']/div[1]/div[1]/div/button[1]")).click();
			} else {
				System.out.println("question was Not validated Error");
			}

			Thread.sleep(4000);
			// Locate the next question (16) and select Yes and verify the More
			// Detail meaning of the question.

			if (mydriver.getPageSource().contains("Do 35% or more of the firm�s employees reside in a HUBZone")) {
				System.out.println(" question was validated");
				String More_Details;
				More_Details = mydriver.findElement(By.xpath(".//*[@id='employees_in_hubzone']/div[1]/div[2]"))
						.getText();
				System.out.println("The Detail meaning for question 15th is" + More_Details);
				Thread.sleep(4000);
				mydriver.findElement(By.xpath(".//*[@id='employees_in_hubzone']/div[1]/div[1]/div/button[1]")).click();
			} else {
				System.out.println("question was Not validated Error");
			}
			...
			Thread.sleep(4000);
			String actual_Text4 = mydriver.findElement(By.cssSelector("div.eligible > p > b")).getText();
			String expected_Text4 = "Based on the information you provided, you may be eligible for the WOSB Program.";
