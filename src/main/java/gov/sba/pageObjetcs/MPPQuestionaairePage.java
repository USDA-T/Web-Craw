...
public class MPPQuestionaairePage {
    ...
    public static void answers_8a_Questioannaire(WebDriver webDriver, String YesNo)
        throws Exception {
        // Elements Tags:
        if (!YesNo.equals(null) && !YesNo.equals("")) {
            switch (YesNo.toLowerCase()) {
                ...
                case "no":
                    ...
                    break;
                case "assert_no":
                    assertFalse(find_Element(webDriver, "MPP_8a_No").getAttribute("outerHTML").toLowerCase().contains("checked"));
                    click_Element(webDriver, "MPP_8a_No");
                    click_Element(webDriver, "Application_Common_Submit_Button");
                    break;
                case "assert_yes":
                    assertFalse(find_Element(webDriver, "MPP_8a_yes").getAttribute("outerHTML").toLowerCase().contains("checked"));
                    click_Element(webDriver, "MPP_8a_Yes");
                    click_Element(webDriver, "Application_Common_Submit_Button");
                    break;
            }
    ...
    public static void eligibilityPage(WebDriver webDriver, String EYesNO, String MPYesNO,String DAYesNo, String  MEYesNo)
        throws Exception {
        //
        try {
            if (!EYesNO.equals(null) && !EYesNO.equals("")) {
                switch (EYesNO.toLowerCase()) {
                    ...
                    case "no":
                        ...
                        break;
                    case "assert_no":
                        assertFalse(find_Element(webDriver, "MPP_Eligibility_No").getAttribute("outerHTML").toLowerCase().contains("checked"));
                        click_Element(webDriver, "MPP_Eligibility_No");
                        break;
                    case "assert_yes":
                        assertFalse(find_Element(webDriver, "MPP_Eligibility_Yes").getAttribute("outerHTML").toLowerCase().contains("checked"));
                        click_Element(webDriver, "MPP_Eligibility_Yes");
                        break;
                }
            }
            if (!MPYesNO.equals(null) && !MPYesNO.equals("")) {
                switch (MPYesNO.toLowerCase()) {
                    ...
                    case "no":
                        ...
                        break;
                    case "assert_yes":
                        assertFalse(find_Element(webDriver, "MPP_MentorProfit_Yes").getAttribute("outerHTML").toLowerCase().contains("checked"));
                        click_Element(webDriver, "MPP_MentorProfit_Yes");
                        break;
                    case "assert_no":
                        assertFalse(find_Element(webDriver, "MPP_MentorProfit_No").getAttribute("outerHTML").toLowerCase().contains("checked"));
                        click_Element(webDriver, "MPP_MentorProfit_No");
                        break;
                }
            }
            if (!DAYesNo.equals(null) && !DAYesNo.equals("")) {
                switch (DAYesNo.toLowerCase()) {
                    ...
                    case "no":
                        ...
                        break;
                    case "assert_yes":
                        assertFalse(find_Element(webDriver, "MPP_Determination_Affiliation_Yes").getAttribute("outerHTML").toLowerCase().contains("checked"));
                        click_Element(webDriver, "MPP_Determination_Affiliation_Yes");
                        break;
                    case "assert_no":
                        assertFalse(find_Element(webDriver, "MPP_Determination_Affiliation_No").getAttribute("outerHTML").toLowerCase().contains("checked"));
                        click_Element(webDriver, "MPP_Determination_Affiliation_No");
                        break;
                }
            }
            if (!MEYesNo.equals(null) && !MEYesNo.equals("")) {
                switch (MEYesNo.toLowerCase()) {
                    ...
                    case "no":
                        ...
                        break;
                    case "assert_yes":
                        assertFalse(find_Element(webDriver, "MPP_Mentor_Equityinterest_yes").getAttribute("outerHTML").toLowerCase().contains("checked"));
                        click_Element(webDriver, "MPP_Mentor_Equityinterest_yes");
                        break;
                    case "assert_no":
                        assertFalse(find_Element(webDriver, "MPP_Mentor_Equityinterest_No").getAttribute("outerHTML").toLowerCase().contains("checked"));
                        click_Element(webDriver, "MPP_Mentor_Equityinterest_No");
                        break;
    ...
    public static void select_NALCS_Code(WebDriver webDriver, String workNaicsYesNo,String smallNaicsYesNo)
        throws Exception {
        try {
    ...
    public static void size_ReDetermination(WebDriver webDriver, String sizeReDeterminationYesNo) throws Exception {
        try {
            // Elements Tags:
    ...
    public static void reDetermination_Info(WebDriver webDriver)
        throws Exception {
        try {
            // Elements Tags:
            generic_file_Upld(webDriver);
    ...
    public static void training(WebDriver webDriver)
        throws Exception {
        try {
            // Elements Tags:
            generic_file_Upld(webDriver);
    ...
    public static void activeAgreement(WebDriver webDriver)
        throws Exception {
        try {
            // Elements Tags:
    ...
    public static void activeAgreementDcoument(WebDriver webDriver)
        throws Exception {
        try {
            // Elements Tags:
            generic_file_Upld(webDriver);
    ...
    public static void mppAgreementDcoument(WebDriver webDriver)
        throws Exception {
        try {
            // Elements Tags:
            generic_file_Upld(webDriver);
    ...
    public static void determination_Needs_Page(WebDriver webDriver, String MTYesNo,String FAYesNo,String CAYes
        ,String  INTYesNo,String BDYesNo, String GAYesNo)
        throws Exception {
        try {
            // Elements Tags:
    ...
    public static void Financial_Needs(WebDriver webDriver,String Text)
        throws Exception {
        try {
            // Elements Tags:
    ...
    public static void Contracting_Needs(WebDriver webDriver,String Text)
        throws Exception {
        try {
            // Elements Tags:
    ...
    public static void Intl_Trade_Needs(WebDriver webDriver,String Text)
        throws Exception {
        try {
            // Elements Tags:
    ...
    public static void Business_Development_Needs(WebDriver webDriver,String Text)
        throws Exception {
        try {
            // Elements Tags:
    ...
    public static void mpp_training(WebDriver webDriver)
        throws Exception {
        try {
            // Elements Tags:
            generic_file_Upld(webDriver);
    ...
    public static void mpp_BusinessInfo(WebDriver webDriver,String MentorDunsNO)
        throws Exception {
        try {
            // Elements Tags:
