...
public class Contributor8aSpouseSubapplicationPage {
  ...
  public static void spousesubapp_Gender_Info_Page(WebDriver webDriver, String which_Gender)
    ...
    try {
      ...
      if (!which_Gender.equals(null) && !which_Gender.equals("")) {
        switch (which_Gender) {
          case "Male":
            new Select(find_Element(webDriver, "8a_spouse_Gender")).selectByIndex(1);
            break;
          case "Female":
            new Select(find_Element(webDriver, "8a_spouse_Gender")).selectByIndex(2);
            break;
        }
  ...
  public static void spousesubapp_MaritalStatus_Page(WebDriver webDriver, String which_Status)
    ...
    if (!which_Status.equals(null) && !which_Status.equals("")) {
      switch (which_Status) {
        case "UnMarried":
          click_Element(webDriver, "8a_spouse_Status_Unmarried");
          break;
        case "Married":
          click_Element(webDriver, "8a_spouse_Status_Married");
          break;
        case "LegallySeperated":
          click_Element(webDriver, "8a_spouse_Status_LegallySeperated");
          break;
  ...
  public static void spousesubapp_SocialSecNum_Page(WebDriver webDriver, String ssntext)
    ...
    setText_Element(webDriver, "8a_spouse_Social_Security_Number", ssntext);
    click_Element(webDriver, "Application_Common_Continue_Button");
  }
  ...
  public static void spousesubapp_Role_Appl_firm_Page(WebDriver webDriver, String which_value)
    ...
    if (!which_value.equals(null) && !which_value.equals("")) {
      switch (which_value.toLowerCase()) {
        case "yes":
          click_Element(webDriver, "8a_Spouse_Role_Appl_Firm_Yes");
          break;
        case "no":
          click_Element(webDriver, "8a_Spouse_Role_Appl_Firm_No");
          break;
      }
      click_Element(webDriver, "Application_Common_Continue_Button");
    }
  ...
  public static void spousesubapp_LengthofResidency_Page(WebDriver webDriver, String which_value)
    ...
    if (!which_value.equals(null) && !which_value.equals("")) {
      switch (which_value.toLowerCase()) {
        case "yes":
          click_Element(webDriver, "8a_spouse_length_of_Residency_yes");
          break;
        case "no":
          click_Element(webDriver, "8a_spouse_length_of_Residency_no");
          break;
      }
      click_Element(webDriver, "Application_Common_Continue_Button");
    }
  ...
  public static void spousesubapp_DateandPlaceofBirth_Page(WebDriver webDriver, String DtofBirth,
    ...
    // page
    setText_Element(webDriver, "8a_spouse_DateofBirth", DtofBirth);
    setText_Element(webDriver, "8a_spouse_PlaceofBirth", Place);
    new Select(find_Element(webDriver, "8a_spouse_CountryofBirth")).selectByValue(Country);
    click_Element(webDriver, "Application_Common_Continue_Button");
  }
  ...
  public static void spousesubapp_Us_Citizenship_Page(WebDriver webDriver, String which_value)
    ...
    if (!which_value.equals(null) && !which_value.equals("")) {
      switch (which_value.toLowerCase()) {
        case "yes":
          click_Element(webDriver, "8a_spouse_US_Citizenship_yes");
          new newMppUploadDocumentPageDeepa(webDriver)
              .deepaUploadMppDocument(fixturesDir() + "Upload.pdf");
          break;
        case "no":
          click_Element(webDriver, "8a_spouse_US_citizenship_no");
          break;
      }
      click_Element(webDriver, "Application_Common_Continue_Button");
    }
  ...
  public static void spousesubapp_Resident_Alien_Page(WebDriver webDriver, String which_value)
    ...
    if (!which_value.equals(null) && !which_value.equals("")) {
      switch (which_value.toLowerCase()) {
        case "yes":
          click_Element(webDriver, "8a_spouse_Resident_Alien_yes");
          new newMppUploadDocumentPageDeepa(webDriver)
              .deepaUploadMppDocument(fixturesDir() + "Upload.pdf");
          break;
        case "no":
          click_Element(webDriver, "8a_spouse_Resident_Alien_no");
          break;
      }
      click_Element(webDriver, "Application_Common_Continue_Button");
    }
  ...
  public static void spousesubapp_Appl_Firm_Ownership_Page(WebDriver webDriver,
    ...
    setText_Element(webDriver, "8a_spouse_Firm_Owner_Percent", firm_Name_Percent);
    setText_Element(webDriver, "8a_spouse_Firm_All_Positions", positons);
    click_Element(webDriver, "Application_Common_Continue_Button");
  }
  ...
  */
   ...
   * String which_value) throws Exception { // Elements
   * Tags: @contributor_spouse_SubApp_Household_Federal Employment Page if
   * (!which_value.equals(null) && !which_value.equals("")) {
   * 
   * switch (which_value.toLowerCase()) { case "yes": click_Element(webDriver,
   * "8a_spouse_Household_Federal_Employment_Yes"); new newMppUploadDocumentPageDeepa(webDriver)
   * .deepaUploadMppDocument(fixturesDir() + "Upload.pdf"); break; case "no":
   * click_Element(webDriver, "8a_spouse_Household_Federal_Employment_No"); break; }
   * click_Element(webDriver, "Application_Common_Continue_Button"); } }
   */
  ...
  public static void spousesubapp_criminal_Hist_Doc_Page(WebDriver webDriver) throws Exception {
    ...
    try {
      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up1_Add_Req");
      Thread.sleep(1500);
      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up1_Add_Req_Upload");
      Thread.sleep(1500);
      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up1_Add_Req_Choose");
      Thread.sleep(1500);
      doUpload_Action();

      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up2_Add_Req:");
      Thread.sleep(1500);
      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up2_Add_Req_Upload");
      Thread.sleep(1500);
      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up2_Add_Req_Choose");
      Thread.sleep(1500);
      doUpload_Action();

      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up3_Add_Req");
      Thread.sleep(1500);
      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up3_Add_Req_Upload");
      Thread.sleep(1500);
      click_Element(webDriver, "8a_spouse_CrimHistDoc_Up3_Add_Req_Choose");
      Thread.sleep(1500);
      doUpload_Action();
      click_Element(webDriver, "Application_Common_Continue_Button");
  ...
  public static void spousesubapp_Basic_Of_Disadvantage_Page(WebDriver webDriver, String Option,
    ...
    new Select(find_Element(webDriver, "8a_spouse_Basic_Of_DisAdv_Sel")).selectByValue(Option);
    setText_Element(webDriver, "8a_spouse_Basic_Of_DisAdv_Text", Text);
    click_Element(webDriver, "Application_Common_Continue_Button");
  }
  ...
  public static void spousesubapp_Transfer_Assets_Page(WebDriver webDriver, String yesNo,
    ...
    try {
      ...
      switch (yesNo) {
        case "Yes":
          click_Element(webDriver, "8a_spouse_Transfer Assets_Yes");
          setText_Element(webDriver, "8a_spouse_Transfer Assets_Yes_Text", "Text");
          break;
        case "no":
          click_Element(webDriver, "8a_spouse_Transfer Assets_No");
          break;
      }
      click_Element(webDriver, "Application_Common_Continue_Button");
    } catch (Exception e) {
