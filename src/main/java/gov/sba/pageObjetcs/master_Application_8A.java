...
public class master_Application_8A {
    ...
    private static final Logger logger =
            LogManager.getLogger(master_Application_8A.class.getName());
    ...
    public static void BasicEligiblity_General_Assessment_Page(WebDriver webDriver, String ProfileYesNo, String BrokenYesNo, String RevenueYesNo, String CitizenYesNo, String DBANameYesNo) throws Exception {
        try {
            ...
            Thread.sleep(1200);// Sleep Needed here as elements are dynamically moving by the time we click any button
            ...
            Thread.sleep(1200);// Sleep Needed here as elements are dynamically moving by the time we click any buttonbutton
            ...
            if (!DBANameYesNo.equals(null) && !DBANameYesNo.equals("")) {
                switch (DBANameYesNo.toLowerCase()) {
                    case "yes":
                        ...
                        setText_Element(webDriver, "BasicEligibility_General_Assessment_DBA_Name_Yes_Comment", "QA Testing");
                        break;
                    case "no":
    ...
    public static void BasicEligiblity_Prior_8a_Involvement_Page(WebDriver webDriver, String PartcipantYesNo, String SubmittedYesNo, String AssetYesNo) throws Exception {
        try {
