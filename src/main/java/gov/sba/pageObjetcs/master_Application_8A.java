...
public class master_Application_8A {
    ...
    public static void BasicEligiblity_General_Assessment_Page(WebDriver webDriver, String ProfileYesNo,
            String BrokenYesNo, String RevenueYesNo, String CitizenYesNo, String DBANameYesNo) throws Exception {
        try {
            // Elements tag: @8a_Initial_Program Basic Eligiblity -General
            // Assessment
            ...
            Thread.sleep(1200);// Sleep Needed here as elements are dynamically
                               // moving by the time we click any button
            ...
            Thread.sleep(1200);// Sleep Needed here as elements are dynamically
                               // moving by the time we click any buttonbutton
    ...
    public static void BasicEligiblity_Prior_8a_Involvement_Page(WebDriver webDriver, String PartcipantYesNo,
            String SubmittedYesNo, String AssetYesNo) throws Exception {
        try {
            // Elements tag: @8a_Initial_Program Basic Eligiblity-Prior 8(a)
            // Involvement
            if (!PartcipantYesNo.equals(null) && !PartcipantYesNo.equals("")) {
                switch (PartcipantYesNo.toLowerCase()) {
                case "yes":
                    click_Element(webDriver, "BasicEligibility_Prior_8a_Involvement_Program_Participant_Yes");
                    break;
                case "no":
                    click_Element(webDriver, "BasicEligibility_Prior_8a_Involvement_Program_Participant_No");
                    break;
                }
            }
            Thread.sleep(1200);// Sleep Needed here as elements are dynamically
            ...
            if (!SubmittedYesNo.equals(null) && !SubmittedYesNo.equals("")) {
                ...
                case "yes":
                    ...
                    setText_Element(webDriver, "BasicEligibility_Prior_8a_InvolvementSubmitted_Yes_Comment", "QA");
                    break;
                case "no":
    ...
    public static void BasicEligiblity_Business_Size_Page(WebDriver webDriver, String NAICSYesNo, String SizeYesNo)
            throws Exception {
        try {
            // Elements tag: @8a_Initial_Program Basic Eligiblity-Prior 8(a)
            // Involvement
    ...
    public static void BasicEligiblity_Size_Determination_Page(WebDriver webDriver) throws Exception {
        try {
            ...
            Thread.sleep(1500);
            click_Element(webDriver, "BasicEligibility_Size_Add_Req_Upload");
            Thread.sleep(1500);
