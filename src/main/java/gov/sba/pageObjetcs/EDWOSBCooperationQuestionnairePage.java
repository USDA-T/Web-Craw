...
public class EDWOSBCooperationQuestionnairePage {
  private static final Logger logger =
      LogManager.getLogger(EDWOSBCooperationQuestionnairePage.class.getName());

  public static void Edwosb_Questionnaire_8a_Page(WebDriver webDriver, String yesno)
      throws Exception {
  ...
  public static void Edwosb_Questionnaire_ThridParty_Page(WebDriver webDriver, String yesno)
      throws Exception {
  ...
  public static void Edwosb_Questionnaire_ChangeEligiblity_Page(WebDriver webDriver, String yesno)
      throws Exception {
  ...
  public static void Edwosb_Questionnaire_NonQualification_Page(WebDriver webDriver, String yesno)
      throws Exception {
  ...
  public static void Edwosb_Questionnaire_CitizenShip_Page(WebDriver webDriver, String yesno)
      throws Exception {
  ...
  public static void Edwosb_Questionnaire_SBAExam_Page(WebDriver webDriver, String yesno)
      throws Exception {
  ...
  public static void Edwosb_Questionnaire_AdjustedGrossIncome_Page(WebDriver webDriver,
      String yesno, String agiexYesNoNa) throws Exception {
  ...
  public static void Edwosb_Questionnaire_EconomicDisadvantage_Page(WebDriver webDriver,
