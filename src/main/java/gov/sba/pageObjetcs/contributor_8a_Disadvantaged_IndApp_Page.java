...
public class contributor_8a_Disadvantaged_IndApp_Page {
        ...
        private static final Logger logger =
                LogManager.getLogger(gov.sba.pageObjetcs.contributor_8a_Disadvantaged_IndApp_Page.class.getName());




        public static void disAdvApp_Gender_Info_Page(WebDriver webDriver, String which_Gender) throws Exception {
            try {
                //  Elements Tags: @vendor_Admin_8a_DisAdv_Application_Page_Gender
                if (!which_Gender.equals(null) && !which_Gender.equals("")) {
                    switch (which_Gender) {
                        case "Male":
                            new Select(find_Element(webDriver, "8a_DisApp_Gender"))
                                    .selectByIndex(1);
                            break;
                        case "Female":
                            new Select(find_Element(webDriver, "8a_DisApp_Gender"))
        ...
        public static void  disAdvApp_MaritalStatus_Page(WebDriver webDriver, String which_Status) throws Exception {
        ...
        public static void disAdvApp_SocialSecNum_Page(WebDriver webDriver, String ssntext) throws Exception {
        ...
        public static void disAdvApp_ContactInfo_Page(WebDriver webDriver, String cotactinfo) throws Exception {
        ...
        public static void disAdvApp_CuurentHomeAddress_Page(WebDriver webDriver, String StreetAdd, String CityAdd, String State, String Zip, String Contry, String Date) throws Exception {
            ...
            new Select(find_Element(webDriver, "8a_DisAdv_Page_State"))
                    .selectByValue(State);
            setText_Element(webDriver, "8a_DisAdv_Page_Zip", Zip);
            new Select(find_Element(webDriver, "8a_DisAdv_Page_country"))
        ...
        public static void disAdvApp_LengthofResidency_Page(WebDriver webDriver, String which_value) throws Exception {
        ...
        public static void disAdvApp_DateandPlaceofBirth_Page(WebDriver webDriver, String DtofBirth, String Place, String Country) throws Exception {
            ...
            new Select(find_Element(webDriver, "8a_DisAdv_Application_Page_country"))
                    .selectByValue(Country);
            click_Element(webDriver, "Application_Common_Continue_Button");
        }

        public static void disAdvApp_Us_Citizenship_Page(WebDriver webDriver, String which_value) throws Exception {
    ...
    public static void disAdvApp_UploadResume_Page(WebDriver webDriver) throws Exception {
        ...
        try {
            click_Element(webDriver, "8a_DisAdv_UpdResume_Up1_Add_Req");
            Thread.sleep(1500);
            click_Element(webDriver, "8a_DisAdv_UpdResume_Up1_Add_Req_Upload");
            Thread.sleep(1500);
            click_Element(webDriver, "8a_DisAdv_UpdResume_Up1_Add_Req_Choose");
            Thread.sleep(1500);
            doUpload_Action();
            click_Element(webDriver, "Application_Common_Continue_Button");
        } catch (Exception e) {
        ...
        public static void disAdvApp_Appl_Firm_Ownership_Page(WebDriver webDriver, String firm_Name_Percent, String positons) throws Exception {
        ...
        public static void disAdvApp_Bank_Acct_Access_Page(WebDriver webDriver, String yesOrNO, String textVal) throws Exception {
        ...
        public static void disAdvApp_Full_Time_Devotion_Page(WebDriver webDriver, String which_value) throws Exception {
        ...
        public static void disAdvApp_Business_Affiliations_Page(WebDriver webDriver, String ans1, String ans2, String ans2Text) throws Exception {
            ...
            if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("")) {
                ...
                switch (ans2.toLowerCase()) {
                    case "yes":
                        ...
                        setText_Element(webDriver, "8a_DisAdv_Business_Affiliation_RelationOwnContract_Yes_Text", ans2Text);
                        break;
                    case "no":
        ...
        public static void disAdvApp_8a_Prior_Involvement_Page(WebDriver webDriver, String ans1, String ans2, String ans3) throws Exception {
            ...
            if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("") && !ans3.equals(null) && !ans3.equals("")) {
                ...
                switch (ans3) {
                    case "yes":
                        click_Element(webDriver, "8a_DisAdv_Priro_8a_Involvement_Owned_ever_owned_Yes");
                        break;
                    case "no":
        ...
        public static void disAdvApp_8a_Federal_Employment_Page(WebDriver webDriver, String which_value) throws Exception {
        ...
        public static void disAdvApp_8a_Household_Federal_Employment_Page(WebDriver webDriver, String which_value) throws Exception {
        ...
        public static void disAdvApp_8a_Financial_Page(WebDriver webDriver, String ans1, String ans2, String ans3, String ans4) throws Exception {
            //  Elements Tags: @vendor_Admin_8a_Prior 8a Involvement Page Page
            if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("") && !ans3.equals(null) && !ans3.equals("") && !ans3.equals(null) && !ans3.equals("")) {
                ...
                switch (ans3) {
                    case "yes":
                        click_Element(webDriver, "8a_DisAdv_Priro_8a_pending_civil_lawsuit_Yes");
                        break;
                    case "no":
                ...
                switch (ans4) {
                    case "yes":
                        click_Element(webDriver, "8a_DisAdv_Priro_8a_paying_Yes");
                        break;
                    case "no":
        ...
        public static void disAdvApp_8a_Criminal_History_Page(WebDriver webDriver, String ans1, String ans1_Text, String ans2, String ans3, String ans4) throws Exception {
            //  Elements Tags: @vendor_Admin_8a_Prior 8a Involvement Page Page
            if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("") && !ans3.equals(null) && !ans3.equals("") && !ans3.equals(null) && !ans3.equals("")) {
                switch (ans1) {
                    case "yes":
                ...
                switch (ans3) {
                    case "yes":
                        click_Element(webDriver, "8a_DisAdv_Priro_8a_criminal_Offense_Yes");
                        break;
                    case "no":
                ...
                switch (ans4) {
                    case "yes":
                        click_Element(webDriver, "8a_DisAdv_Priro_8a_criminal_Violations_Yes");
                        break;
                    case "no":
        ...
        public static void disAdvApp_criminal_Hist_Doc_Page(WebDriver webDriver) throws Exception {
            ...
            try {
                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up1_Add_Req");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up1_Add_Req_Upload");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up1_Add_Req_Choose");
                Thread.sleep(1500);
                doUpload_Action();

                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up2_Add_Req");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up2_Add_Req_Upload");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up2_Add_Req_Choose");
                Thread.sleep(1500);
                doUpload_Action();

                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up3_Add_Req");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up3_Add_Req_Upload");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_CrimHistDoc_Up3_Add_Req_Choose");
                Thread.sleep(1500);
                doUpload_Action();
                click_Element(webDriver, "Application_Common_Continue_Button");
        ...
        public static void disAdvApp_Basic_Of_Disadvantage_Page(WebDriver webDriver, String Option, String Text) throws Exception {

            new Select(find_Element(webDriver, "8a_DisAdv_Basic_Of_DisAdv_Sel"))
        ...
        public static void disAdvApp_Social_Narrative_Page(WebDriver webDriver) throws Exception {
            ...
            try {
                click_Element(webDriver, "8a_DisAdv_Social_Narrative_Up1_Add_Req");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_Social_Narrative_Up1_Add_Req_Upload");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_Social_Narrative_Up1_Add_Req_Choose");
                Thread.sleep(1500);
                doUpload_Action();
                click_Element(webDriver, "Application_Common_Continue_Button");
        ...
        public static void disAdvApp_Transfer_Assets_Page(WebDriver webDriver, String yesNo, String Text) throws Exception {
            try {
        ...
        public static void disAdvApp_Tax_Returns_Page(WebDriver webDriver) throws Exception {
            //  Elements Tags: @vendor_Admin_8a_Social_Narrative
            try {
                click_Element(webDriver, "8a_DisAdv_Tax_Returns_Up1_Add_Req");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_Tax_Returns_Up1_Add_Req_Upload");
                Thread.sleep(1500);
                click_Element(webDriver, "8a_DisAdv_Tax_Returns_Up1_Add_Req_Choose");
                Thread.sleep(1500);
                doUpload_Action();
                click_Element(webDriver, "Application_Common_Continue_Button");
        ...
        /*public static void disAdvApp_FinancialData_AddPerson(WebDriver webDriver, String FName, String LName, String Title, String Ssn, String MartialSt, String Email, String City, String Address, String State, String Postal, String Co, String HPhone, String BPhone) throws Exception {
        ...
        public static void disAdvApp_FinancialData_Legally_Separted(WebDriver webDriver, String YesNo) throws Exception {
            ...
            try {
                if (!YesNo.equals(null) && !YesNo.equals("")) {
                    switch (YesNo) {
                        case "Yes":
                            click_Element(webDriver, "8a_DisAdv_financial_Legally_Separted_Yes");
                            click_Element(webDriver, "8a_DisAdv_financial_Legally_Separted_Add_Req");
                            Thread.sleep(1500);
                            click_Element(webDriver, "8a_DisAdv_financial_Legally_Separted_Upload");
                            Thread.sleep(1500);
                            click_Element(webDriver, "8a_DisAdv_financial_Legally_Separted_Choose");
                            Thread.sleep(1500);
                            doUpload_Action();
                            break;
                        case "No":
                            click_Element(webDriver, "8a_DisAdv_financial_Legally_Separted_No");
                            break;
                    }
                    click_Element(webDriver, "Application_Common_Continue_Button");
                }
      ...
      */
        public static void disAdvApp_financial_CashOnHand_Page(WebDriver webDriver, String Date, String Currency, String SavingBal, String CheckingBal) throws Exception {
            try {
        ...
        public static void disAdvApp_financial_OtherSource_Page(WebDriver webDriver, String Salary, String OtherIncome, String OthIncText, String AppFirm, String EquityFirm) throws Exception {
            try {
                //  Elements Tags: @vendor_Admin_8a_financial_CashOnHand Page
        ...
        public static void disAdvApp_financial_Notes_Receivable_Page(WebDriver webDriver, String YesNo) throws Exception {
            try {
                //  Elements Tags: @vendor_Admin_8a_DisAdv_Application_Page_Gender
                if (!YesNo.equals(null) && !YesNo.equals("")) {
                    switch (YesNo) {
                        case "Yes":
                            click_Element(webDriver, "8a_DisAdv_financial_Notes Receivable_Yes");
                            ...
                            break;
                        case "No":
                            click_Element(webDriver, "8a_DisAdv_financial_Notes Receivable_No");
                            break;
                    }
                    click_Element(webDriver, "Application_Common_Continue_Button");
                }
        ...
        public static void disAdvApp_financial_Retirement_Account_Page(WebDriver webDriver, String IRAYesNo, String OTHYesNo) throws Exception {
            try {
                ...
                if (!IRAYesNo.equals(null) && !IRAYesNo.equals("")) {
                    switch (IRAYesNo) {
                        case "Yes":
                            click_Element(webDriver, "8a_DisAdv_financial_Notes Receivable_Yes");
                            click_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts__IRA_New_Button");
                            new Select(find_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_Type")).selectByIndex(1);
                            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_TotVal", "9999");
                            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_Contributions", "100");
                            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_Date_Of_InCon", "05/31/2017");
                            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_Name_Of_InvCom", "ABC");
                            click_Element(webDriver, "Application_Common_Create_button");
                            new newMppUploadDocumentPageDeepa(webDriver).deepaUploadMppDocument(fixturesDir() + "Upload.pdf");
                            break;
                        case "No":
                            click_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_No");
                            break;
                    }
                }
                ...
                if (!OTHYesNo.equals(null) && !OTHYesNo.equals("")) {
                    switch (OTHYesNo) {
                        case "Yes":
                            click_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_Yes");
                            new Select(find_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_Type")).selectByIndex(1);
                            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_TotalValue", "9999");
                            click_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_New_Button");
                            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_Name_Of_InvCom", "100");
                            click_Element(webDriver, "Application_Common_Create_button");
                            new newMppUploadDocumentPageDeepa(webDriver).deepaUploadMppDocument(fixturesDir() + "Upload.pdf");
                            break;
                        case "No":
                            click_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_ No");
                            break;
                    }
                }
                click_Element(webDriver, "Application_Common_Continue_Button");
        ...
        public static void disAdvApp_financial_Life_Insurance_Page(WebDriver webDriver, String PolicyYesNo, String LoanesNo) throws Exception {
            try {
                //  Elements Tags: @vendor_Admin_8a_financial_Retirement Accounts #Do you have a Roth IRA?
                if (!PolicyYesNo.equals(null) && !PolicyYesNo.equals("")) {
                    switch (PolicyYesNo) {
                        case "Yes":
                            ...
                            setText_Element(webDriver, "8a_DisAdv_financial_Life_Insurance_Policy_Beneficiaries", "XYZ");
                            click_Element(webDriver, "Application_Common_Create_button");
                            break;
                        case "No":
        ...
        public static void disAdvApp_financial_StocksAndBonds_Page(WebDriver webDriver, String YesNo) throws Exception {
            try {
                //  Elements Tags: @vendor_Admin_8a_financial_Retirement Accounts #Do you have a Roth IRA?
                if (!YesNo.equals(null) && !YesNo.equals("")) {
                    switch (YesNo) {
                        case "Yes":
                            ...
                            new Select(find_Element(webDriver, "8a_DisAdv_financial_StockandBonds_Type")).selectByIndex(1);
                            ...
                            setText_Element(webDriver, "8a_DisAdv_financial_StockandBonds_Date", "05/31/2017");
        ...
        public static void disAdvApp_financial_RealEstate_Page(WebDriver webDriver, String YesNo, String JointOwnedYesNo, String MortageNameYesNo, String ndMortageYesNo, String ndMortageNameYesNo, String IncomeYesNo) throws Exception {
            try {
                ...
                if (!YesNo.equals(null) && !YesNo.equals("")) {
                    switch (YesNo) {
                        case "Yes":
                            ...
                            if (!JointOwnedYesNo.equals(null) && !JointOwnedYesNo.equals("")) {
                                switch (JointOwnedYesNo) {
                                    case "Yes":
                                        ...
                                        setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Percentage_Ownership", "100");
                                        setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Percentage_Mortage", "10");
                                        break;
                                    case "No":
                            ...
                            setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Current_Residence_Val", "11111");
                            setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Mortage_Balance_Val", "111");
                                    ...
                                    case "Yes":
                                        ...
                                        if (!ndMortageNameYesNo.equals(null) && !ndMortageNameYesNo.equals("")) {
                                            switch (ndMortageNameYesNo) {
                                                case "Yes":
                                                    click_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Name_2nd_Mortgage_Yes");
                                                    setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Percentage_2nd_Mortgage", "11");
                                                    setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_CurrBal_2nd_Mortgage", "1111");
                                                    break;
                                                case "No":
                                                    click_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Name_2nd_Mortgage_No");
                                            }
                                        }
                                        break;
                                    case "No":
        ...
        public static void disAdvApp_financial_RealEstateOther_Page(WebDriver webDriver, String YesNo, String OthJointOwnedYesNo, String OthMortageNameYesNo, String OthndMortageYesNo, String OthndMortageNameYesNo, String OthIncomeYesNo) throws Exception {
            try {
                ...
                if (!YesNo.equals(null) && !YesNo.equals("")) {
                    switch (YesNo) {
                        case "Yes":
                            ...
                            new Select(find_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_Type")).selectByIndex(1);
                            ...
                            if (!OthJointOwnedYesNo.equals(null) && !OthJointOwnedYesNo.equals("")) {
                                switch (OthJointOwnedYesNo) {
                                    case "Yes":
                                        ...
                                        setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_Percentage_RealEstate", "100");
                                        break;
                                    case "No":
                            ...
                            setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_Percentage_Mortage", "11");
                                    ...
                                    case "Yes":
                                        ...
                                        if (!OthndMortageNameYesNo.equals(null) && !OthndMortageNameYesNo.equals("")) {
                                            switch (OthndMortageNameYesNo) {
                                                case "Yes":
                                                    click_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_Name_2nd_Mortgage_Yes");
                                                    setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_Percentage_2nd_Mortgage", "11");
                                                    setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_CurrBal_2nd_Mortgage", "1111");
                                                    break;
                                                case "No":
                                                    click_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_Name_2nd_Mortgage_No");
                                            }
                                        }
                                        break;
                                    case "No":
                            ...
                            if (!OthIncomeYesNo.equals(null) && !OthIncomeYesNo.equals("")) {
                                switch (OthIncomeYesNo) {
                                    case "Yes":
                                        ...
                                        setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_Income_Val", "1000");
                                        break;
                                    case "No":
        ...
        public static void disAdvApp_financial_Personal_Property_Page(WebDriver webDriver, String PersonalYesNo, String OthPersonalYesNo) throws Exception {
            try {
                //  Elements Tags: @vendor_Admin_8a_financial_Retirement Accounts #Do you have a Roth IRA?
                if (!PersonalYesNo.equals(null) && !PersonalYesNo.equals("")) {
                    switch (PersonalYesNo) {
                        case "Yes":
                            ...
                            setText_Element(webDriver, "8a_DisAdv_financial_Personal_Property_DescAss", "10ToT2010");
                            click_Element(webDriver, "Application_Common_Create_button");
                            break;
                        case "No":
                ...
                if (!OthPersonalYesNo.equals(null) && !OthPersonalYesNo.equals("")) {
                    switch (OthPersonalYesNo) {
                        case "Yes":
                            ...
                            setText_Element(webDriver, "8a_DisAdv_financial_Oth_Personal_Property_DescAss", "10ToT2012");
                            click_Element(webDriver, "Application_Common_Create_button");
                            break;
                        case "No":
        ...
        public static void disAdvApp_financial_NotesPayableandOther_Page(WebDriver webDriver, String YesNo) throws Exception {
            try {
                ...
                if (!YesNo.equals(null) && !YesNo.equals("")) {
                    switch (YesNo) {
                        case "Yes":
                            ...
                            click_Element(webDriver, "8a_DisAdv_financial_NotesPayable_OtherLiabilities_New_Button");
                            new Select(find_Element(webDriver, "8a_DisAdv_financial_NotesPayable_OtherLiabilities_Type")).selectByIndex(1);
                            setText_Element(webDriver, "8a_DisAdv_financial_NotesPayable_OtherLiabilities_OrgBal", "100");
                            setText_Element(webDriver, "8a_DisAdv_financial_NotesPayable_OtherLiabilities_CurrBal", "1000");
                            setText_Element(webDriver, "8a_DisAdv_financial_NotesPayable_OtherLiabilities_Amount", "1000");
                            setText_Element(webDriver, "8a_DisAdv_financial_NotesPayable_OtherLiabilities_Collateral", "100");
                            setText_Element(webDriver, "8a_DisAdv_financial_NotesPayable_OtherLiabilities_Noteholder", "1000");
                            setText_Element(webDriver, "8a_DisAdv_financial_NotesPayable_OtherLiabilities_Addressholder", "1000");
                            click_Element(webDriver, "Application_Common_Create_button");
                            break;
                        case "No":
        ...
        public static void disAdvApp_financial_Assessed_Taxes_Page(WebDriver webDriver, String YesNo) throws Exception {
            try {
                ...
                if (!YesNo.equals(null) && !YesNo.equals("")) {
                    switch (YesNo) {
                        case "Yes":
                            ...
                            setText_Element(webDriver, "8a_DisAdv_financial_Assessed_Taxes_Whendue", "05/31/2017");
                            click_Element(webDriver, "Application_Common_Create_button");
                            break;
                        case "No":
        ...
        public static void disAdvApp_financial_PersonalSummary_Page(WebDriver webDriver) throws Exception {
        ...
        public static void disAdvApp_financial_PrivacyStatements_Page(WebDriver webDriver) throws Exception {
            try { /*  Elements Tags: Application_Common_Continue_Button*/
                click_Element(webDriver, "Application_Common_Continue_Button");
            } catch (Exception e) {
                logger.info(e.toString());
