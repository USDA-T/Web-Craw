        ...
        switch (IRAYesNo) {
          case "Yes":
            ...
            new Select(find_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_Type"))
                .selectByIndex(1);
            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_TotVal",
                "9999");
            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_Contributions",
                "100");
            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_Date_Of_InCon",
                "05/31/2017");
            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_IRA_Name_Of_InvCom",
                "ABC");
            click_Element(webDriver, "Application_Common_Create_button");
            new newMppUploadDocumentPageDeepa(webDriver)
                .deepaUploadMppDocument(fixturesDir() + "Upload.pdf");
      ...
      if (!OTHYesNo.equals(null) && !OTHYesNo.equals("")) {
        switch (OTHYesNo) {
          case "Yes":
            ...
            new Select(find_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_Type"))
                .selectByIndex(1);
            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_TotalValue",
                "9999");
            click_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_New_Button");
            setText_Element(webDriver, "8a_DisAdv_financial_Retirement Accounts_OTH_Name_Of_InvCom",
                "100");
            click_Element(webDriver, "Application_Common_Create_button");
            new newMppUploadDocumentPageDeepa(webDriver)
                .deepaUploadMppDocument(fixturesDir() + "Upload.pdf");
