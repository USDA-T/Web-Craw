...
public class EDWOSBFinancialDataSection {
    private static final Logger logger = LogManager.getLogger(EDWOSBFinancialDataSection.class.getName());
    ...
    public static void edwosb_financial_Retirement_Account_Page(WebDriver webDriver,
                ...
                switch (IRAYesNo) {
                    case "Yes":
                       click_Element(webDriver, "EDWOSB_financial_Page_Ans_372_Y");
                        ...
                        setText_Element(webDriver, "EDWOSB_financial_Retirement_Accounts_IRA_TotVal",
                            "9999");
                        setText_Element(webDriver, "EDWOSB_financial_Retirement_Accounts_IRA_Contributions",
                            "100");
                        WebElement aa = find_Element(webDriver,
                            "EDWOSB_financial_Retirement_Accounts_IRA_Date_Of_InCon");
                        aa.clear();
    ...
    public static void edwosb_financial_Life_Insurance_Page(WebDriver webDriver,
                ...
                switch (YesNo) {
                    case "Yes":
                        ...
                        setText_Element(webDriver, "EDWOSB_financial_Real_Estate_Current_Residence_Val",
                            "11111");
                        setText_Element(webDriver, "EDWOSB_financial_Real_Estate_Mortage_Balance_Val",
                            "111");
            ...
            if (!YesNo.equals(null) && !YesNo.equals("")) {
                switch (YesNo) {
                    case "Yes":
                        ...
                        setText_Element(webDriver, "EDWOSB_financial_Real_Estate_Oth_Percentage_Mortage",
                            "11");
                        ...
                        if (!OthIncomeYesNo.equals(null) && !OthIncomeYesNo.equals("")) {
                            switch (OthIncomeYesNo) {
                                case "Yes":
                                    ...
                                    setText_Element(webDriver, "EDWOSB_financial_Real_Estate_Oth_Income_Val",
                                        "1000");
                                    break;
                                case "No":
            ...
            if (!PersonalYesNo.equals(null) && !PersonalYesNo.equals("")) {
                switch (PersonalYesNo) {
                    case "Yes":
                        ...
                        setText_Element(webDriver, "EDWOSB_financial_Personal_Property_DescAss",
                            "10ToT2010");
                        click_Element(webDriver, "Application_Common_Create_button");
                        Thread.sleep(2000);
                        break;
    ...
    public static void edwosb_financial_NotesPayableandOther_Page(WebDriver webDriver,
            ...
            if (!YesNo.equals(null) && !YesNo.equals("")) {
                switch (YesNo) {
                    case "Yes":
                        ...
                        click_Element(webDriver,
                            "EDWOSB_financial_NotesPayable_OtherLiabilities_New_Button");
                        new Select(
                        ...
                        setText_Element(webDriver, "EDWOSB_financial_NotesPayable_OtherLiabilities_Amount",
                            "1000");
                        setText_Element(webDriver,
                            "EDWOSB_financial_NotesPayable_OtherLiabilities_Collateral", "100");
                        setText_Element(webDriver,
                            "EDWOSB_financial_NotesPayable_OtherLiabilities_Noteholder", "1000");
                        setText_Element(webDriver,
    ...
    public static void edwosb_financial_PersonalSummary_Page(WebDriver webDriver)
        throws Exception {
    ...
    public static void edwosb_financial_PrivacyStatements_Page(WebDriver webDriver)
        throws Exception {
        try { /* Elements Tags: Application_Common_Continue_Button */
            click_Element(webDriver, "Application_Common_Continue_Button");
        } catch (Exception e) {
