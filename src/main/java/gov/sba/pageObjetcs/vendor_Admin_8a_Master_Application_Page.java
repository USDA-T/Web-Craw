...
public class vendor_Admin_8a_Master_Application_Page {
    ...
    private static final Logger logger = LogManager.getLogger(vendor_Admin_8a_Master_Application_Page.class.getName());
    ...
    public static void masterApp_Gender_Info_Page(WebDriver webDriver, String which_Gender) throws Exception {
        try {
            ...
            if (!which_Gender.equals(null) && !which_Gender.equals("")) {
                switch (which_Gender) {
                case "Male":
                    new Select(find_Element(webDriver, "8a_MasterApp_Gender")).selectByIndex(1);
                    break;
                case "Female":
                    new Select(find_Element(webDriver, "8a_MasterApp_Gender")).selectByIndex(2);
                    break;
                }
    ...
    public static void masterApp_MaritalStatus_Page(WebDriver webDriver, String which_Status) throws Exception {
        // Elements Tags:
        // @vendor_Admin_8a_Master_Application_Page_martial_Status
    ...
    public static void masterApp_SocialSecNum_Page(WebDriver webDriver, String ssntext) throws Exception {
        // Elements Tags:
        // @vendor_Admin_8a_Master_Application_Page_Social_Secuirty_Number Page
    ...
    public static void masterApp_ContactInfo_Page(WebDriver webDriver, String cotactinfo) throws Exception {
        // Elements Tags: @vendor_Admin_8a_Master_Application_Page_ContactInfo
        // Page
        setText_Element(webDriver, "8a_Master_Application_Page_ContactInfo", cotactinfo);
        click_Element(webDriver, "Application_Common_Continue_Button");
    }

    public static void masterApp_CuurentHomeAddress_Page(WebDriver webDriver, String StreetAdd, String CityAdd,
            String State, String Zip, String Contry, String Date) throws Exception {
        // Elements Tags:
        // @vendor_Admin_8a_Master_Application_Page_CurrentHomeAddress Page
    ...
    public static void masterApp_LengthofResidency_Page(WebDriver webDriver, String which_value) throws Exception {
        // Elements Tags: @vendor_Admin_8a_Master_Application_Page_length of
        // Residency
    ...
    public static void masterApp_DateandPlaceofBirth_Page(WebDriver webDriver, String DtofBirth, String Place,
            String Country) throws Exception {
        // Elements Tags: @vendor_Admin_8a_Master_Application_Page_Date and
        // palce of Birth page
        setText_Element(webDriver, "8a_MasterApp_DateofBirth", DtofBirth);
        setText_Element(webDriver, "8a_MasterApp_PlaceofBirth", Place);
        new Select(find_Element(webDriver, "8a_Master_Application_Page_country")).selectByValue(Country);
        click_Element(webDriver, "Application_Common_Continue_Button");
    }

    public static void masterApp_Us_Citizenship_Page(WebDriver webDriver, String which_value) throws Exception {
        // Elements Tags: @vendor_Admin_8a_Master_Application_US Citizenship
        // Page
        if (!which_value.equals(null) && !which_value.equals("")) {
            switch (which_value.toLowerCase()) {
            case "yes":
    ...
    public static void masterApp_Appl_Firm_Ownership_Page(WebDriver webDriver, String firm_Name_Percent,
            String positons) throws Exception {
    ...
    public static void masterApp_Bank_Acct_Access_Page(WebDriver webDriver, String yesOrNO, String textVal)
            throws Exception {
    ...
    public static void masterApp_Business_Affiliations_Page(WebDriver webDriver, String ans1, String ans2,
            String ans2Text) throws Exception {
    ...
    public static void masterApp_8a_Prior_Involvement_Page(WebDriver webDriver, String ans1, String ans2, String ans3)
            throws Exception {
        // Elements Tags: @vendor_Admin_8a_Prior 8a Involvement Page Page
        if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("") && !ans3.equals(null)
                && !ans3.equals("")) {
            switch (ans1) {
            case "yes":
    ...
    public static void masterApp_8a_Household_Federal_Employment_Page(WebDriver webDriver, String which_value)
            throws Exception {
    ...
    public static void masterApp_8a_Financial_Page(WebDriver webDriver, String ans1, String ans2, String ans3,
            String ans4) throws Exception {
        // Elements Tags: @vendor_Admin_8a_Prior 8a Involvement Page Page
        if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("") && !ans3.equals(null)
                && !ans3.equals("") && !ans3.equals(null) && !ans3.equals("")) {
            switch (ans1) {
            case "yes":
    ...
    public static void masterApp_8a_Criminal_History_Page(WebDriver webDriver, String ans1, String ans1_Text,
            String ans2, String ans3, String ans4) throws Exception {
        // Elements Tags: @vendor_Admin_8a_Prior 8a Involvement Page Page
        if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("") && !ans3.equals(null)
                && !ans3.equals("") && !ans3.equals(null) && !ans3.equals("")) {
            switch (ans1) {
    ...
    public static void masterApp_Basic_Of_Disadvantage_Page(WebDriver webDriver, String Option, String Text)
            throws Exception {

        new Select(find_Element(webDriver, "8a_MasterApp_Basic_Of_DisAdv_Sel")).selectByValue(Option);
    ...
    public static void masterApp_FinancialData_AddPerson(WebDriver webDriver, String FName, String LName, String Title,
            String Ssn, String MartialSt, String Email, String City, String Address, String State, String Postal,
            String Co, String HPhone, String BPhone) throws Exception {
    ...
    public static void masterApp_financial_CashOnHand_Page(WebDriver webDriver, String Date, String Currency,
            String SavingBal, String CheckingBal) throws Exception {
        try {
    ...
    public static void masterApp_financial_OtherSource_Page(WebDriver webDriver, String Salary, String OtherIncome,
            String OthIncText, String AppFirm, String EquityFirm) throws Exception {
        try {
            // Elements Tags: @vendor_Admin_8a_financial_CashOnHand Page
    ...
    public static void masterApp_financial_Retirement_Account_Page(WebDriver webDriver, String IRAYesNo,
            String OTHYesNo) throws Exception {
        try {
            // Elements Tags: @vendor_Admin_8a_financial_Retirement Accounts #Do
            // you have a Roth IRA?
    ...
    public static void masterApp_financial_Life_Insurance_Page(WebDriver webDriver, String PolicyYesNo, String LoanesNo)
            throws Exception {
        try {
            // Elements Tags: @vendor_Admin_8a_financial_Retirement Accounts #Do
            // you have a Roth IRA?
    ...
    public static void masterApp_financial_RealEstate_Page(WebDriver webDriver, String YesNo, String JointOwnedYesNo,
            String MortageNameYesNo, String ndMortageYesNo, String ndMortageNameYesNo, String IncomeYesNo)
            throws Exception {
        try {
                        ...
                        case "Yes":
                            ...
                            if (!ndMortageNameYesNo.equals(null) && !ndMortageNameYesNo.equals("")) {
                                ...
                                case "Yes":
                                    ...
                                    setText_Element(webDriver, "8a_Master_financial_Real_Estate_CurrBal_2nd_Mortgage",
                                            "1111");
                                    break;
                                case "No":
    ...
    public static void masterApp_financial_RealEstateOther_Page(WebDriver webDriver, String YesNo,
                ...
                case "Yes":
                    ...
                    if (!OthJointOwnedYesNo.equals(null) && !OthJointOwnedYesNo.equals("")) {
                        ...
                        case "Yes":
                            ...
                            setText_Element(webDriver, "8a_Master_financial_Real_Estate_Oth_Percentage_RealEstate",
                                    "100");
                            break;
                        case "No":
    ...
    public static void masterApp_financial_Personal_Property_Page(WebDriver webDriver, String PersonalYesNo,
            String OthPersonalYesNo) throws Exception {
        try {
            // Elements Tags: @vendor_Admin_8a_financial_Retirement Accounts #Do
            // you have a Roth IRA?
    ...
    public static void masterApp_financial_NotesPayableandOther_Page(WebDriver webDriver, String YesNo)
            throws Exception {
        try {
            // Elements Tags: @vendor_Admin_8a_financial_Notes Payable and Other
            // Liabilities
            if (!YesNo.equals(null) && !YesNo.equals("")) {
                switch (YesNo) {
                case "Yes":
                    ...
                    new Select(find_Element(webDriver, "8a_Master_financial_NotesPayable_OtherLiabilities_Type"))
                            .selectByIndex(1);
                    ...
                    setText_Element(webDriver, "8a_Master_financial_NotesPayable_OtherLiabilities_Addressholder",
                            "1000");
                    click_Element(webDriver, "Application_Common_Create_button");
                    break;
                case "No":
