...
public class programs_Page {
    ...
    public static void generic_file_Upld(WebDriver webDriver) throws Exception {
        ...
        try {
            click_Element(webDriver, "File_Up1_Add_Req"); Thread.sleep(800);
            click_Element(webDriver, "File_Up1_Choose_Doc_Library"); Thread.sleep(800);
            click_Element(webDriver, "File_Up1_Choose_Doc"); Thread.sleep(900);
            click_Element(webDriver, "File_Up1_Associate_Button"); Thread.sleep(900);
            click_Element(webDriver, "Application_Common_Submit_Button"); Thread.sleep(900);
        } catch (Exception e) {
            throw e;
        }
    }
    public static void contributor_login(WebDriver webDriver,String FullName, String EmailAddress) throws Exception {
        //  Elements Tags: @Generic file attach-upload
        try {
