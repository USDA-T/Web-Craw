...
public class Contributor8aDisadvantagedIndAppPage {
    ...
    public static void disAdvApp_DateandPlaceofBirth_Page(WebDriver webDriver, String DtofBirth,
        ...
        new Select(find_Element(webDriver, "8a_DisAdv_CountryofBirth"))
    ...
    public static void disAdvApp_financial_Retirement_Account_Page(WebDriver webDriver,
        ...
        try {
            // Elements Tags: @contributor_8a_DisAdv_financial_Retirement Accounts #Do you have a Roth IRA?
                ...
                switch (IRAYesNo) {
                    case "Yes":
                        ...
                        setText_Element(webDriver, "8a_DisAdv_financial_Retirement_Accounts_IRA_Contributions",
                            "100");
                        WebElement aa = find_Element(webDriver, "8a_DisAdv_financial_Retirement_Accounts_IRA_Date_Of_InCon");
                        aa.clear();
            ...
            if (!YesNo.equals(null) && !YesNo.equals("")) {
                switch (YesNo) {
                    case "Yes":
                        ...
                        setText_Element(webDriver, "8a_DisAdv_financial_Real_Estate_Oth_Mortage_Balance_Val", "111");
            ...
            if (!YesNo.equals(null) && !YesNo.equals("")) {
                switch (YesNo) {
                    case "Yes":
                        ...
                        WebElement whenduedate = find_Element(webDriver, "8a_DisAdv_financial_Assessed_Taxes_Whendue");
                        whenduedate.clear();
