...
public class contributor_8a_spouse_subapplication_Page {
    ...
    public static void spousesubapp_Gender_Info_Page(WebDriver webDriver, String which_Gender) throws Exception {
        try {
            //  Elements Tags: @contributor_spouse_SubApp_Master_Application_Page_Gender
            if (!which_Gender.equals(null) && !which_Gender.equals("")) {
                switch (which_Gender) {
                    case "Male":
                        new Select(find_Element(webDriver, "8a_spousesubapp_Gender"))
                                .selectByIndex(1);
                        break;
                    case "Female":
                        new Select(find_Element(webDriver, "8a_spousesubapp_Gender"))
    ...
    public static void spousesubapp_MaritalStatus_Page(WebDriver webDriver, String which_Status) throws Exception {
    ...
    public static void spousesubapp_SocialSecNum_Page(WebDriver webDriver, String ssntext) throws Exception {
    ...
    public static void spousesubapp_ContactInfo_Page(WebDriver webDriver, String cotactinfo) throws Exception {
    ...
    public static void spousesubapp_CuurentHomeAddress_Page(WebDriver webDriver, String StreetAdd, String CityAdd, String State, String Zip, String Contry, String Date) throws Exception {
    ...
    public static void spousesubapp_LengthofResidency_Page(WebDriver webDriver, String which_value) throws Exception {
    ...
    public static void spousesubapp_DateandPlaceofBirth_Page(WebDriver webDriver, String DtofBirth, String Place, String Country) throws Exception {
    ...
    public static void spousesubapp_Us_Citizenship_Page(WebDriver webDriver, String which_value) throws Exception {
    ...
    public static void spousesubapp_Appl_Firm_Ownership_Page(WebDriver webDriver, String firm_Name_Percent, String positons) throws Exception {
    ...
    public static void spousesubapp_Bank_Acct_Access_Page(WebDriver webDriver, String yesOrNO, String textVal) throws Exception {
    ...
    public static void spousesubapp_Full_Time_Devotion_Page(WebDriver webDriver, String which_value) throws Exception {
    ...
    public static void spousesubapp_Business_Affiliations_Page(WebDriver webDriver, String ans1, String ans2, String ans2Text) throws Exception {
        ...
        if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("")) {
            ...
            switch (ans2.toLowerCase()) {
                case "yes":
                    ...
                    setText_Element(webDriver, "8a_spousesubapp_Business_Affiliation_RelationOwnContract_Yes_Text", ans2Text);
                    break;
                case "no":
    ...
    public static void spousesubapp_8a_Prior_Involvement_Page(WebDriver webDriver, String ans1, String ans2, String ans3) throws Exception {
    ...
    public static void spousesubapp_8a_Federal_Employment_Page(WebDriver webDriver, String which_value) throws Exception {
    ...
    public static void spousesubapp_8a_Household_Federal_Employment_Page(WebDriver webDriver, String which_value) throws Exception {
    ...
    public static void spousesubapp_8a_Financial_Page(WebDriver webDriver, String ans1, String ans2, String ans3, String ans4) throws Exception {
        //  Elements Tags: @contributor_spouse_SubApp_Prior 8a Involvement Page Page
    ...
    public static void spousesubapp_8a_Criminal_History_Page(WebDriver webDriver, String ans1, String ans1_Text, String ans2, String ans3, String ans4) throws Exception {
        //  Elements Tags: @contributor_spouse_SubApp_Prior 8a Involvement Page Page
        if (!ans1.equals(null) && !ans1.equals("") && !ans2.equals(null) && !ans2.equals("") && !ans3.equals(null) && !ans3.equals("") && !ans3.equals(null) && !ans3.equals("")) {
            switch (ans1) {
                case "yes":
                    click_Element(webDriver, "8a_spousesubapp_Prior_8a_criminal_Hist_names_Yes");
                    setText_Element(webDriver, "8a_spousesubapp_Prior_8a_criminal_Hist_names_Yes_text", ans1_Text);
                    break;
                case "no":
    ...
    public static void spousesubapp_Basic_Of_Disadvantage_Page(WebDriver webDriver, String Option, String Text) throws Exception {
    ...
    public static void spousesubapp_Transfer_Assets_Page(WebDriver webDriver, String yesNo, String Text) throws Exception {
        try {
    ...
    /*public static void spousesubapp_FinancialData_AddPerson(WebDriver webDriver, String FName, String LName, String Title, String Ssn, String MartialSt, String Email, String City, String Address, String State, String Postal, String Co, String HPhone, String BPhone) throws Exception {

        //  Elements Tags: @contributor_spouse_SubApp_FinancialData Page - EDWOSB
        try {
    ...
    public static void spousesubapp_FinancialData_Legally_Separted(WebDriver webDriver, String YesNo) throws Exception {
   ...
   */
    public static void spousesubapp_financial_CashOnHand_Page(WebDriver webDriver, String Date, String Currency, String SavingBal, String CheckingBal) throws Exception {
        try {
    ...
    public static void spousesubapp_financial_OtherSource_Page(WebDriver webDriver, String Salary, String OtherIncome, String OthIncText, String AppFirm, String EquityFirm) throws Exception {
        try {
            //  Elements Tags: @contributor_spouse_SubApp_financial_CashOnHand Page
    ...
    public static void spousesubapp_financial_Notes_Receivable_Page(WebDriver webDriver, String YesNo) throws Exception {
        try {
            //  Elements Tags: @contributor_spouse_SubApp_Master_Application_Page_Gender
            if (!YesNo.equals(null) && !YesNo.equals("")) {
                switch (YesNo) {
    ...
    public static void spousesubapp_financial_Retirement_Account_Page(WebDriver webDriver, String IRAYesNo, String OTHYesNo) throws Exception {
        try {
            //  Elements Tags: @contributor_spouse_SubApp_financial_Retirement Accounts #Do you have a Roth IRA?
            ...
            //  Elements Tags: @contributor_spouse_SubApp_financial_Retirement Accounts Do you have any other retirement accounts?
    ...
    public static void spousesubapp_financial_Life_Insurance_Page(WebDriver webDriver, String PolicyYesNo, String LoanesNo) throws Exception {
        try {
            //  Elements Tags: @contributor_spouse_SubApp_financial_Retirement Accounts #Do you have a Roth IRA?
    ...
    public static void spousesubapp_financial_StocksAndBonds_Page(WebDriver webDriver, String YesNo) throws Exception {
        try {
            //  Elements Tags: @contributor_spouse_SubApp_financial_Retirement Accounts #Do you have a Roth IRA?
            if (!YesNo.equals(null) && !YesNo.equals("")) {
                switch (YesNo) {
    ...
    public static void spousesubapp_financial_RealEstate_Page(WebDriver webDriver, String YesNo, String JointOwnedYesNo, String MortageNameYesNo, String ndMortageYesNo, String ndMortageNameYesNo, String IncomeYesNo) throws Exception {
        try {
    ...
    public static void spousesubapp_financial_RealEstateOther_Page(WebDriver webDriver, String YesNo, String OthJointOwnedYesNo, String OthMortageNameYesNo, String OthndMortageYesNo, String OthndMortageNameYesNo, String OthIncomeYesNo) throws Exception {
        try {
    ...
    public static void spousesubapp_financial_Personal_Property_Page(WebDriver webDriver, String PersonalYesNo, String OthPersonalYesNo) throws Exception {
        try {
            //  Elements Tags: @contributor_spouse_SubApp_financial_Retirement Accounts #Do you have a Roth IRA?
    ...
    public static void spousesubapp_financial_NotesPayableandOther_Page(WebDriver webDriver, String YesNo) throws Exception {
        try {
    ...
    public static void spousesubapp_financial_Assessed_Taxes_Page(WebDriver webDriver, String YesNo) throws Exception {
        try {
    ...
    public static void spousesubapp_financial_PersonalSummary_Page(WebDriver webDriver) throws Exception {
    ...
    public static void spousesubapp_financial_PrivacyStatements_Page(WebDriver webDriver) throws Exception {
        try { /*  Elements Tags: Application_Common_Continue_Button*/
            click_Element(webDriver, "Application_Common_Continue_Button");
        } catch (Exception e) {
            logger.info(e.toString());
