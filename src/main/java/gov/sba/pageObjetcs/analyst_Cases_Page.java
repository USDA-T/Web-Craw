...
public class analyst_Cases_Page {
    private static final Logger logger_Cases_Page = LogManager.getLogger(analyst_Cases_Page.class.getName());
    ...
    public static void return_DunsNo_Cases_Table(WebDriver webDriver, String which_Duns, String app_Type) throws Exception {
