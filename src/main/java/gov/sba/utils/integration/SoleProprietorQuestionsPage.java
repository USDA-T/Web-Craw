...
public class SoleProprietorQuestionsPage {
    ...
    public void SoleProprietorQuestions() throws Exception {
        try {
            ...
            String actual_Text5 = webDriver.findElement(By.xpath("//div[@id='answers_tpc3_q1']/fieldset/p[2]"))
                    .getText();
            ...
            // questions.
            String actual_Text13 = webDriver.findElement(By.xpath("//div[@id='answers_oper1_q1']/fieldset/p[2]"))
                    .getText();
            ...
            // questions
            String actual_Text15 = webDriver.findElement(By.xpath("//div[@id='answers_oper2_q1']/fieldset/p[2]"))
                    .getText();
            ...
            String actual_Text17 = webDriver.findElement(By.xpath("//div[@id='answers_oper2_q2']/fieldset/p[2]"))
                    .getText();
            ...
            String actual_Text24 = webDriver.findElement(By.xpath("//div[@id='answers_oper3_q1']/fieldset/p[2]"))
                    .getText();
            ...
            // 2nd question meaning.
            String actual_Text26 = webDriver.findElement(By.xpath("//div[@id='answers_oper3_q2']/fieldset/p[2]"))
                    .getText();
            ...
            webDriver.findElement(By.xpath("//div[2]/fieldset/div/label[2]")).click();
            // 3rd question.
            String actual_Text251 = webDriver.findElement(By.cssSelector("#answers_oper4_q1 > fieldset > h4"))
                    .getText();
            ...
            webDriver.findElement(By.xpath("//div[3]/fieldset/div/label[2]")).click();
            // 4th question.
            String actual_Text252 = webDriver.findElement(By.cssSelector("#answers_oper4_q2 > fieldset > h4"))
                    .getText();
            ...
            // 5th question.
            String actual_Text211 = webDriver.findElement(By.cssSelector("#answers_oper5_q2 > fieldset > h4"))
                    .getText();
            ...
            String actual_Text331 = webDriver.findElement(By.cssSelector("#answers_oper6_q2 > fieldset > h4"))
                    .getText();
            ...
            try {
                ...
                // 1st question meaning.
                String actual_Text28 = webDriver.findElement(By.xpath("//div[@id='answers_oper6_q1']/fieldset/p[2]"))
                        .getText();
                ...
                // winged winged fifth man heaven won't it first male saw
                // gathered deep. Abundantly herb it
                // own.
                // Darkness from, created great gathering us called deep
                // abundantly. Divide. So replenish
                // rule
                // together beginning fowl seas light gathering air fill, saw
                // darkness divide doesn't
                // greater
                // fly they're all fly. Shall light from given, place itself for
                // were third. Itself second
                // gathered fruit fromAlso is their earth so. Dry female let
                // doesn't void unto kind. Him two
                // days set green us. Darkness from you'll. Him winged winged
                // fifth man heaven won't it
                // first
                // male saw gathered deep. Abundantly herb it own. Darkness
                // from, created great gathering us
                ...
                // from
                // given, place itself for were third. Itself second gathered
                // fruit from");
                Thread.sleep(2000);
                webDriver.findElement(By.xpath("//input[@name='commit']")).click();
                ...
                String actual_Text38 = webDriver
                        .findElement(By.xpath("//div[@id='answers_woman_has_not_transferred_assets']/fieldset/p[2]"))
                        .getText();
                ...
                String actual_Text334 = webDriver
                        ...
                        .getText();
                String expected_Text334 = "If this situation does not apply, select N/A.";
                ...
                String actual_Text521 = webDriver
                        ...
                        .getText();
                String expected_Text521 = "Please provide the last three (3) Federal Tax Returns Form 1040, schedules, W-2s, and completed IRS FORM 4506-T for the qualifying individual(s) and their spouses.";
                ...
                // Validate that user successfully navigated to the Financial
                // Data
                // section.
                ...
                // Verify that the section to Create new record is been seen by
                // user and
                // enter record2.
                ...
                assertEquals(actual_Text, expected_Text);
                // 1st question meaning.
                String actual_Text19 = webDriver.findElement(By.xpath("//div[@id='answers_oper1_q2']/fieldset/p[2]"))
                        .getText();
                ...
                // 2nd question.
                String actual_Text20 = webDriver.findElement(By.cssSelector("#answers_oper2_q1 > fieldset >h4"))
                        .getText();
                ...
                // 2nd question meaning.
                String actual_Text22 = webDriver.findElement(By.cssSelector("#answers_oper2_q1 > fieldset > h4"))
                        .getText();
                ...
                // 3rd question.
                String actual_Text201 = webDriver.findElement(By.cssSelector("#answers_oper2_q2 > fieldset >h4"))
                        .getText();
                ...
                // 3rd question meaning.
                String actual_Text221 = webDriver.findElement(By.cssSelector("#answers_oper2_q2 > fieldset > h4"))
                        .getText();
                ...
                webDriver.findElement(By.id("answers_265_comment")).sendKeys(
                ...
                // webDriver.findElement(By.id("answers_246_comment")).sendKeys("Also
                // is their earth so. Dry
                // female let doesn't void unto kind. Him two days set green us.
                // Darkness from you'll. Him
                // winged winged fifth man heaven won't it first male saw
                ...
                // Locate the Expertise & Employment questions, Verify, select
                // No for
                // both and continue.
                // 1st question.
                String actual_Text231 = webDriver.findElement(By.cssSelector("h4")).getText();
                String expected_Text231 = "Are the management and daily operations of the business controlled by the qualifying individual(s)?";
                assertEquals(actual_Text231, expected_Text231);
                // 1st question meaning.
                String actual_Text241 = webDriver.findElement(By.xpath("//div[@id='answers_oper3_q1']/fieldset/p[2]"))
                        .getText();
                String expected_Text241 = "Control means that both the long-term decision making and the day-to-day management and administration of the business operations are conducted by the qualifying individuals. Reference: 13 C.F.R. 127.202(a)";
                assertEquals(actual_Text241, expected_Text241);
                webDriver.findElement(By.xpath("//div[1]/fieldset/div/label[2]")).click();
                // 2nd question.
                String actual_Text2511 = webDriver.findElement(By.cssSelector("#answers_oper3_q2 > fieldset > h4"))
                        .getText();
                String expected_Text2511 = "Does the qualifying individual(s) hold the highest officer position in the business and does she have the managerial experience needed to run the business?";
                ...
                assertEquals(actual_Text, expected_Text);
                webDriver.findElement(By.xpath("//div[5]/fieldset/div/label[2]")).click(); // 6th
                                                                                           // question
                                                                                           // meaning.
