  ...
  public void SoleProprietorQuestions() throws Exception {
    try {
      ...
      try {
        ...
        // winged winged fifth man heaven won't it first male saw gathered deep. Abundantly herb it
        // own.
        // Darkness from, created great gathering us called deep abundantly. Divide. So replenish
        // rule
        // together beginning fowl seas light gathering air fill, saw darkness divide doesn't
        // greater
        ...
        // days set green us. Darkness from you'll. Him winged winged fifth man heaven won't it
        // first
        ...
        // gathering air fill, saw darkness divide doesn't greater fly they're all fly. Shall light
        // from
        ...
        expected_Text =
            "Men or other entities may be involved in the management of the business and may be stockholders, partners or limited liability members of the business, provided that no males or other entity exercise actual control or have the power to control the business. Reference: 13 C.F.R. 127.202(g)";
        assertEquals(actual_Text, expected_Text);
        webDriver.findElement(By.xpath("//div[5]/fieldset/div/label[2]")).click(); // 6th question
                                                                                   // meaning.
        actual_Text =
            webDriver.findElement(By.cssSelector("#answers_oper6_q2 > fieldset > h4")).getText();
        expected_Text =
