...
public class ContributorOtherIndividualsQuestionPage extends TestCase {
  ...
  public void ContributorOtherIndividualsQuestion() throws Exception {
      ...
      webDriver.findElement(By.xpath("//form[3]/fieldset/ul/li/input")).sendKeys("Contributor1 SDVD");
      //Enter contributor's email.
      webDriver.findElement(By.xpath("//form[3]/fieldset/ul/li[2]/input")).sendKeys("norole15@mailinator.com");
      ...
      CoreUtils.clickContinue(webDriver);
      assertEquals("8(a) Business Partner section is complete", webDriver.findElement(By.xpath("//article/div/div/div/div/p")).getText());
