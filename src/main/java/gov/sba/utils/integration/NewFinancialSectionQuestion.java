...
public class NewFinancialSectionQuestion {
  ...
  public void NewFinancialQuestion() throws Exception {
    ...
    try {
      ...
      webDriver.findElement(By.xpath("//div[@id='answers_232_details_table_wrapper']/div/a/span"))
          .click();
      logger.info(
      ...
      try {
        ...
        logger.info(
            "User is NOT being navigated to the 'Notes Payable' section on the form 413, Pass");
      }
      Thread.sleep(3000);
      ...
      try {
        ...
        logger
            .info("User successfully navigated to the section 'Assessed Taxes' on Form 413, Pass");
        // Verify and answer YES to question 'Do you have any Assessed
        // Taxes
        // that were unpaid?'.
        try {
          assertTrue(webDriver.getPageSource()
              .contains("Do you have any Assessed Taxes that were unpaid"));
          logger.info(
