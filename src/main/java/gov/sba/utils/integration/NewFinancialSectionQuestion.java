...
public class NewFinancialSectionQuestion {
  ...
  public void NewFinancialQuestion() throws Exception {
    ...
    // as required.
          webDriver.findElement(By.name("answers[195][value]")).sendKeys("01/05/2017");
    ...
    webDriver.findElement(By.xpath("//div[@id='answers_203_details_table_wrapper']/div/a/span")).click();
    logger.info(
    ...
    // insurance.
    webDriver.findElement(By.xpath("//*[@id='answers_206_value_no']")).click();
    webDriver.findElement(By.xpath("//*[@id='answers_207_value_no']")).click();
    Thread.sleep(2000);
    webDriver.findElement(By.xpath("//input[@name='commit']")).click();
    // Select Yes for the Stock and Bonds Section.
    webDriver.findElement(By.xpath("//*[@id='answers_209_value_no']")).click();
    Thread.sleep(2000);
