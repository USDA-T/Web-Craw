...
public class ReturnPendingCert2Page extends TestCase {
  private static final Logger logger = LogManager.getLogger(ReturnPendingCert2Page.class.getName());
  WebDriver webDriver;
  int get_The_Row_From_Login_Data;
  String DunsNumber;

  public ReturnPendingCert2Page(WebDriver webDriver) {
    this.webDriver = webDriver;
    DunsNumber = null;
  }

  public void ReturnPendingCert2() throws Exception {
    ...
    logger.info("Checking for pending now app now.");
