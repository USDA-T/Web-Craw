...
public class ContributorSDvDPage extends TestCase {
	private static final Logger logger = LogManager.getLogger(ContributorSDvDPage.class.getName());
	WebDriver webDriver;
	...
	public ContributorSDvDPage(WebDriver webDriver) {
	...
	public void ContributorSDvD() throws Exception {
		...
		WebElement rateElement3 = webDriver.findElement(By.linkText("Start Application"));
		...
		// Verify section is required.
		CoreUtils.clickContinue(webDriver);
		assertEquals("Please answer this question", webDriver.findElement(By.id("answers_655_value-error")).getText());
