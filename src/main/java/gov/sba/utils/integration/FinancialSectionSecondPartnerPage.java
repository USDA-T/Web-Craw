...
public class FinancialSectionSecondPartnerPage {
  ...
  public void FinancialSectionSecondPartner() throws Exception {
    try {
      ...
      assertEquals(Actual_Text, Expected_Text);
      // Detail Section.
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_edwosb_salary']/fieldset/p"))
          .getText();
      ...
      // Detail Section.
      Actual_Text =
          webDriver.findElement(By.xpath("//div[@id='answers_automobiles']/fieldset/p")).getText();
      Expected_Text =
      ...
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver
          .findElement(By.cssSelector("#answers_other_personal_property > fieldset > p")).getText();
      Expected_Text =
      ...
      WebElement PersonalProperty =
          webDriver.findElement(By.xpath("//div[@id='answers_automobiles']/fieldset/p"));
