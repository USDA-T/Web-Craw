package gov.sba.utils.integration;
	...
	public class SizeAnalystSendsRequestAccessPage extends TestCase {
		private static final Logger logger = LogManager.getLogger(SizeAnalystSendsRequestAccessPage.class.getName());
		WebDriver webDriver;

		public SizeAnalystSendsRequestAccessPage(WebDriver webDriver) {
			this.webDriver = webDriver;
		}

		public void SizeAnalystSendsRequestAccess() throws Exception {
			...
			jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.xpath("//form/button")));
			webDriver.findElement(By.xpath("//form/button")).click();
			// Select Size for Business unit.
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h1")));
			Actual_Text = webDriver.findElement(By.cssSelector("h1")).getText();
			Expected_Text = "What is your business unit?";
			assertEquals(Actual_Text, Expected_Text);
			// Select Cods to verify filtered Duty Station.
			webDriver.findElement(By.xpath("//li/label")).click();
			...
			assertEquals(Actual_Text, Expected_Text);
			// Click the back button and select Size.
