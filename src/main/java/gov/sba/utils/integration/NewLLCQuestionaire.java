...
public class NewLLCQuestionaire {
    ...
    public void NewLlcquestions() throws Exception {
        ...
        Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_8aq1']/fieldset/h4")).getText();
        ...
        // continue.
        Actual_Text = webDriver.findElement(By.xpath("//*[@id='answers_tpc2_q1']/fieldset/h4")).getText();
        ...
        // 2nd
        Actual_Text = webDriver.findElement(By.xpath("//*[@id='answers_oper2_q2']/fieldset/h4")).getText();
        ...
        // 2nd question.
        Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_oper3_q2']/fieldset/h4")).getText();
        ...
        Thread.sleep(2000);
        webDriver.findElement(By.name("commit")).click();
        // check if the certificate is for Wosb - Then Review page should
        // display else if it Edwosb the
        // finanical section should display
        String text = webDriver.findElement(By.xpath("//ul[@class='usa-sidenav-list']/li/a[contains(text(),'Review')]"))
                .getText();
        logger.info(text);
