...
public class NewLLCQuestionaire {
  ...
  WebDriver webDriver;
    ...
    public void NewLLCQuestionaire() throws Exception {
      ...
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_8aq1']/fieldset/h4"))
          .getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_8aq1']/fieldset/p[3]"))
          .getText();
      ...
      String actual_Text = webDriver
          .findElement(By.xpath("//div[@id='answers_tpc1_q1']/fieldset/p[2]")).getText();
      ...
      Actual_Text = webDriver.findElement(By.xpath("//*[@id='answers_tpc2_q1']/fieldset/h4"))
          .getText();
      ...
      Actual_Text = webDriver.findElement(By.cssSelector("#answers_oper1_q2 > fieldset > h4"))
          .getText();
      ...
      //2nd
      Actual_Text = webDriver.findElement(By.xpath("//*[@id='answers_oper2_q2']/fieldset/h4"))
          .getText();
      ...
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_oper3_q1']/fieldset/h4"))
          .getText();
      ...
      // 2nd question.
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_oper3_q2']/fieldset/h4"))
          .getText();
      ...
      Actual_Text = webDriver.findElement(By.xpath("//*[@id='answers_oper4_q1']/fieldset/h4"))
          .getText();
      ...
      Thread.sleep(2000);
      //4th Question
      Actual_Text = webDriver.findElement(By.cssSelector("#answers_oper4_q2 > fieldset > h4"))
          .getText();
      ...
      // 6th question.
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_oper6_q2']/fieldset/p[2]"))
          .getText();
      ...
      Thread.sleep(2000);
      //SBA Exam
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_oper6_q1']/fieldset/p[2]"))
          .getText();
      ...
      try {
        ...
        Thread.sleep(2000);
      webDriver.findElement(By.name("commit")).click();
     // check if the certificate is for Wosb - Then Review page should display else if it Edwosb the finanical section should display
      String text = webDriver.findElement(By.xpath("//ul[@class='usa-sidenav-list']/li/a[contains(text(),'Review')]")).getText();
      logger.info(text);
