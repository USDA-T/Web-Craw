package gov.sba.utils.integration;
  ...
  public class SoleProprietorReturnCertFirstAndSecondPartnerAfterReview1Page extends TestCase {
    private static final Logger logger =
        LogManager.getLogger(SoleProprietorReturnCertFirstAndSecondPartnerAfterReview1Page.class.getName());
    WebDriver webDriver;
    ...
    public void SoleProprietorReturnCertFirstAndSecondPartnerAfterReview1() throws Exception {
      ...
      webDriver.findElement(By.xpath("(//textarea[@id='assessments__note_body'])[20]")).sendKeys("Also is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll.");
      ...
      webDriver.findElement(By.xpath("(//textarea[@id='assessments__note_body'])[11]")).sendKeys("Also is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll.");
      //Click on the save and continue button.
      Thread.sleep(2000);
      webDriver.findElement(By.id("save_notes")).click();
      Thread.sleep(2000);
      ...
      webDriver.findElement(By.xpath("(//textarea[@id='assessments__note_body'])[12]")).sendKeys("Also is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll.");
      //Click on the save and continue button.
      Thread.sleep(2000);
      webDriver.findElement(By.id("save_notes")).click();
      ...
      webDriver.findElement(By.id("note_link")).click();
      Thread.sleep(2000);
      webDriver.findElement(By.xpath("//textarea[@id='assessment_note_body']")).sendKeys("Also is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll.");
      Thread.sleep(2000);
      //Click on the save and continue button.
      ...
      Expected_Text ="Also is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll.";
      assertEquals(Actual_Text, Expected_Text);
      ...
      webDriver.findElement(By.cssSelector("#assessment_note_body")).sendKeys("Also is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll.");
      //Click on the save and continue button.
      webDriver.findElement(By.xpath("//input[@name='commit']")).click();
      Thread.sleep(2000);
