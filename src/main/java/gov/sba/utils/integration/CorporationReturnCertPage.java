...
public class CorporationReturnCertPage extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(CorporationReturnCertPage.class.getName());
  WebDriver webDriver;
  ...
  public void CorporationReturnCert() throws Exception {
    ...
    Expected_Text =
        "By submitting this certification I, Deric Vendor, am an officer or owner of Entity 127 Legal Business Name authorized to represent it and electronically sign this certification on its behalf.";
    assertEquals(Actual_Text, Expected_Text);
