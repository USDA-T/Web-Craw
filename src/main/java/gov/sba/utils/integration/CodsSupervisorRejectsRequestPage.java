...
public class CodsSupervisorRejectsRequestPage extends TestCase {

  private static final Logger logger =
      LogManager.getLogger(CodsSupervisorRejectsRequestPage.class.getName());
  WebDriver webDriver;
  int get_The_Row_From_Login_Data;

  public CodsSupervisorRejectsRequestPage(WebDriver webDriver) {
    this.webDriver = webDriver;
    get_The_Row_From_Login_Data = 70;

  }

  public void CodsSupervisorRejectsRequest() throws Exception {
