...
public class ContributorSpouseOfaDisadvantageIndividualPage extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(ContributorSpouseOfaDisadvantageIndividualPage.class.getName());
  WebDriver webDriver;
  ...
  public void ContributorSpouseOfaDisadvantageIndividual() throws Exception {
    try {
      ...
      wait.until(ExpectedConditions.elementSelectionStateToBe(
          By.linkText("Add a spouse of a Disadvantaged Individual"), false));
      Actual_Text = webDriver.findElement(By.linkText("Add a spouse of a Disadvantaged Individual"))
          .getText();
      ...
      try {
        ...
        webDriver.findElement(By.xpath("//form[2]/fieldset/ul/li/input"))
            .sendKeys("Contributor1 SDVD");
        // Enter contributor's email.
        webDriver.findElement(By.xpath("//form[2]/fieldset/ul/li[2]/input"))
            .sendKeys("norole17@mailinator.com");
