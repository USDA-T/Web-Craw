...
public class ReturnPendingCert3Page extends TestCase {
	private static final Logger logger = LogManager.getLogger(ReturnPendingCert3Page.class.getName());
	WebDriver webDriver;
	int get_The_Row_From_Login_Data;
	String DunsNumber;

	public ReturnPendingCert3Page(WebDriver webDriver) {
		this.webDriver = webDriver;
		DunsNumber = null;
	}

	public void ReturnPendingCert3() throws Exception {
		...
		if (webDriver.getPageSource().contains("Pending")) {
			...
			LoginPageWithReference login_Data711 = new LoginPageWithReference(webDriver, get_The_Row_From_Login_Data);
