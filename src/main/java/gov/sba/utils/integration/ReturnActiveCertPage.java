...
public class ReturnActiveCertPage extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(ReturnActiveCertPage.class.getName());
  WebDriver webDriver;
  int get_The_Row_From_Login_Data;
  String DunsNumber;

  public ReturnActiveCertPage(WebDriver webDriver) {
    this.webDriver = webDriver;
    DunsNumber = null;
  }

  public void ReturnActiveCert() throws Exception {
