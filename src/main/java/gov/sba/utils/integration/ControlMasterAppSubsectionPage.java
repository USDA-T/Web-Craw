...
public class ControlMasterAppSubsectionPage extends TestCase {
	...
	public void ControlMasterAppSubsection() throws Exception {
		...
		// Verify Status.
		Actual_Text = webDriver.findElement(By.xpath("//div[3]/div[2]/section/div/div[2]/table/tbody/tr/td/span"))
				.getText();
		...
		// Expected_Text =
		// "The Federal government relies on the information in the forms and
		// any documents or
		// supplemental information submitted to determine whether your business
		// is eligible to
		// participate in the 8(a) Business Development Program. The definition
		// of important terms are
		// set forth in the Small Business Act, U.S. Small Business
		// Administration (SBA) regulations (13
		// CFR § 124.3), and also any statutory and regulatory provision
		// referenced in those
		// authorities. In addition, please note that the SBA may request
		// further clarification or
		// supporting documentation in order to assist in the verification of
		// any of the information
		// provided and that each person providing information may be prosecuted
		// if they have provided
		...
		Actual_Text = webDriver
				...
				.getText();
		Expected_Text = "The individual claiming disadvantaged status must hold the highest position in the firm and receive the highest pay. References: 13 C.F.R. § 124.106(a)(2) and 13 C.F.R. § 124.106(e)(3)";
		assertEquals(Actual_Text, Expected_Text);
		// 5th question. 1.4e
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[7]/fieldset/div/label[2]")));
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[3]/div[2]/section/div/div[2]/table/tbody/tr/td/span")));
		Actual_Text = webDriver.findElement(By.xpath("//div[3]/div[2]/section/div/div[2]/table/tbody/tr/td/span"))
				.getText();
		Expected_Text = "In progress";
		assertEquals(Actual_Text, Expected_Text);
		WebElement CharacterInProgressStatus1 = webDriver
				.findElement(By.xpath("//div[3]/div[2]/section/div/div[2]/table/tbody/tr/td/span"));
		...
		// question 6, 1.4f with comment.
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[6]/fieldset/div/input")));
		...
		webDriver.findElement(By.xpath("//div[7]/fieldset/div/label")).click();
		// Enter comment.
		...
		assertEquals(Actual_Text, Expected_Text);
		WebElement ControlComplteStatus = webDriver
				.findElement(By.xpath("//div[3]/div[2]/section/div/div[2]/table/tbody/tr/td/span"));
