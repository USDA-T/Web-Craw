package gov.sba.utils.integration;
  ...
  public class ReturnActiveCert3Page extends TestCase {
    private static final Logger logger =
        LogManager.getLogger(ReturnActiveCert3Page.class.getName());
    WebDriver webDriver;
    int get_The_Row_From_Login_Data;
    String DunsNumber;

    public ReturnActiveCert3Page(WebDriver webDriver) {
      this.webDriver = webDriver;
      DunsNumber = null;
    }

    public void ReturnActiveCert3() throws Exception {
