...
public class SubmitAndReviewPage extends TestCase {
	...
	public void SubmitAndReview() throws Exception {
		...
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.id("legal_1")));
		webDriver.findElement(By.id("legal_1")).click();
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.id("legal_2")));
		...
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.id("legal_4")));
		...
		if (webDriver.getPageSource().contains("Return to Vendor")) {
			...
			jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.linkText("EDWOSB Self-Certification")));
			...
			jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.id("form413")));
			...
			wait.until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@id='owners__first_name'])[2]")));
			...
			wait.until(ExpectedConditions.elementToBeClickable(By.id("personal_summary_denzel_washington")));
