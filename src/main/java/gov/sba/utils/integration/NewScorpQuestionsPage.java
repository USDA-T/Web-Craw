...
public class NewScorpQuestionsPage {
	...
	public void NewScorpQuestions() throws Exception {
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[3]/fieldset/div/label[2]")));
		webDriver.findElement(By.xpath("//div[3]/fieldset/div/label[2]")).click(); // 4th
																					// question.
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[4]/fieldset/div/label[2]")));
		webDriver.findElement(By.xpath("//div[4]/fieldset/div/label[2]")).click(); // 5th
																					// question.
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[5]/fieldset/div/label[2]")));
		webDriver.findElement(By.xpath("//div[5]/fieldset/div/label[2]")).click(); // 5th
																					// question.
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[6]/fieldset/div/label[2]")));
		webDriver.findElement(By.xpath("//div[6]/fieldset/div/label[2]")).click(); // 5th
		// question.
		webDriver.findElement(By.xpath("//textarea")).sendKeys(
