package gov.sba.utils.integration;
  ...
  public class NewScorpQuestionsPage {
          ...
          public void NewScorpQuestions() throws Exception {
            ...
            assertEquals(Actual_Text, Expected_Text);
            webDriver.findElement(By.xpath("//div[2]/fieldset/div/label[2]")).click();            Thread.sleep(2000);
            //3rd question.
            ...
            assertEquals(Actual_Text, Expected_Text);
            //select no and continue.
            webDriver.findElement(By.xpath("//div[3]/fieldset/div/label[2]")).click();            Thread.sleep(2000);
            Thread.sleep(2000);
            webDriver.findElement(By.xpath("//input[@name='commit']")).click();
