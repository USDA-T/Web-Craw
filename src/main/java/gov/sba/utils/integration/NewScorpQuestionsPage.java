package gov.sba.utils.integration;
  ...
  public class NewScorpQuestionsPage {
          ...
          public void NewScorpQuestions() throws Exception {
            ...
            webDriver.findElement(By.id("answers_267_comment")).sendKeys("Like any other social media site Facebook has length requirements when it comes to writing on the wall, providing status, messaging and commenting. Understanding how many characters you can use, enables you to more effectively use Facebook as a business or campaign tool");
            Thread.sleep(2000);
            webDriver.findElement(By.xpath("//input[@name='commit']")).click();      
            //==>Citizenship section.
            Actual_Text = webDriver.findElement(By.cssSelector("h4")).getText();
            ...
            webDriver.findElement(By.id("answers_275_comment")).sendKeys("Also is their earth so. Dry given, place itself for were third. Itself second gathered fruit from");
            Thread.sleep(2000);
            webDriver.findElement(By.xpath("//input[@name='commit']")).click();
            //==>Management section.
            Actual_Text = webDriver.findElement(By.cssSelector("h4")).getText();
            ...
            webDriver.findElement(By.id("answers_281_comment")).sendKeys(
            ...
            act4.doubleClick(webDriver.findElement(By.id("answers_291_value_no"))).build().perform();
