...
public class Upload3pdfOnSamePage {
  ...
  public void Upload3pdfOnSame(String upload_Path) throws Exception {
    ...
    if (webDriver.getCurrentUrl().contains("qa.sba-one")) {
      webDriver.findElement(By.xpath("(//a[contains(text(),'Add required documents')])[3]"))
          .click();
      wait.until(
          ExpectedConditions.elementToBeClickable(By.xpath("(//button[@id='doc-lib-button'])[3]")));
      ...
      if (webDriver.getCurrentUrl().contains("http://localhost/")) {
        ...
        wait.until(ExpectedConditions
            .elementToBeClickable(By.xpath("(//button[@id='doc-lib-button'])[3]")));
        webDriver.findElement(By.xpath("(//button[@id='doc-lib-button'])[3]")).click();
        webDriver.findElement(By.xpath("(//input[@id='truth'])[3]")).click();
        Thread.sleep(1000);;
        webDriver.findElement(By.xpath("(//button[@id='document_library_associate'])[3]")).click();
        ...
        act.doubleClick(
            webDriver.findElement(By.xpath("(//a[contains(text(),'Choose a .pdf file')])[3]")))
            .build().perform();
        ...
        robot.keyRelease(KeyEvent.VK_ENTER);
        wait.until(
            ExpectedConditions.elementToBeClickable(By.xpath("(//button[@id='attach'])[3]")));
