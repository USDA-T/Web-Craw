...
public class ScorpReturnCertPage extends TestCase {
	private static final Logger logger = LogManager.getLogger(ScorpReturnCertPage.class.getName());
	WebDriver webDriver;
	int get_The_Row_From_Login_Data;

	public ScorpReturnCertPage(WebDriver webDriver) {
		this.webDriver = webDriver;
	}

	public void ScorpReturnCert() throws Exception {
		...
		Expected_Text = "By submitting this certification I, QA User, am an officer or owner of Entity 37 Legal Business Name authorized to represent it and electronically sign this certification on its behalf.";
		assertEquals(Actual_Text, Expected_Text);
			...
			if (webDriver.getCurrentUrl().contains("staging")) {
				...
				if (webDriver.getCurrentUrl().contains("newqa")) {
					...
					wait.until(ExpectedConditions
							.visibilityOfElementLocated(By.linkText("Entity 37 Legal Business Name")));
					webDriver.findElement(By.linkText("Entity 37 Legal Business Name")).click();
				} else {
