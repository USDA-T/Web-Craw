...
public class ScorpReturnCertPage extends TestCase {
  ...
  public void ScorpReturnCert() throws Exception {
    ...
    Expected_Text =
        "By submitting this certification I, QA User, am an officer or owner of Entity 37 Legal Business Name authorized to represent it and electronically sign this certification on its behalf.";
    assertEquals(Actual_Text, Expected_Text);
