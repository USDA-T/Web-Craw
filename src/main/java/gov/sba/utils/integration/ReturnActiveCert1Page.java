...
public class ReturnActiveCert1Page extends TestCase {
  private static final Logger logger = LogManager.getLogger(ReturnActiveCert1Page.class.getName());
  WebDriver webDriver;
  int get_The_Row_From_Login_Data;
  String DunsNumber;

  public ReturnActiveCert1Page(WebDriver webDriver) {
    this.webDriver = webDriver;
    DunsNumber = null;
  }

  public void ReturnActiveCert1() throws Exception {
