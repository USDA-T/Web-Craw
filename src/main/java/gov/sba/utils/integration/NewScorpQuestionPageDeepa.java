...
public class NewScorpQuestionPageDeepa {
  ...
  public void NewScorpQuestionPageDeepa() throws Exception {
    ...
    // expected_Text = "If the qualifying individual is not currently an 8(a) BD Program
    // Participant, please select “No”. If the qualifying individual was already approved by the
    // 8(a) BD Program and at least 51% of the business is held by women, you are eligible for the
    // WOSB Program as an EDWOSB and you will skip forward to the “Review” section of this
    // application. Please upload your original 8(a) Acceptance Letter and your most recent Annual
    // Review Letter.";
    // assertEquals(actual_Text, expected_Text);
    //
    // //
    ...
    // expected_Text = "If the qualifying individual is both 8(a) and Third-Party Certified, upload
    ...
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_393_setText",
        "QA testing");
    ...
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_399_setText",
        "QA testing");
    CommonApplicationMethods.click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
    ...
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_407_setText",
        "QA testing");
    CommonApplicationMethods.click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
    // Management
    ...
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_413_setText",
        "QA testing");
    CommonApplicationMethods.click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
    // SBA Exam
    ...
    /*
     * Point coordinates =
     * webDriver.findElement(By.xpath("//h2[contains(text(),'Financial Data')]")).getLocation();;
     ...
     * robot.keyPress(KeyEvent.VK_TAB); Thread.sleep(1500); robot.keyPress(KeyEvent.VK_TAB);
     * Thread.sleep(1500); robot.keyPress(KeyEvent.VK_TAB); Thread.sleep(1500);
     */
