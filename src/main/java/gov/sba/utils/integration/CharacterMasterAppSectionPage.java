...
public class CharacterMasterAppSectionPage extends TestCase {
	...
	public void CharacterMasterAppSection() throws Exception {
		...
		// Verify Status.
		Actual_Text = webDriver.findElement(By.xpath("//div[2]/div[2]/section/div/div[2]/table/tbody/tr/td/span"))
				.getText();
		...
		Expected_Text = "If yes, upload details and a copy of the bankruptcy court’s final order or discharge.";
		assertEquals(Actual_Text, Expected_Text);
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[2]/div[2]/section/div/div[2]/table/tbody/tr/td/span")));
		Actual_Text = webDriver.findElement(By.xpath("//div[2]/div[2]/section/div/div[2]/table/tbody/tr/td/span"))
				.getText();
		Expected_Text = "In progress";
		assertEquals(Actual_Text, Expected_Text);
		WebElement CharacterInProgressStatus = webDriver
				.findElement(By.xpath("//div[2]/div[2]/section/div/div[2]/table/tbody/tr/td/span"));
