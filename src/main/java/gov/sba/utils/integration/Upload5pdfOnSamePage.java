...
public class Upload5pdfOnSamePage {
  ...
  public void Upload5pdfOnSame(String upload_Path) throws Exception {
    ...
    if (webDriver.getCurrentUrl().contains("certify.qa")) {
      webDriver.findElement(By.xpath("(//a[contains(text(),'Add required documents')])[5]"))
          .click();
      wait.until(
          ExpectedConditions.elementToBeClickable(By.xpath("(//button[@id='doc-lib-button'])[5]")));
      ...
      if (webDriver.getCurrentUrl().contains("localhost")) {
        ...
        wait.until(ExpectedConditions
            .elementToBeClickable(By.xpath("(//button[@id='doc-lib-button'])[5]")));
        webDriver.findElement(By.xpath("(//button[@id='doc-lib-button'])[5]")).click();
        webDriver.findElement(By.xpath("(//input[@id='truth'])[5]")).click();
        Thread.sleep(1000);;
        webDriver.findElement(By.xpath("(//button[@id='document_library_associate'])[5]")).click();
        ...
        if (webDriver.getCurrentUrl().contains("newqa")) {
          ...
          act.doubleClick(
              webDriver.findElement(By.xpath("(//a[contains(text(),'Choose a .pdf file')])[5]")))
              .build().perform();
          ...
          robot.keyRelease(KeyEvent.VK_ENTER);
          wait.until(
              ExpectedConditions.elementToBeClickable(By.xpath("(//button[@id='attach'])[5]")));
