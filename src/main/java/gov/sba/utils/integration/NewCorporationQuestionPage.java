...
import org.openqa.selenium.interactions.Actions;
  ...
  public class NewCorporationQuestionPage {
      private static final Logger logger = LogManager.getLogger(NewCorporationQuestionPage.class.getName());
      WebDriver webDriver;
  
      public NewCorporationQuestionPage(WebDriver mydriver) {
