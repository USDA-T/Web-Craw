...
public class NewFinancialSectionQuestionDeepa {
  ...
  public void NewFinancialQuestion() throws Exception {
    ...
    CommonApplicationMethods.sendKeys_Element(webDriver, "EDWOSB_financial_Page_Ans_363_setText",
        "01052017");
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_364_setText",
        "2000");
    // Locate the Savings Account(s) Balance Search box
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_365_setText",
        "5000");
    // Locate the Checking Account(s) Balance Search box
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_366_setText",
        "5000");
    ...
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_367_setText",
        "7000");
    // Locate the Other Income search box and enter Other Income.
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_368_setText",
        "0");;
    // Locate the applicant Business Type and enter amount of applicant
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_369_setText",
        "800000");
    // Locate the applicant equity in other firm and enter applicant
    // business equity.
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_370_setText",
        "50000");
    // Locate the continue button and click on it to continue.
    CommonApplicationMethods.click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
    ...
    // valid data.
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_386_SetText",
        "1000");
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_387_SetText",
        "2000");
    CommonApplicationMethods.setText_Element(webDriver, "EDWOSB_financial_Page_Ans_388_SetText",
        "3000");
    // Locate and click on the continue button.
    CommonApplicationMethods.click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
