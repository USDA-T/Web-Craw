...
public class SoleProprietorReturnCertPage extends TestCase {
	private static final Logger logger = LogManager.getLogger(SoleProprietorReturnCertPage.class.getName());
	WebDriver webDriver;
	int get_The_Row_From_Login_Data;

	public SoleProprietorReturnCertPage(WebDriver webDriver) {
		this.webDriver = webDriver;
	}

	public void SoleProprietorReturnCert() throws Exception {
