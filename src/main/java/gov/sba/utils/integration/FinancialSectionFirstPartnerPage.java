...
public class FinancialSectionFirstPartnerPage {
	private static final Logger logger = LogManager.getLogger(FinancialSectionFirstPartnerPage.class.getName());
	...
	public void FinancialSectionFirstPartner() throws Exception {
		...
		String actual_Text6 = webDriver.findElement(By.xpath("//form/h2")).getText();
		...
		String actual_Text1 = webDriver.findElement(By.xpath("//div[2]/h2")).getText();
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[3]/div[14]/button[2]")));
		...
		act4.doubleClick(webDriver.findElement(By.xpath("//div/label"))).build().perform();
		// Locate the Continue Button and click on it to continue.
		// Upload document.
		file_path_abs = FixtureUtils.fixturesDir() + "MainTestUploadDoc.pdf";
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.id("personal_summary_denzel_washington")));
		webDriver.findElement(By.id("personal_summary_denzel_washington")).click();
		CoreUtils.clickContinue(webDriver);
		String actual_Text111 = webDriver.findElement(By.xpath("//div[2]/h2")).getText();
