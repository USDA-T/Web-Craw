...
public class FinancialSectionPage {
    ...
    public void Financialsection() throws Exception {
        ...
        webDriver.findElement(By.id("answers_48_1_3_value")).sendKeys("45");
        webDriver.findElement(By.id("answers_48_1_4_value")).sendKeys("45");
        ...
        webDriver.findElement(By.id("answers_48_1_6_value")).sendKeys("45");
        ...
        webDriver.findElement(By.id("answers_49_value_yes")).click();
        Thread.sleep(2000);
        webDriver.findElement(By.id("add_real_estate")).click();
        Thread.sleep(3000);
        webDriver.findElement(By.id("answers_50_1_1_value")).sendKeys("4000000");
        ...
        webDriver.findElement(By.id("answers_50_1_6_value")).sendKeys("450000");
        webDriver.findElement(By.id("answers_50_1_7_value")).sendKeys("4700000");
