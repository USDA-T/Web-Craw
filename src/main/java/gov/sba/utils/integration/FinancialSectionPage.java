...
public class FinancialSectionPage extends TestCase {
	...
	public void Financialsection() throws Exception {
		...
		String actual_Text2 = webDriver.findElement(By.xpath("//article/h2")).getText();
		...
		String actual_Text4 = webDriver.findElement(By.xpath("//article/div/h2")).getText();
