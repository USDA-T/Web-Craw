...
public class FinancialSectionPage {
  ...
  public void Financialsection() throws Exception {
    ...
    // as required.
    webDriver.findElement(By.id("date-195")).sendKeys("01/26/2017");
    // Locate the Cash on Hand Search box for Pual Washington and enter the
    // information as required.
    webDriver.findElement(By.xpath(".//*[@id='answers_196_value']")).sendKeys("2000");
    // Locate the Savings Account(s) Balance Search box for Pual Washington
    // and enter the information as required.
    webDriver.findElement(By.xpath(".//*[@id='answers_197_value']")).sendKeys("5000");
    // Locate the Checking Account(s) Balance Search box for Pual Washington
    // and enter the information as required.
    webDriver.findElement(By.xpath(".//*[@id='answers_198_value']")).sendKeys("45000");
    ...
    webDriver.findElement(By.xpath(".//*[@id='answers_199_value']")).sendKeys("70000");
    // Locate the Other Income search box and enter Other Income.
    webDriver.findElement(By.xpath(".//*[@id='answers_200_value']")).sendKeys("80000");
    // Locate the applicant Business Type and enter amount of applicant
    // equity.
    webDriver.findElement(By.xpath(".//*[@id='answers_201_value']")).sendKeys("800000");
    // Locate the applicant equity in other firm and enter applicant
    // business equity.
    webDriver.findElement(By.xpath(".//*[@id='answers_202_value']")).sendKeys("50000");
    // Locate the continue button and click on it to continue.
    Thread.sleep(2000);
    webDriver.findElement(By.xpath("//input[@name='commit']")).click();
    ...
    webDriver.findElement(By.xpath("//div[@id='answers_203_details_table_wrapper']/div/a/span"))
        .click();
    logger.info(
    ...
    Thread.sleep(2000);
    webDriver.findElement(By.xpath("//div[@id='answers_205_details_table_wrapper']/div/a/span"))
        .click();
    ...
    webDriver.findElement(By.xpath("//div[@id='answers_206_details_table_wrapper']/div/a/span"))
        .click();
    ...
    webDriver.findElement(By.id("answers_208_value")).sendKeys("50000.45");
    Thread.sleep(2000);
    webDriver.findElement(By.xpath("//input[@name='commit']")).click();
    // Select Yes for the Stock and Bonds Section.
    webDriver.findElement(By.xpath(".//*[@id='answers[209][value]']/label[1]")).click();
    webDriver.findElement(By.xpath("//div[@id='answers_209_details_table_wrapper']/div/a/span"))
        .click();
    ...
    Thread.sleep(2000);
    webDriver.findElement(By.cssSelector("label.yes")).click();
    webDriver.findElement(By.id("answers_211_1_1_value"))
        .sendKeys("8597 weems rd 2000 ln manassas va 30998");
    webDriver.findElement(By.xpath("//div[@id='answers[211][1][2][value]']/label")).click();
    webDriver.findElement(By.id("answers_211_1_3_value")).sendKeys("50");
    webDriver.findElement(By.id("answers_211_1_4_value")).sendKeys("98");
    webDriver.findElement(By.xpath("//div[@id='answers[211][1][5][value]']/label")).click();
    // mydriver.findElement(By.xpath(".//*[@id='answers_48_2_5_value']")).sendKeys(Percentage);
    webDriver.findElement(By.id("answers_211_1_6_value")).sendKeys("78");
    webDriver.findElement(By.id("answers_211_1_7_value")).sendKeys("76");
    webDriver.findElement(By.xpath("//div[@id='answers[211][1][8][value]']/label")).click();
    webDriver.findElement(By.id("answers_211_1_9_value")).sendKeys("50");
    webDriver.findElement(By.xpath("//div[@id='answers[211][1][10][value]']/label")).click();
    webDriver.findElement(By.id("answers_211_1_11_value")).sendKeys("50");
    Thread.sleep(2000);
    ...
    webDriver.findElement(By.xpath(".//*[@id='answers[212][value]']/label[1]")).click();
    webDriver.findElement(By.id("add_real_estate")).click();
    Thread.sleep(3000);
    webDriver.findElement(By.id("answers_213_1_1_value")).sendKeys("1000");
    webDriver.findElement(By.id("answers_213_1_2_value_no")).click();
    webDriver.findElement(By.xpath("//div[@id='answers[213][1][4][value]']/label[2]")).click();
    // mydriver.findElement(By.xpath(".//*[@id='answers_50_2_5_value']")).sendKeys(Percentage);
    webDriver.findElement(By.id("answers_213_1_6_value")).sendKeys("76");
    webDriver.findElement(By.id("answers_213_1_7_value")).sendKeys("87");
    // Select yes for the last two question.
    Thread.sleep(2000);
    webDriver.findElement(By.xpath("//div[@id='answers[213][1][8][value]']/label")).click();
    webDriver.findElement(By.id("answers_213_1_9_value")).sendKeys("65");
    webDriver.findElement(By.xpath("//div[@id='answers[213][1][10][value]']/label")).click();
    webDriver.findElement(By.id("answers_213_1_11_value")).sendKeys("56");
    Thread.sleep(3000);
    webDriver.findElement(By.xpath("//form[@id='edwosb']/input[4]")).click();
    Thread.sleep(3000);
    ...
    webDriver.findElement(By.xpath(".//*[@id='answers[214][value]']/label[1]")).click();
    // Locate the New button on the data table and click on it to add
    // information.
    webDriver.findElement(By.xpath("//div[@id='answers_214_details_table_wrapper']/div/a/span"))
        .click();
    ...
    webDriver.findElement(By.xpath(".//*[@id='answers[216][value]']/label[1]")).click();
    webDriver.findElement(By.id("answers_216_comment")).sendKeys(
    ...
    // or assets?'.
    webDriver.findElement(By.xpath(".//*[@id='answers[217][value]']/label[1]")).click();
    // Locate the new button on the data table and click on it to add
    ...
    // Select Yes for question; 'Does any of the above listed property
    // is pledged as security?'.
    webDriver.findElement(By.xpath(".//*[@id='answers[218][value]']/label[1]")).click();
    // Locate the new button on the data table and click on it to enter
    // data.
    ...
    Thread.sleep(3000);
    // Select yes for question; 'Are any leans delinquent?'.
    webDriver.findElement(By.xpath(".//*[@id='answers[219][value]']/label[1]")).click();
    webDriver.findElement(By.id("answers_219_comment")).sendKeys(
        "Also is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll. Him winged winged fifth man heaven won't it first male saw gathered deep. Abundantly herb it own. Darkness from, created great gathering us called deep abundantly. Divide. So replenish rule together beginning fowl seas light gathering air fill, saw darkness divide doesn't greater fly they're all fly. Shall light from given, place itself for were third. Itself second gathered fruit fromAlso is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll. Him winged winged fifth man heaven won't it first male saw gathered deep. Abundantly herb it own. Darkness from, created great gathering us called deep abundantly. Divide. So replenish rule together beginning fowl seas light gathering air fill, saw darkness divide doesn't greater fly they're all fly. Shall light from given, place itself for were third. Itself second gathered fruit from");
    Thread.sleep(3000);
    ...
    try {
      ...
      webDriver.findElement(By.xpath(".//*[@id='answers[220][value]']/label[2]")).click();
      webDriver.findElement(By.xpath(".//*[@id='answers[221][value]']/label[1]")).click();
      webDriver.findElement(By.xpath(".//*[@id='answers_222_value']")).sendKeys("45");
      Thread.sleep(2000);
      webDriver.findElement(By.xpath("//form[@id='edwosb']/input[4]")).click();
    } catch (Error e) {
      logger
    ...
    try {
      ...
      try {
        ...
        webDriver.findElement(By.xpath(".//*[@id='answers[223][value]']/label[1]")).click();
        Thread.sleep(3000);
      } catch (Error e) {
        logger.info(
    ...
    webDriver.findElement(By.xpath("//div[@id='answers_223_details_table_wrapper']/div/a/span"))
        .click();
    ...
    webDriver.findElement(By.xpath(".//*[@id='answers[224][value]']/label[1]")).click();
    webDriver.findElement(By.xpath(".//*[@id='answers[224][value]']/label[1]")).click();
    ...
    // valid data.
    webDriver.findElement(By.id("answers_225_value")).sendKeys("30000");
    webDriver.findElement(By.id("answers_226_value")).sendKeys("10000");
    webDriver.findElement(By.id("answers_227_value")).sendKeys("20000");
    // Locate and click on the continue button.
    Thread.sleep(2000);
    webDriver.findElement(By.xpath("//form[@id='edwosb']/input[4]")).click();
    Thread.sleep(2000);
