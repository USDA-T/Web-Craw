...
public class AddSecondPatnerAfterReviewPage extends TestCase {
	private static final Logger logger = LogManager.getLogger(AddSecondPatnerAfterReviewPage.class.getName());
	...
	public void AddSecondPatnerAfterReview() throws Exception {
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("//div[2]/div/div[7]/fieldset/div/input")));
