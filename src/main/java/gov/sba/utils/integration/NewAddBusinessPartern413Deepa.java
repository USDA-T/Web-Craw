...
public class NewAddBusinessPartern413Deepa {
  ...
  public void NewFinancialQuestion(String Firstname, String lastname, String Ssn, String Email,
      String Address, String State, String Postalcode, String HPhone, String BPhone, String City,
      String Co) throws Exception {
    // Validate that user successfully navigated to the Financial Data
    // section.
    CommonApplicationMethods.click_Element(webDriver,
        "EDWOSB_Questionnaire_Page_FinancialPage_Link");
