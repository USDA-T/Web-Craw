...
public class EdwobEightAMppTestPage {
  ...
  public void EdwobEightAMppTest() throws Exception {
    ...
    String actual_Text2 = webDriver
        .findElement(By.xpath("//div[@id='answers_8a_certified']/fieldset/p[2]")).getText();
    ...
    // Actual_Text =
    // webDriver.findElement(By.xpath("//label[5]")).getText();
    // Expected_Text = "By submitting this certification I, QA User, am an
    // officer or owner of
    // Entity 81 Legal Business Name authorized to represent it and
