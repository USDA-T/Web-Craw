package gov.sba.utils.integration;
  ...
  public class ReturnPendingCert1Page extends TestCase {
    private static final Logger logger =
        LogManager.getLogger(ReturnPendingCert1Page.class.getName());
    WebDriver webDriver;
    int get_The_Row_From_Login_Data;
    String DunsNumber;

    public ReturnPendingCert1Page(WebDriver webDriver) {
      this.webDriver = webDriver;
      DunsNumber = null;
    }

    public void ReturnPendingCert1() throws Exception {
            ...
            if (webDriver.getCurrentUrl().contains("newqa")) {
              ...
              if (webDriver.getCurrentUrl().contains("localhost")) {
                ...
                if (assertTrue(webDriver.getPageSource().concat("MPP Application"))) {
                  ...
                  webDriver.findElement(By.id("review_workflow_state_returned_for_modification"))
                      .click();
                  webDriver.findElement(By.xpath("//form[@id='new_determination']/input[5]"))
                      .click();
                  webDriver.findElement(By.linkText("Vendor Overview")).click();
                  webDriver.findElement(By.id("profileid")).click();
                  webDriver.findElement(By.linkText("Logout")).click();
