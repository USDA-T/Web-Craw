...
import junit.framework.TestCase;
  ...
  public class PotentialForSuccessMasterAppSectionPage extends TestCase {
    ...
    public void PotentialForSuccessMasterAppSection() throws Exception {
      ...
      try { if ("Taxes".equals(webDriver.findElement(By.cssSelector("h2")).getText())) break; } 
      catch (Exception e) {}
      Thread.sleep(1000);
      }
      ...
      for (int second = 0;; second++) {
          if (second >= 60) fail("timeout");
          try { if ("Revenue".equals(webDriver.findElement(By.cssSelector("h2")).getText())) break; } 
          catch (Exception e) {}
          Thread.sleep(1000);
      }
      ...
      for (int second = 0;; second++) {
      if (second >= 60) fail("timeout");
      try { if ("The award date should be in MM/DD/YYYY format\nThe NAICS code should be a 5 or 6 digit number".equals(webDriver.findElement(By.xpath("//div[2]/div/div/p")).getText())) break; 
      } catch (Exception e) {logger.info(e.getMessage());}
      Thread.sleep(1000);
      }
      assertEquals("The award date should be in MM/DD/YYYY format\nThe NAICS code should be a 5 or 6 digit number", webDriver.findElement(By.xpath("//div[2]/div/div/p")).getText());
      webDriver.findElement(By.xpath("//tr[3]/td/input")).clear();
      ...
      for (int second = 0;; second++) {
          if (second >= 60) fail("timeout");
          try { if ("Potential for Success".equals(webDriver.findElement(By.cssSelector("h2")).getText())) break; } 
          catch (Exception e) {logger.info(e.getMessage());}
      }
      ...
      for (int second = 0;; second++) {
          if (second >= 60) fail("timeout");
          try { if ("Please answer this question".equals(webDriver.findElement(By.xpath("//div/span")).getText())) break; 
          } catch (Exception e) {logger.info(e.getMessage());}
      }
      ...
      for (int second = 0;; second++) {
          if (second >= 60) fail("timeout");
          try { if ("Review".equals(webDriver.findElement(By.cssSelector("h2")).getText())) break; } catch (Exception e) {}
          Thread.sleep(1000);
      }
      ...
      assertEquals("", webDriver.getTitle());
      try {
        assertEquals("Please list current and past Federal and non-Federal awarded contracts within the last 12 months.", webDriver.findElement(By.xpath("//div[4]/fieldset/h4")).getText());
      } catch (Error e) {
        logger.info(e.getMessage());
      }
    }
