package gov.sba.utils.integration;
  ...
  public class ReturnActiveCert4Page extends TestCase {
    private static final Logger logger = LogManager.getLogger(ReturnActiveCert4Page.class.getName());
    WebDriver webDriver;
    int get_The_Row_From_Login_Data;
    String DunsNumber;

    public ReturnActiveCert4Page(WebDriver webDriver) {
      this.webDriver = webDriver;
      DunsNumber = null;
    }

    public void ReturnActiveCert4() throws Exception {
