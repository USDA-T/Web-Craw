...
public class ContributorDisadvantageIndividualQuetionPage extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(ContributorDisadvantageIndividualQuetionPage.class.getName());
  WebDriver webDriver;
  ...
  public void ContributorDisadvantageIndividualQuetion() throws Exception {
    try {
      ...
      webDriver.findElement(By.linkText("Add another Disadvantaged Individual, if applicable"))
          .click();
      ...
      UploadDocumentContributorsPage uploadDocumentContributors0 =
          new UploadDocumentContributorsPage(webDriver);
