...
public class AdminFinancialCalculationOnSummaryPage extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(AdminFinancialCalculationOnSummaryPage.class.getName());
  WebDriver webDriver;

  public AdminFinancialCalculationOnSummaryPage(WebDriver webDriver) {
    this.webDriver = webDriver;

  }

  public void AdminFinancialCalculationOnSummary() throws Exception {
    ...
    try {
      ...
      // Cash on Hand.
      // ==>>Get the cash on hand value and convert to integer, then remove the dollar sign for
      // calculation purpose.
      String COH = null;
      ...
      // ==>>Get the Checking Account(s) Balances Balances value and convert to integer.
      String CAB = null;
      ...
      // ==>>Get the IRA, 401K or Other Retirement Account value and convert to integer.
      String ORA = null;
      ...
      logger.info(
          "IRA, 401K or Other Retirement Account without the dollar sign is " + number4.toString());
      // Convert the string value to integer.
      ...
      // ==>>Get Cash Surrender Value of Whole Life Insurance value and convert to integer.
      String CSVLI = null;
      ...
      // ==>>Get Stocks and Bonds or Mutual Funds? value and convert to integer.
      String SB = null;
      ...
      // ==>>Get Applicant's Equity in Other Firms value and convert to integer.
      String AEOF = null;
      ...
      logger
          .info("Applicant's Equity in Other Firms without dollar sign is " + number13.toString());
      // Convert the string value to integer.
      int value14 = Integer.parseInt(AEOF1);
      logger.info("Applicant's Equity in Other Firms success");
      // ==>>Get Total Assets(sum of all the assets) value and convert to integer.
      String TA = null;
      ...
      logger
          .info("Applicant's Equity in Other Firms without dollar sign is " + number14.toString());
      // Convert the string value to integer.
      int TotalAssets = Integer.parseInt(TA1);
      logger.info("Total Assets success");
      // =====>>>Add all the assets and verify that it matches the total on the total assets box.
      int TotalAsset = value1 + value2 + value3 + value4 + value5 + value6 + value7 + value8
      ...
      logger.info("Other Liabilities success");
      // ======>>>>Add all the liabilities value and verify if it matches the total liabilities
      // value.
      int TotalLiabilitie =
      ...
      // =======>>>>>Adjusted Gross Income (AGI) verification and validation.
      // ==>>Get Most Recent Tax Year and convert to integer.
      String MRTY = null;
      MRTY = webDriver.findElement(By.xpath("//div[3]/div[2]/table/tbody/tr/td[2]")).getText();
      logger.info("Most Recent Tax Year value is " + MRTY);
      NumberFormat format30 = NumberFormat.getCurrencyInstance();
      Number number30 = format30.parse(MRTY);
      String MRTY1;
      MRTY1 = number30.toString();
      logger.info("Most Recent Tax Year value without dollar sign is " + number30.toString());
      // Convert the string value to integer.
      int value28 = Integer.parseInt(MRTY1);
      logger.info("Most Recent Tax Year success");
      // ==>>Get Year 2 value and convert to integer.
      String YYYY2 = null;
      YYYY2 = webDriver.findElement(By.xpath("//div[3]/div[2]/table/tbody/tr[2]/td[2]")).getText();
      logger.info("Year 2 value is " + YYYY2);
      NumberFormat format31 = NumberFormat.getCurrencyInstance();
      Number number31 = format31.parse(YYYY2);
      String YYYY21;
      YYYY21 = number31.toString();
      logger.info("Year 2 value without dollar sign is " + number31.toString());
      // Convert the string value to integer.
      int value29 = Integer.parseInt(YYYY21);
      logger.info("Year 2 success");
      // ==>>Get Year 3 value and convert to integer.
      String YYYY3 = null;
      YYYY3 = webDriver.findElement(By.xpath("//div[3]/div[2]/table/tbody/tr[3]/td[2]")).getText();
      logger.info("Year 3 value is " + YYYY3);
      NumberFormat format32 = NumberFormat.getCurrencyInstance();
      Number number32 = format32.parse(YYYY3);
      String YYYY31;
      YYYY31 = number32.toString();
      logger.info("Year 3 value without dollar sign is " + number32.toString());
      // Convert the string value to integer.
      int value30 = Integer.parseInt(YYYY31);
      logger.info("Year 3 success");
      // ==>>Get Total (Avg) value and convert to integer.
      String TAvg = null;
      TAvg = webDriver.findElement(By.xpath("//div[3]/div[2]/table/tbody/tr[4]/td[2]")).getText();
      logger.info("Total (Avg) value is " + TAvg);
      NumberFormat format33 = NumberFormat.getCurrencyInstance();
      Number number33 = format33.parse(TAvg);
      String TAvg1;
      TAvg1 = number33.toString();
      logger.info("Total (Avg) value without dollar sign is " + number33.toString());
      // Convert the string value to integer.
      int TotalAverage = Integer.parseInt(TAvg1);
      logger.info("The actual total average is " + TotalAverage);
      // =====>>>>>Calculating the Adjusted Gross Income.
      int TotalAGI = value28 + value29 + value30;
      logger.info("Total Sources of Income is " + TotalAGI);
      // =====>>>Total (Avg) that is the total Adjusted Gross Income divided by 3 .
      int TotalAvg = TotalAGI / 3;
      logger.info("The Expected calculated Total (Avg) is " + TotalAvg);
      // =====>>>>verify the calculation for Adjusted Gross Income is correct.
      Actual_AdjustedGrossIncome = TotalAverage;
