...
import org.openqa.selenium.WebDriver;
  ...
  public class StartWosbProgramPage {
    ...
    if (webDriver.getPageSource().contains("Active")) {
        ...
        webDriver.findElement(By.id("certificate_type_wosb")).click();              // Click on the Start a new application button.
        webDriver.findElement(By.id("add_certification")).click();             
        //Verify and validate the terms for the certification.
        Actual_Text = webDriver.findElement(By.xpath("//form[@id='new_sba_application']/div[2]/p")).getText();
        ...
        Actual_Text = webDriver.findElement(By.xpath("//form[@id='new_sba_application']/div[2]/p[2]")).getText();
