...
import junit.framework.TestCase;
  ...
  public class BusinessOwnershipSubsectionMasterPage extends TestCase {
    ...
    public void BusinessOwnershipSubsectionMaster() throws Exception {
      ...
      assertEquals(Actual_Text, Expected_Text);
      //Details.
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_ownership_percentage']/fieldset/p[3]")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_ownership_percentage']/fieldset/p[4]")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_ownership_percentage']/fieldset/p[5]")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_ownership_percentage']/fieldset/p[6]")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_ownership_percentage']/fieldset/p[7]")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      //Details.
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_51_percent_owned_other_entity']/fieldset/p[2]")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_51_percent_owned_other_entity']/fieldset/p[3]")).getText();
      ...
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_51_percent_owned_other_entity']/fieldset/p[4]")).getText();
      ...
      logger.info("Back to main window = " + webDriver.getCurrentUrl());
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_51_percent_owned_other_entity']/fieldset/p[5]")).getText();
      ...
      logger.info("Back to main window = " + webDriver.getCurrentUrl());
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_51_percent_owned_other_entity']/fieldset/p[6]")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      //Details.
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_ownership_interest_in_other_firm']/fieldset/p[2]")).getText();
      ...
      Upload2pdfOnSamePage MontanaUploadDocument2 = new Upload2pdfOnSamePage(webDriver);
      MontanaUploadDocument2.Upload2pdfOnSame(file_path_abs);     
      webDriver.findElement(By.xpath("//div[4]/fieldset/div/input")).click();
      //Upload a document.
      file_path_abs = FixtureUtils.fixturesDir() + "MainTestUploadDoc.pdf";
      Upload3pdfOnSamePage MontanaUploadDocument3 = new Upload3pdfOnSamePage(webDriver);
      MontanaUploadDocument3.Upload3pdfOnSame(file_path_abs);      
      webDriver.findElement(By.xpath("//div[5]/fieldset/div/input")).click();
      file_path_abs = FixtureUtils.fixturesDir() + "MainTestUploadDoc.pdf";
      Upload4pdfOnSamePage MontanaUploadDocument4 = new Upload4pdfOnSamePage(webDriver);
      MontanaUploadDocument4.Upload4pdfOnSame(file_path_abs);
      //click on the continue button.
      CoreUtils.clickContinue(webDriver);
      wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h2")));
      Actual_Text = webDriver.findElement(By.cssSelector("h2")).getText();
      ...
      assertEquals(Actual_Text, Expected_Text);
      //Verify questions.
      Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_upload_relevant_corporation_documents_q0']/fieldset/h4")).getText();
      ...
      //Upload a document.
      file_path_abs = FixtureUtils.fixturesDir() + "MainTestUploadDoc.pdf";
      Upload2pdfOnSamePage MontanaUploadDocument6 = new Upload2pdfOnSamePage(webDriver);
      MontanaUploadDocument6.Upload2pdfOnSame(file_path_abs);
      //3rd upload.
      Actual_Text = webDriver.findElement(By.xpath("//div[3]/fieldset/h4")).getText();
