...
public class SoleProprietorReturnCertFirstAndSecondPartnerAfterReviewPage extends TestCase {
	private static final Logger logger = LogManager
			.getLogger(SoleProprietorReturnCertFirstAndSecondPartnerAfterReviewPage.class.getName());
	WebDriver webDriver;
	...
	public void SoleProprietorReturnCertFirstAndSecondPartnerAfterReview() throws Exception {
		...
		Expected_Text = "By submitting this certification I, QA User, am an officer or owner of Entity 23 Legal Business Name authorized to represent it and electronically sign this certification on its behalf.";
		assertEquals(Actual_Text, Expected_Text);
		...
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.id("note_link")));
		webDriver.findElement(By.id("note_link")).click();
		webDriver.findElement(By.id("assessments__note_body")).sendKeys(
				"Also is their earth so. Dry female let doesn't void unto kind. Him two days set green us. Darkness from you'll.");
		jse.executeScript("arguments[0].scrollIntoView()",
		...
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.linkText("Show more")));
		...
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.linkText("Determination")));
		...
		assertEquals(Actual_Text, Expected_Text);
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.xpath("//li[2]/label")));
