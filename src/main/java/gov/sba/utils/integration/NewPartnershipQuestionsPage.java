...
public class NewPartnershipQuestionsPage {
  private static final Logger logger =
      LogManager.getLogger(NewPartnershipQuestionsPage.class.getName());
  WebDriver webDriver;
  ...
  public void NewPartnershipQuestions() throws Exception {
      ...
      webDriver.findElement(By.xpath("//label[2]")).click();
      CoreUtils.clickContinue(webDriver);      // ==>Non-qualification section page.
      Actual_Text = webDriver.findElement(By.cssSelector("h4")).getText();
      Expected_Text =
      ...
      // select no and continue.
      webDriver.findElement(By.xpath("//label[2]")).click();
      CoreUtils.clickContinue(webDriver);      // ==>Partnership program 1st question.
      Actual_Text = webDriver.findElement(By.cssSelector("h4")).getText();
      Expected_Text =
