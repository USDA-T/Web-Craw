...
public class NewPartnershipQuestionsPage {
	...
	public void NewPartnershipQuestions() throws Exception {
		...
		CoreUtils.clickContinue(webDriver); // 8(a) question section.
		...
		CoreUtils.clickContinue(webDriver); // ==>Third Party section.
		Actual_Text = webDriver.findElement(By.cssSelector("h4")).getText();
		...
		webDriver.findElement(By.xpath("//label[2]")).click();
		CoreUtils.clickContinue(webDriver); // ==>Non-qualification section
											// page.
		Actual_Text = webDriver.findElement(By.cssSelector("h4")).getText();
		...
		// select no and continue.
		webDriver.findElement(By.xpath("//label[2]")).click();
		CoreUtils.clickContinue(webDriver); // ==>Partnership program 1st
											// question.
		Actual_Text = webDriver.findElement(By.cssSelector("h4")).getText();
		...
		jse2.executeScript("arguments[0].scrollIntoView()",
		...
		assertEquals(Actual_Text, Expected_Text);
		jse2.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.xpath("//label[2]")));
		webDriver.findElement(By.xpath("//label[2]")).click();
		// 2nd question.
