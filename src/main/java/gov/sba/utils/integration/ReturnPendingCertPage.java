...
public class ReturnPendingCertPage extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(ReturnPendingCertPage.class.getName());
  WebDriver webDriver;
  int get_The_Row_From_Login_Data;
  String DunsNumber;

  public ReturnPendingCertPage(WebDriver webDriver) {
    this.webDriver = webDriver;
    DunsNumber = null;
  }

  public void ReturnPendingCert() throws Exception {
