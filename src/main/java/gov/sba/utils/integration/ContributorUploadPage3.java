...
public class ContributorUploadPage3 {
	...
	public void ContributorUpload(String upload_Path) throws Exception {
		...
		WebElement rateElement = webDriver.findElement(By.xpath("(//a[contains(text(),'Add required documents')])[3]"));
		...
		act.doubleClick(webDriver.findElement(By.xpath("(//a[contains(text(),'Choose a .pdf file')])[3]"))).build()
				.perform();
		...
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.xpath("(//button[@id='attach'])[3]")));
