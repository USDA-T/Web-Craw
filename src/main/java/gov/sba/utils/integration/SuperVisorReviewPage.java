...
public class SuperVisorReviewPage extends TestCase {
  ...
  private static final Logger SuperVisorReviewPage =
      LogManager.getLogger(SuperVisorReviewPage.class.getName());
  ...
  public void testMainTest() throws Exception {
    try {
      ...
      WebElement current_Page_Title =
          webDriver.findElement(By.xpath("//article[@id='main-content']/div[2]/div[2]/h1"));
      ...
      webDriver
          .findElement(
              By.xpath("//*[@id='new_assessment']/div/input[contains(@value,'Save and commit')]"))
          .click();
