...
public class TestWorkflowPrepopulateAnswersEDWOSB extends TestCase {

  private static final Logger logger_TestApp395Edwosb =
      LogManager.getLogger(TestWorkflowPrepopulateAnswersEDWOSB.class.getName());
  ...
  @Test
  public void testWorkflowPrepopulateAnswersEDWOSB() throws Exception {
    // Login to dashboard.
    try {
      ...
      CommonApplicationMethods.take_ScreenShot_TestCaseName(webDriver,
          new String[] {"TestWorkflowPrepopulateAnswersEDWOSB", "Exception"});
      throw e;
    }
  }
