...
public class TestUS1503MppAnalystSuperVisor extends TestCase {
  ...
  @Test
  public void testUS1503MppAnalystSuperVisor() throws Exception {
    // Login to dashboard.
    ...
    try {
      ...
      String Allcases_PageTitle = webDriver
          .findElement(By.xpath("//article[@id='main-content']//h1[contains(text(),'All cases')]"))
          .getText();
      assertEquals(Allcases_PageTitle, "All cases");

      String[] header_Names_Array = new String[] {"Business name", "DUNS", "Program", "Review type",
          "Submitted", "Owner", "Current reviewer", "Status"};
      ...
      ResultSet result_Set =
          statement_SQL.executeQuery(" SELECT F.legal_business_name AS legal_Name, "
              ...
              + "G.id as certificate_ID ,P.id as group_id " + "	FROM "
      ...
      WebElement current_Row_MPP = webDriver.findElement(By.xpath(
          "//div[@id='table-search']/table[contains(@class,'usa-table')]/tbody/tr/td[text()='MPP']"));
      ...
      CommonApplicationMethods.take_ScreenShot_TestCaseName(webDriver,
          new String[] {"TestUS1503MppAnalystSuperVisor", "Exception"});
    }
