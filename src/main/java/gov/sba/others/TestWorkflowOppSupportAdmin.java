...
public class TestWorkflowOppSupportAdmin extends TestCase {
    //US1235
    ...
    public void testMainTest() throws Exception {
        try {
           ...
           // new LoginPageWithDetails(webDriver, email, password).Login_With_Details();
            ...
            //App-45 cases page
             Assert.assertEquals("Cases",find_Element(webDriver,"Opp_Support_Page_Cases_Link").getText());
             click_Element(webDriver,"Opp_Support_Page_Cases_Link");
             Assert.assertEquals("Cases",find_Element(webDriver,"Opp_Support_Admin_Page_Cases").getText());
            ...
            catch (Exception e) { element_Found = false; logger.info("Test case Passed-HelpPage_Edit funtionality"); }
