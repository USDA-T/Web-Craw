...
public class TestWorkflowMPPVendor8aYes extends TestCase {
  ...
  private static final Logger logger =
      LogManager.getLogger(TestWorkflowMPPVendor8aYes.class.getName());
  WebDriver webDriver;
  ...
  @Test
  public void testWorkflowMPPVendor8aYes() throws Exception {
    try {
      ...
      CommonApplicationMethods.take_ScreenShot_TestCaseName(webDriver,
          new String[] {"TestWorkflowMPPVendor8aYes", "Exception"});
      throw e;
    }
  }
