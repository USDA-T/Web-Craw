...
public class TestUs1674EDWOSBAnalystReview extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            List<WebElement> current_Row_EDWOSB = CommonApplicationMethods.find_Elements(webDriver, "xpath",
            ...
            if (current_Row_EDWOSB.size() >= 1) {
                ...
                assertEquals("Initial Review", new Select(find_Element(webDriver, "Case_Current_ReviewType"))
