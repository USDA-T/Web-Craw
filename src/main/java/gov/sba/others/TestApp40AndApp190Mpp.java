...
public class TestApp40AndApp190Mpp extends TestCase {
  private static final Logger TestApp40AndApp190Mpp =
      LogManager.getLogger(TestApp40AndApp190Mpp.class.getName());
  ...
  public void run_This_app(String app_Type_Passed, String duns_No_Passed) throws Exception {
    ...
    // Delete if Draft
    TestApp40AndApp190Mpp.info(app_Type_Passed);
    ...
    TestApp40AndApp190Mpp.info(app_Type_Passed.toLowerCase().trim());
    TestApp40AndApp190Mpp.info(xpath);
    ...
    TestApp40AndApp190Mpp.info(current_Row.size() + ": Is the total Under Review Elements");
    if (current_Row.size() > 0) {
      WebElement a1 =
          current_Row.get(0).findElement(By.xpath("td/a[contains(text(),'Legal Business Name')]"));
      TestApp40AndApp190Mpp.info(a1.getText());
      a1.click();
  ...
  @Test
  public void testApp40AndApp190Mpp() throws Exception {

    LoginPageWithDetails login_Data = new LoginPageWithDetails(webDriver, email, password);
    login_Data.Login_With_Details();
    TestApp40AndApp190Mpp.info(duns_Number);
