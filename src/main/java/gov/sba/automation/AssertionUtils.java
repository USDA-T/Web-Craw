...
public class AssertionUtils {
    ...
    switch (type_Of_App.toLowerCase() + status_Of_App.toLowerCase()) {
      case "edwosbactive":
        ...
        if (current_Row.size() > 0) {
          ...
          webDriver
              .findElement(By
                  .xpath("//ul[@class='usa-sidenav-list']/li/a[contains(@href,'determinations')]"))
              .click();
          webDriver.findElement(By.id("review_workflow_state_returned_for_modification")).click();
          webDriver.findElement(By.xpath("//input[contains(@value,'Save and commit')]")).click();
          webDriver.navigate().back();
  ...
  public static void return_all_Applications(WebDriver webDriver, int login_Id, String duns_Number)
      throws Exception {
    Logger commonApplicationMethodsLogs =
    ...
    try {
      if ((paS.contains("return to vendor") || paS.contains("active"))
        ...
        current_Row_Check_01 =
            webDriver.findElement(By.xpath("//table[@id='certifications']/tbody"));
        List<WebElement> current_Row_Check_02 = current_Row_Check_01.findElements(By.xpath(
        ...
        if (current_Row_Check_02.size() > 0) {
          for (int i = 0; i < current_Row_Check_02.size(); i++) {
            ...
            CommonApplicationMethods.click_Element(webDriver,
                "Analyst_Review_Determ_Page_Return_Mod_Link");
