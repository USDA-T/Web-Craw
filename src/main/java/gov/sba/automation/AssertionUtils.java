...
public class AssertionUtils {
    public static void verify_Element_Property(WebDriver webdriver, String locator_Yaml, String property_Yaml)
        ...
        WebElement click_element = CommonApplicationMethods.find_Element(webdriver, locator.get("Locator").toString(),
    ...
    public static void returnAppToVendorMethd(WebDriver webDriver, int which_Loginto_ReturnApp, String duns_Number,
        ...
        case "edwosbactive":
            ...
            if (current_Row.size() > 0) {
                ...
                new Select(find_Element(webDriver, "Case_Current_Owner")).selectByIndex(1);
    ...
    public static void return_all_Applications(WebDriver webDriver, int login_Id, String duns_Number) throws Exception {
        ...
        try {
            if ((paS.contains("return to vendor") || paS.contains("active"))
                ...
                current_Row_Check_01 = find_Element(webDriver, "SBA_Table_Applications");
                String xp = "tr[ td[position()=1]/a[contains(text(),'WOSB') or contains(text(),'MPP')] and td[(position()=4) and ( (contains(text(),'ctive')) or  (contains(text(),'ending')) ) ] ]/td[position()=1]/a";
