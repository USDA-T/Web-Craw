...
public class CodsSupervisorApprovedRequestPage extends TestCase {

  private static final Logger logger =
      LogManager.getLogger(CodsSupervisorApprovedRequestPage.class.getName());
  WebDriver webDriver;
  int get_The_Row_From_Login_Data;

  public CodsSupervisorApprovedRequestPage(WebDriver webDriver) {
    this.webDriver = webDriver;
    get_The_Row_From_Login_Data = 70;

  }

  public void CodsSupervisorApprovedRequest() throws Exception {
    WebDriverWait wait = new WebDriverWait(webDriver, 30);
    String Actual_Text = null;
    String Expected_Text = null;
    logger.info(
        "Completing Process, CODS supervisors Approved Access Request from another Cods Supervisors.");
    // Login to dashboard.
