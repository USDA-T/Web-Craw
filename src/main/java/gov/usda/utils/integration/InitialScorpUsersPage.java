...
public class InitialScorpUsersPage extends TestCase {

	private static final Logger logger = LogManager
			.getLogger(gov.usda.utils.integration.InitialScorpUsersPage.class.getName());
	WebDriver webDriver;
	int get_The_Row_From_Login_Data;

	public InitialScorpUsersPage(WebDriver webDriver) {
		this.webDriver = webDriver;

	}

	public void InitialScorpUsers() throws Exception {
		...
		if (webDriver.getPageSource().contains("Pending")) {
			...
			get_The_Row_From_Login_Data = 89;
