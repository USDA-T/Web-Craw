      ...
      if (!YesNo.equals(null) && !YesNo.equals("")) {
        switch (YesNo) {
          case "Yes":
            ...
            setText_Element(webDriver, "8a_Spouse_financial_Real_Estate_Oth_Mortage_Balance_Val",
                "111");
      ...
      if (!YesNo.equals(null) && !YesNo.equals("")) {
        switch (YesNo) {
          case "Yes":
            ...
            click_Element(webDriver,
                "8a_Spouse_financial_NotesPayable_OtherLiabilities_New_Button");
            new Select(
                find_Element(webDriver, "8a_Spouse_financial_NotesPayable_OtherLiabilities_Type"))
                    .selectByIndex(1);
            setText_Element(webDriver, "8a_Spouse_financial_NotesPayable_OtherLiabilities_OrgBal",
                "100");
            setText_Element(webDriver, "8a_Spouse_financial_NotesPayable_OtherLiabilities_CurrBal",
                "1000");
            setText_Element(webDriver, "8a_Spouse_financial_NotesPayable_OtherLiabilities_Amount",
                "1000");
            setText_Element(webDriver,
                "8a_Spouse_financial_NotesPayable_OtherLiabilities_Collateral", "100");
            setText_Element(webDriver,
                "8a_Spouse_financial_NotesPayable_OtherLiabilities_Noteholder", "1000");
            setText_Element(webDriver,
                "8a_Spouse_financial_NotesPayable_OtherLiabilities_Addressholder", "1000");
            click_Element(webDriver, "Application_Common_Create_button");
            Thread.sleep(2000);
            break;
          case "No":
