...
import gov.usda.utils.integration.CodsSupervisorSendsRequestAccessPage;
...
public class TestCompleteAccessRequestFlowForCodsSup extends TestCase {
	...
	private static final Logger logger = LogManager.getLogger(TestCompleteAccessRequestFlowForCodsSup.class.getName());
	...
	public void testCompleteAccessRequestFlowForCodsSup() throws Exception {
		...
		logger.info("Supervisor approves, Rejects or denies an access request from an 8a analyst or other supervisors");
		// Login to dashboard.
		...
		CodsSupervisorSendsRequestAccessPage codsSupervisorSendsRequestAccess = new CodsSupervisorSendsRequestAccessPage(
				webDriver);
		...
		// Completing the Revoke Access process.
		CodesSupervisorRevokeAccessPage codesSupervisorRevokeAccess = new CodesSupervisorRevokeAccessPage(webDriver);
		codesSupervisorRevokeAccess.CodesSupervisorRevokeAccess();
		...
		// Complete request access for CODS Supervisor.
		CodsSupervisorSendsRequestAccessPage codsSupervisorSendsRequestAccess1 = new CodsSupervisorSendsRequestAccessPage(
				webDriver);
		...
		// Supervisor.
		CodsSupervisorRejectsRequestPage codsSupervisorRejectsRequest = new CodsSupervisorRejectsRequestPage(webDriver);
