...
import static gov.usda.automation.AssertionUtils.delete_All_Application_Draft;
import static gov.usda.pageObjetcs.MasterApplication8a.*;
import static gov.usda.pageObjetcs.ProgramsPage.*;
import static gov.usda.pageObjetcs.VendorDashboardPage.click_On_App_In_Vend_Dash;
 ...
 * Tests TestWorkflow8aInital SelectingNoAllSections---Vendor Create 8a Initial Program: select no
 * to all questionnaires on all sub sections + With Vendor admin sub application and 8a disadvantage
 * individual sub application in Contributor section. login with SBA 8a Cod supervisor and verify
 * the newly submitted cases in Unassigned table and assign to BOS Analyst.
 */
// Still in progress
...
public class TestWorkflow8aInitalSelectingNoAllSections extends TestCase {
  ...
  public void testWorkflow8aInitalSelectingNoAllSections() throws Exception {
    try {
      ...
      contributor_Disadv_login(webDriver, "norole10", "norole10@mailinator.com");
      ...
      contributor_Spouse_login(webDriver, "norole2", "norole2@mailinator.com");
      navigationMenuClick(webDriver, "LOGOUT");
      click_Element(webDriver, "SBA_Login_Button");
