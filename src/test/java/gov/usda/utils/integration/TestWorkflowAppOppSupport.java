...
import static gov.usda.pageObjetcs.AppProfileSearchType.TestuserProfileSearch;
...
public class TestWorkflowAppOppSupport extends TestCase {
  ...
  public void testWorkflowAppOppSupport() throws Exception {
    ...
    try {
       ...
       * assertEquals("Vendor Support", find_Element(webDriver,
       * "Opp_Support_Page_Test_Business_Search").getText().toString());
       */
