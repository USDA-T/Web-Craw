package gov.usda.automation.examples;
...
// LoggerFactory.getLogger(TestWosbClickThrough.class);
//
...
// CoreWait.waitForPresenceOfElementLocated(wdriver,
// By.cssSelector(".button-full"));
//
...
// CoreUtils.clickContinue(driver);
//
// CoreUtils.yesOrNo(driver, "no", new int[] { offSet(214), offSet(215),
// offSet(216) });
// CoreUtils.comment(driver, offSet(216));
// CoreUtils.clickContinue(driver);
//
// CoreUtils.yesOrNo(driver, "no", new int[] { offSet(217), offSet(218),
// offSet(219), offSet(220), offSet(221), offSet(222) });
