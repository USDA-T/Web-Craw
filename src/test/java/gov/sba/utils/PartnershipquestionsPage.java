...
WebDriver mydriver;
	...
	//Locate the Third Party Certification, question1 and select No and continue.
				String actual_Text3=mydriver.findElement(By.xpath(".//*[@id='answers_tpc1_q1']/div/fieldset/legend")).getText();
	...
	//Locate the Non-qualification question,Verify,select No and continue.
				String actual_Text4=mydriver.findElement(By.xpath(".//*[@id='answers_tpc3_q1']/div/fieldset/legend")).getText();
			...
			//Locate the Partnership questions and select No and continue.
				String actual_Text50=mydriver.findElement(By.xpath("//li[@id='answers_partn_q1']/div/fieldset/legend")).getText();
				String expected_Text50="If a partnership, the partnership agreement evidences that at least 51% of each class of partnership interest is unconditionally and directly owned by one or more women, or economically disadvantaged women.";
				assertEquals(actual_Text50, expected_Text50);
			//validate detail meaning for the 1st partnership question.
				
				String actual_Text51=mydriver.findElement(By.cssSelector("p.usa-text-small")).getText();
		...
		mydriver.findElement(By.id("answers_76_comment")).sendKeys("Testing");		
		//Locate the Partnership questions 2 and select No and continue.
		
		
	 Thread.sleep(4000);
		
       mydriver.findElement(By.xpath("//div[@id='answers[77][value]']/label[2]")).click();
       mydriver.findElement(By.xpath(".//*[@id='answers_77_comment']")).sendKeys("Testing");
       String actual_Text54=mydriver.findElement(By.name("commit")).getText();
       String expected_Text54="Save and continue";
       assertEquals(actual_Text54, expected_Text54);
       mydriver.findElement(By.name("commit")).click();


	   System.out.println("The partnership questions have been answered");
					
						
				//Locate the Citizenship & Ownership question 1and2, Verify,select No and continue.
				String actual_Text12=mydriver.findElement(By.xpath(".//*[@id='answers_oper1_q1']/div/fieldset/legend")).getText();
				...
				String actual_Text0=mydriver.findElement(By.xpath(".//*[@id='answers_oper1_q2']/div/fieldset/legend")).getText();
			...
			//Verify the more detail meaning for the Citizenship & Ownership questions.
				...
				mydriver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();	
		    //Locate the Businesses & Trusts questions,Verify, select No for both and continue.
				String actual_Text14=mydriver.findElement(By.xpath(".//*[@id='answers_oper2_q1']/div/fieldset/legend")).getText();
			...
			//Verify the more detail meaning for the Businesses & Trusts questions
				...
				//2nd question
				String actual_Text16=mydriver.findElement(By.xpath(".//*[@id='answers_oper2_q2']/div/fieldset/legend")).getText();
			...
			//Locate the Operations & Management questions, Verify, select No for both and continue.
				//1st question
				String actual_Text18=mydriver.findElement(By.xpath(".//*[@id='answers_oper3_q1']/div/fieldset/legend")).getText();
				...
				//2nd question.
				String actual_Text20=mydriver.findElement(By.xpath(".//*[@id='answers_oper3_q2']/div/fieldset/legend")).getText();
				...
				mydriver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();		
			//Locate the Expertise & Employment questions, Verify, select No for both and continue.
				//1st question.
				String actual_Text23=mydriver.findElement(By.xpath(".//*[@id='answers_oper4_q1']/div/fieldset/legend")).getText();
				...
				//2nd question.
				String actual_Text25=mydriver.findElement(By.xpath(".//*[@id='answers_oper4_q2']/div/fieldset/legend")).getText();
			...
			//Locate the Highest Officer & Control questions,Verify, select No for both and continue.
				//1st question.
				String actual_Text27=mydriver.findElement(By.xpath(".//*[@id='answers_oper5_q1']/div/fieldset/legend")).getText();
				...
				//2nd question.
				String actual_Text29=mydriver.findElement(By.xpath(".//*[@id='answers_oper5_q2']/div/fieldset/legend")).getText();
				...
				mydriver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
			//Locate the SBA Exam & Daily Operations questions,Verify, select No for both and continue.
				//1st question.
				String actual_Text31=mydriver.findElement(By.xpath(".//*[@id='answers_oper6_q1']/div/fieldset/legend")).getText();
				...
				//2nd question.
				String actual_Text33=mydriver.findElement(By.xpath(".//*[@id='answers_oper6_q2']/div/fieldset/legend")).getText();
				...
				mydriver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
			//Locate the Net Worth questions,Verify, select No for both and continue.
				//1st question.
				String actual_Text35=mydriver.findElement(By.xpath(".//*[@id='answers_demonstrate_less_than_750k']/div/fieldset/legend")).getText();
				...
				//2nd question.
				String actual_Text37=mydriver.findElement(By.xpath(".//*[@id='answers_woman_financial_condition']/div/fieldset/legend")).getText();
				...
				mydriver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
			//Locate the Adjusted Gross Income questions,verify, select No for both and continue.
				//1st question.
				String actual_Text39=mydriver.findElement(By.xpath(".//*[@id='answers_agi_3_year_less_than_350k']/div/fieldset/legend")).getText();
				...
				//2nd question.
				String actual_Text41=mydriver.findElement(By.xpath(".//*[@id='answers_agi_3_year_exceeds_but_uncommon']/div/fieldset/legend")).getText();
			...
			//Locate the Fair Market Value questions,verify select No and continue.
				String actual_Text43=mydriver.findElement(By.xpath(".//*[@id='answers_woman_assets_less_than_6m']/div/fieldset/legend")).getText();
				...
				mydriver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();	
			//Locate the Assets questions,verify, select and No for both and continue.
				//1st question.
				String actual_Text45=mydriver.findElement(By.xpath(".//*[@id='answers_woman_has_not_transferred_assets']/div/fieldset/legend")).getText();
				...
				//2nd question.
				String actual_Text47=mydriver.findElement(By.xpath(".//*[@id='answers_woman_asset_transfer_excusable']/div/fieldset/legend")).getText();
			...
			//Validate that user successfully navigated to the Financial Data section.
				String actual_Text55=mydriver.findElement(By.cssSelector("h2.usa-heading.ques-private")).getText();
				String expected_Text55="Financial Data";
				assertEquals(actual_Text55, expected_Text55);
		    //Validate the Personal Information.
				//String actual_Text50=mydriver.findElement(By.cssSelector("p..firepath-matching-node")).getText();
				//String expected_Text50="This section must be completed by each individual claiming economic disadvantage in connection with the 8(a) Program and/or the Women-Owned Small Business Federal Contract Program. If married, the spouse must complete this section, except when the individual and the spouse are legally separated. If separated, provide copy of separation document.";
				//assertEquals(actual_Text50, expected_Text50);
			//Locate the 'Add New Person' button at the bottom of the personal information and click on it.
			mydriver.findElement(By.xpath("//button")).click();
			Thread.sleep(2000);
			//Verify that the section to Create new record is been seen by user and enter record2.
			String actual_Text56=mydriver.findElement(By.className("DTE_Header_Content")).getText();
			String expected_Text56="Create new record";
			assertEquals(actual_Text56, expected_Text56);	
