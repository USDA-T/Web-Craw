...
import junit.framework.TestCase;
	...
	public class TestApp200InformApplicantWhenSectionIsUnanswerMPP extends TestCase {

	    private static final Logger logger = LogManager.getLogger(TestApp200InformApplicantWhenSectionIsUnanswerMPP.class.getName());
	    ...
	    public void testMainTest() throws Exception {
	        ...
	        // Login to dashboard.
	        logger.info("Inform applicants when Required sections of application are left unanswered");
	        ...
	        act2.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
	        ...
	        act8.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
            ...
            act6.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
            ...
            act1.doubleClick(webDriver.findElement(By.id("answers_141_value_no"))).build().perform();	
            Thread.sleep(3000);
            webDriver.findElement(By.className("usa-button")).click();
	        ...
	        // Link.
	            ...
	            Thread.sleep(3000);
	            webDriver.findElement(By.className("usa-button")).click();
	            //Click back on to the MPP Agreement tab and select YES for  two need question to trigger a new section.
	            webDriver.findElement(By.id("mpp_agreement")).click();
		        webDriver.findElement(By.className("usa-button")).click();
	            ...
	            act3.doubleClick(webDriver.findElement(By.id("answers_141_value_yes"))).build().perform();
		        webDriver.findElement(By.className("usa-button")).click();
		        webDriver.findElement(By.id("mentor_training")).click();
	            Thread.sleep(3000);
		        webDriver.findElement(By.className("usa-button")).click();
	            ...
	            Expected_Text = "Some required sections were not answered";
	            assertEquals(Actual_Text, Expected_Text);
	            Actual_Text = webDriver.findElement(By.cssSelector("#main-content > ul > li > a")).getText();
	            Expected_Text = "Trade Education Needs";
	            assertEquals(Actual_Text, Expected_Text);
	            Actual_Text = webDriver.findElement(By.xpath("//article/ul/li[2]/a")).getText();
	            Expected_Text = "Business Development Needs";
	            assertEquals(Actual_Text, Expected_Text);
	            Actual_Text = webDriver.findElement(By.xpath("//article/ul/li[3]/a")).getText();
	            Expected_Text = "General/Administrative Needs";
	            assertEquals(Actual_Text, Expected_Text);
	            WebElement UnansweredSec = webDriver.findElement(By.xpath(".//*[@id='main-content']"));
	            HighLight.highLightElement(webDriver, UnansweredSec);
	            webDriver.findElement(By.id("mpp_agreement")).click();
		        webDriver.findElement(By.className("usa-button")).click();
	            webDriver.findElement(By.id("answers_139_value_no")).click();
		        webDriver.findElement(By.id("answers_140_value_no")).click();
		        Actions act5 = new Actions(webDriver);
	            act5.doubleClick(webDriver.findElement(By.id("answers_141_value_no"))).build().perform();		       
	            webDriver.findElement(By.className("usa-button")).click();
		        webDriver.findElement(By.id("mentor_training")).click();
		        webDriver.findElement(By.className("usa-button")).click();
	            // Enter an invalid DUNS# and verify message.
	            webDriver.findElement(By.id("duns-value-167")).clear();
	            webDriver.findElement(By.id("duns-value-167")).sendKeys("146482889");
	            webDriver.findElement(By.xpath("//a[contains(text(),'Change DUNS')]")).click();
	            webDriver.findElement(By.id("duns-value-167")).sendKeys("146482889");
	            webDriver.findElement(By.id("search-duns-167")).click();
                Thread.sleep(2000);
	            logger.info(webDriver.switchTo().alert().getText());
