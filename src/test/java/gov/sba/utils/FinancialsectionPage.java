...
WebDriver mydriver;
	...
	//Locate section for 'Cash on Hand' enter all valid data as required.
		...
		//Locate the Cash on Hand Search box for Pual Washington and enter the information as required.
		mydriver.findElement(By.xpath(".//*[@id='answers_33_value']")).sendKeys("4000");
		
		//Locate the Savings Account(s) Balance Search box for Pual Washington and enter the information as required.
	...
	//Locate section for Other Source of Income enter all valid data as required.
	...
	//Locate and  YES for question 'Do you have any notes receivable from others?'.
	...
	mydriver.findElement(By.xpath(".//*[@id='answers_40_details_table_wrapper']/div/a[1]/span")).click();
	   System.out.println("User is prompted to enter Atleast one row  field or to select no if not applicable. Valid error Message is ");
	   Thread.sleep(3000);     
	...
	//Locate the 'Payment Amount(Calculated Annually)' and enter a valid Amount.
		mydriver.findElement(By.xpath(".//*[@id='DTE_Field_pay_amount']")).sendKeys("60000");
	//Locate the 'How Secured or Endorsed / Type of Collateral' search box and enter a valid Collateral type(s).
	...
	//locate the 'CONTINUE' button at the right bottom of the page and click on it to save
		...
		//mydriver.findElement(By.xpath(".//*[@id='DTE_Field_investment_company']")).sendKeys("21 cenyury");
		//mydriver.findElement(By.xpath("html/body/div[3]/div/div/div/div[1]/div[4]/div[3]/button")).click();
	Thread.sleep(4000);
		...
		//mydriver.findElement(By.xpath(".//*[@id='DTE_Field_investment_company']")).sendKeys("21 century");
		//mydriver.findElement(By.xpath("html/body/div[3]/div/div/div/div[1]/div[4]/div[3]/button")).click();
		Thread.sleep(4000);
		mydriver.findElement(By.name("commit")).click();
	...
	//Locate and select yes for question Do you have life insurance policy that has a cash surrender value.
		...
		mydriver.findElement(By.xpath("html/body/div[3]/div/div/div/div[1]/div[4]/div[3]/button")).click();
		Thread.sleep(5000);
	//Locate and select yes for question, Do you have loan against a life insurance.
	...
	//Locate the New button on the data table and click on it to add information.
	mydriver.findElement(By.xpath(".//*[@id='answers_51_details_table_wrapper']/div/a[1]")).click();
	//Locate current value search box and enter a valid value for you automobile.
	...
	//Locate the description of asset search box and enter the make,model and year of your automobile.
	mydriver.findElement(By.xpath(".//*[@id='DTE_Field_asset_description']")).sendKeys("nissan maxima");
	//Locate the payment amount search box and enter the annual payment amount for the automobile.
	mydriver.findElement(By.xpath(".//*[@id='DTE_Field_payment_amount']")).sendKeys("30000");
	//Locate the Create button and click on it.
	Thread.sleep(3000);
	mydriver.findElement(By.xpath("html/body/div[3]/div/div/div/div[1]/div[4]/div[3]/button")).click();
	Thread.sleep(3000);
	//Select Yes for question; 'Does any of the above listed property is pledged as security?'. 
	mydriver.findElement(By.xpath(".//*[@id='answers[52][value]']/label[1]")).click();
	mydriver.findElement(By.xpath(".//*[@id='answers[52][value]']/label[1]")).click();

	//Locate the new button on the data table and click on it to enter data.
	...
	//Locate the new button on the data table and click on it to add another data for personal property.
	...
	//Verify that User navigate to the Next section of 'Notes Payable' in form 413 successfully.
	...
	//US660 'Assessed Taxes' test begin here.
		...
		//Verify that user successfully navigated to the section 'Assessed Taxes' on form 413.
		if(mydriver.getPageSource().contains("Assessed Taxes")){
			...
			//Verify and answer YES to question 'Do you have any Assessed Taxes that were unpaid?'.
			if(mydriver.getPageSource().contains("Do you have any Assessed Taxes that were unpaid")){
				System.out.println("Assessed Taxes question; 'Do you have any Assessed Taxes that were unpaid?' is present, Pass");
				mydriver.findElement(By.xpath(".//*[@id='answers[60][value]']/label[1]")).click();	
				Thread.sleep(3000);
			}
			else{
				System.out.println("Assessed Taxes question; 'Do you have any Assessed Taxes that were unpaid?' NOT Present, Failed");
			}
		}
		else{
			System.out.println("User did Not successfully navigated to the section 'Assessed Taxes' on Form 413, Failed");
		}
	//Verify data table and complete it if taxes were unpaid.
		if(mydriver.getPageSource().contains("Include only assessed taxes that are unpaid")){
			...
			//Locate the when due search box, clear existing data and enter a valid date.
			...
			//Locate the property search box and enter the type of property the tax lien attaches to.
		...
		Thread.sleep(3000);
	//Verify and select YES for the next assessed taxes section question; 'Do you have any other liabilities?'.
		...
		if(mydriver.getPageSource().contains("Complete this section only if liabilities were not listed elsewhere")){
			System.out.println("Assessed taxes data tabl is present for question 'Do you have any other liabilities?', Pass");
	...
	Thread.sleep(4000);
	//Locate the next 3 search boxes for Adjusted Gross Income and enter valid data.
