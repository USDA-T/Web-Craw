    ...
    public void AddOrStartNewMppProgram() throws Exception {
        ...
        if (webDriver.getPageSource().contains("Active")) {
            ...
            Actual_Text = webDriver.findElement(By.xpath("//article[@id='main-content']/section/article/div/div[2]"))
                    .getText();
            Expected_Text = "Get started now on your WOSB self-certification, EDWOSB self-certification, All Small Business Mentor-Prot�g� agreement, or 8(a) Document Upload.";
            assertEquals(Actual_Text, Expected_Text);
