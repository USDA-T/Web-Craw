...
public class TestUs1674EDWOSBAnalystReview extends TestCase {
    ...
    private static final Logger logger_US1674_EDWOSB = LogManager.getLogger(TestUs1674EDWOSBAnalystReview.class.getName());
...
//Financia Data Review Page
                webDriver.findElement(By.xpath("//div[@id='question-review']/div/div/aside/ul[@class='usa-sidenav-list']/li/a[contains(text(),'Financial review')]")).click();
                ...
                WebElement ret_Accounts = webDriver.findElement(By.xpath("//article[@id='main-content']/form/div[contains(@class,'review_outer')]/div[contains(@class,'review_main')]/div/div[contains(@class,'tab-content')]/form/div/div/div/h3[contains(text(),'Retirement Accounts')]"));
                logger_US1674_EDWOSB.info(ret_Accounts.getText());
                WebElement ret_Account_Title = ret_Accounts.findElement(By.xpath("..")).findElement(By.xpath("div/div[contains(@class,'table-top')]/strong[text()='Vendor attachments:']"));
