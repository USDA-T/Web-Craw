...
public class ScorpQuestionsPage {
    ...
    public void ScorpQuestions() throws Exception {
        ...
        WebElement emailid = webDriver.findElement(By.id("DTE_Field_email"));
        emailid.sendKeys("DWashington@mailinator.com");

//        action.moveToElement(emailid).click(emailid).build().perform();
        Thread.sleep(1000);
        Robot actionRobot = new Robot();
        actionRobot.keyPress(KeyEvent.VK_TAB);
        actionRobot.keyRelease(KeyEvent.VK_TAB);
        Thread.sleep(500);
//        actionRobot.keyPress(KeyEvent.VK_TAB);
//        actionRobot.keyRelease(KeyEvent.VK_TAB);
//        Thread.sleep(500);
        actionRobot.keyPress(KeyEvent.VK_ENTER);
        actionRobot.keyRelease(KeyEvent.VK_ENTER);

//        webDriver.findElement(By.xpath("//div[contains(@class,'DTED_Lightbox_Container')]//button[@class='btn' and contains(text(),'reate') ]")).click();
        Thread.sleep(2500);
