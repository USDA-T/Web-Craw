...
public class EightATestPage {
    ...
    public void EightATest() throws Exception {
        ...
        Thread.sleep(2000);
        MontanaUploadDocument1Page montanaUploadDocument3 = new MontanaUploadDocument1Page(webDriver);
        montanaUploadDocument3.MontanaUploadDocument1();
        Thread.sleep(2000);
        MontanaUploadDocument1Page montanaUploadDocument4 = new MontanaUploadDocument1Page(webDriver);
        montanaUploadDocument4.MontanaUploadDocument1();
        Thread.sleep(2000);
        webDriver.findElement(By.className("usa-button")).click();
