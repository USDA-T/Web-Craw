...
public class TestMppBuildQuestionnaireTs12n extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        Thread.sleep(2000);
        Actions act15 = new Actions(webDriver);
        act15.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
        ...
        Thread.sleep(3000);
        Actions act14 = new Actions(webDriver);
        act14.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
        ...
        Thread.sleep(2000);
        Actions act16 = new Actions(webDriver);
        act16.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
