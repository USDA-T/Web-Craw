...
public class ScorpQuestionsPage {
	...
	public void ScorpQuestions() throws Exception {
		...
		// and continue.
		String actual_Text12 = webDriver.findElement(By.cssSelector("h4"))
				.getText();
		...
		String actual_Text0 = webDriver.findElement(By.cssSelector("#answers_oper1_q2 > fieldset > h4"))
				.getText();
		...
		// 2nd question.
		String actual_Text20 = webDriver.findElement(By.cssSelector("#answers_oper3_q2 > fieldset > h4"))
				.getText();
		...
		// both and continue.
		// 1st question.
		String actual_Text23 = webDriver.findElement(By.cssSelector("h4"))
				.getText();
		...
		// 2nd question.
		String actual_Text25 = webDriver.findElement(By.cssSelector("#answers_oper4_q2 > fieldset > h4"))
				.getText();
		...
		// both and continue.
		// 1st question.
		String actual_Text27 = webDriver.findElement(By.cssSelector("h4"))
				.getText();
		...
		// 2nd question.
		String actual_Text29 = webDriver.findElement(By.cssSelector("#answers_oper5_q2 > fieldset > h4"))
				.getText();
		...
		// 1st question.
		String actual_Text31 = webDriver.findElement(By.cssSelector("h4"))
				.getText();
		...
		// 2nd question.
		String actual_Text33 = webDriver.findElement(By.cssSelector("#answers_oper6_q2 > fieldset > h4"))
				.getText();
		...
		String actual_Text35 = webDriver
				.findElement(By.cssSelector("h4")).getText();
		...
		// 2nd question meaning.
		String actual_Text38 = webDriver.findElement(By.cssSelector("#answers_woman_financial_condition > fieldset > p")).getText();
		...
		// 2nd question meaning.
		String actual_Text42 = webDriver.findElement(By.cssSelector("#answers_agi_3_year_exceeds_but_uncommon > fieldset > p")).getText();
		...
		// 2nd question meaning.
		String actual_Text48 = webDriver.findElement(By.cssSelector("#answers_woman_asset_transfer_excusable > fieldset > p")).getText();
