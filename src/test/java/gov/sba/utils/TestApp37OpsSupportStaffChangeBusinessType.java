    ...
    public void testMainTest() throws Exception {
        try {
            ...
            if (commonApplicationMethods.checkApplicationExists(webDriver, "EDWOSB", "Active")) {
                ...
                commonApplicationMethods.returnAppToVendorMethd(webDriver, 11, duns_Number, "EDWOSB", "Active",
                ...
                webDriver
                        .findElement(
                                By.xpath("//div[@class='vendor-support-link']/a[contains(text(),'Vendor Support')]"))
                        .click();
