...
public class Us801AmIEligibleTs9 {
	...
	public void mainTest() throws Exception {
		logger.info("User is eligible for ALL programs, 8(a), WOSB set-asides, EDWOSB & Hob-zone");
		...
		String actual_Text0 = webDriver.findElement(By.xpath("//div[@id='naics_fed_set_asides']/div[2]/div/div/div"))
				.getText();
		String expected_Text0 = "Yes, the WOSB Federal Contract Program set-asides are available in your primary NAICS code.";
