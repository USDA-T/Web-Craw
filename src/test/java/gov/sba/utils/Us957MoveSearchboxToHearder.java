...
public class Us957MoveSearchboxToHearder {
	...
	public void mainTest() throws Exception {
		...
		assertEquals("Entity 37 Legal Business Name", webDriver.findElement(By.cssSelector(".usa-heading")).getText());
		...
		assertTrue(webDriver.getPageSource().contains("Women-Owned Small Business  Program Certification"));
