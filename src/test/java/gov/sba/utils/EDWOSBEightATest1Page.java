...
public class EDWOSBEightATest1Page {
    private static final Logger logger = LogManager.getLogger(WOSBEightATestPage.class.getName());
    WebDriver webDriver;

    public EDWOSBEightATest1Page(WebDriver webDriver) {
        this.webDriver = webDriver;
    }

    public void EDWOSBEightATest1() throws Exception {
