...
//Clear the search duns number in the search box and very that that the duns number is thesame on the search result.
	...
	//business type.
	String actual_Text1=webDriver.findElement(By.xpath("//form[@id='associate_business']/div[3]/div[3]/span[2]")).getText();
	String expected_Text1="s-corp";
	assertEquals(actual_Text1, expected_Text1);
	//Duns.
	String actual_Text2=webDriver.findElement(By.xpath("//form[@id='associate_business']/div[2]/div[3]/span[2]")).getText();
	String expected_Text2="275276652";
	assertEquals(actual_Text2, expected_Text2);
	//address
	String actual_Text3=webDriver.findElement(By.xpath("//form[@id='associate_business']/div[4]/div/span[2]")).getText();
...
//Loacte the view profile button and click on it.
	...
	Thread.sleep(3000);
//Locate and verify the ASSOCIATED VENDOR ADMINISTRATOR profile link and click on it.
...
//Verify that user has access to the the vendors Documents library.
	assertElementpresent("Document Library", webDriver.findElement(By.xpath("//div[@id='business_search']/div[5]/div")));
...
//Locate Entity 37 Legal Business Name and click on it to view all the company information.
