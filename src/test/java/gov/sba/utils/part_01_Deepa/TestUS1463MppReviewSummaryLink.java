...
public class TestUS1463MppReviewSummaryLink extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            String stext = webDriver.findElement(By.xpath("//h4[contains(text(),'ation is processed and evaluated, a member of the All Smal')]")).getText();
            logger_US1463.info(stext);
            assertEquals(stext, "Thank you for submitting your application to participate in SBA’s All Small Mentor-Protégé Program. Once your application is processed and evaluated, a member of the All Small Mentor-Protégé Program Office will contact you to verify your application status.");
            ...
            Boolean found = false;
            try {
                webDriver.findElement(By.xpath("//a[ @class='tab-link' and contains ( text(), 'Certificate Letter' ) ]"));
                found = true;
            }catch (Exception e){
