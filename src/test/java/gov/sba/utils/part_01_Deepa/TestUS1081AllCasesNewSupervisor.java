...
public class TestUS1081AllCasesNewSupervisor extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            List<WebElement> rows_Body = webDriver.findElements(By.xpath("//div[@id='table-search']/table/tbody/tr[ td[position()=2]/a[ contains( text(),'" + duns_Number + "') ] ]")); // Get
            ...
            webDriver.findElement(By.xpath("//div[contains(@class,'review_nav')]/p/a[contains(text(),'Vendor Overview')]")).click();
            Thread.sleep(1500);
            webDriver.findElement(By.linkText("Return to Vendor")).click();
            Thread.sleep(1500);
            try {webDriver.switchTo().alert().accept();}catch (Exception e){logger_US1081.info("None Alert");}

            List<WebElement> rows_Body_01 = webDriver.findElements(By.xpath("//table[@id='certifications']/tbody/tr[ td[position()=4 and contains(text(),'Draft')]  ]")); // Get
