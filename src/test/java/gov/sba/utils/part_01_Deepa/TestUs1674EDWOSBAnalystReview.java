    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            List<WebElement> current_Row_EDWOSB = webDriver.findElements(By.xpath(
                    "//div[@id='table-search']/table/tbody/tr[  td[position()=2]/a[contains(text(),'" + duns_Number + "')]  ]/td[1]/a"));
            ...
            webDriver.findElement(By.xpath(
                    "//div[@id='table-search']/table/tbody/tr[  td[position()=2]/a[contains( text(), '" + duns_Number + "' )]  ]/td[1]/a")).click();


                webDriver.findElement(By.xpath("//input[@id='submit_button']")).click();

                // Question Review Page
                webDriver.findElement(By.xpath("//ul[contains(@class,'usa-sidenav-list')]/li/a[contains(text(),'Question review')]")).click();
                ...
                webDriver.findElement(By.xpath("//ul[contains(@class,'usa-sidenav-list')]/li/a[contains(text(),'Financial review')]")).click();

                //Come back Later add a new test case for Questionaire flow and check Enabled //Use below later
                ...
                webDriver.findElement(By.xpath("//input[@name='commit']"))
                        .click();
