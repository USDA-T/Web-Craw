    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            if (current_Row_WOSB.size() > 0) {
                ...
                webDriver.findElement(By.xpath("//table[@id='certifications']/tbody/tr/td/a[contains(text(),'WOSB')]")).click();
...
//
//            current_Row_WOSB = webDriver.findElements(By.xpath(
//                    "//div[@id='table-search']/table/tbody/tr[  td[3][contains(text(),'WOSB')]  and td[8][contains(text(),'ctive')]   ]"));
//
//            if (current_Row_WOSB.size() <= 0) {
//
