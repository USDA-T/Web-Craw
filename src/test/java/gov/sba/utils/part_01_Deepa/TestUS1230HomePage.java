    ...
    public void testMainTest() throws Exception {
        ...
        try {
            List<WebElement> upcoming_Event = webDriver
                    .findElement(By.xpath("//div[contains(@class,'usa-width-one-whole') and contains(@class,'row_block')]"))
        ...
        try {
            Actual_Text = webDriver
                    .findElement(By.xpath("//div[contains(@class,'currently-grey-box') and contains(@class,'usa-width-one-whole')]"))
                    .getText();
