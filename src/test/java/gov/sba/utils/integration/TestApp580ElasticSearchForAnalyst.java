...
public class TestApp580ElasticSearchForAnalyst extends TestCase {
    ...
    private static final Logger logger = LogManager.getLogger(TestApp580ElasticSearchForAnalyst.class.getName());
        ...
        if (webDriver.getPageSource().contains("WOSB")) {
            ...
            if (webDriver.getPageSource().contains("EDWOSB")) {
                ...
                if (webDriver.getPageSource().contains("MPP, 8(a) Document Upload")) {
                    ...
                    Actual_Text = webDriver.findElement(By.xpath("//div[@id='table-search']/table/tbody/tr/td"))
                            .getText();
