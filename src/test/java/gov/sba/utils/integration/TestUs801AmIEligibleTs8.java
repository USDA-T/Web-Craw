...
public class TestUs801AmIEligibleTs8 extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(TestUs801AmIEligibleTs8.class.getName());
    ...
    if (webDriver.getCurrentUrl().contains("qa.sba-one")) {
      try {
        ...
        String actual_error4 = webDriver
            .findElement(
                By.xpath("//div[@id='unconditional_direct_51_percent']/div/div[2]/ul/li[2]"))
            .getText();
        ...
        String actual_error5 = webDriver
            .findElement(
                By.xpath("//div[@id='unconditional_direct_51_percent']/div/div[2]/ul/li[3]"))
            .getText();
        ...
        // meaning of the question.
        String actual_Text6 =
            webDriver.findElement(By.xpath("//div[@id='for_profit']/div/div/p")).getText();
        ...
        String actual_Text7 =
            webDriver.findElement(By.xpath("//div[@id='for_profit']/div/div[2]/ul/li")).getText();
        ...
        String actual_Text8 = webDriver
            .findElement(By.xpath("//div[@id='for_profit']/div/div[2]/ul/li[2]")).getText();
        String expected_Text8 =
        ...
        String actual_Text9 = webDriver
            .findElement(By.xpath("//div[@id='for_profit']/div/div[2]/ul/li[3]")).getText();
        String expected_Text9 =
        ...
        String actual_Text10 =
            webDriver.findElement(By.xpath("//div[@id='non_suspended']/div/div/p")).getText();
        String expected_Text10 =
        ...
        String actual_Text11 =
            webDriver.findElement(By.xpath("//div[@id='non_suspended']/div/div[2]/p")).getText();
        String expected_Text11 =
        ...
        // meaning of the question.
        String actual_Text12 =
            webDriver.findElement(By.xpath("//div[@id='us_business']/div/div/p")).getText();
        String expected_Text12 =
        ...
        String actual_Text13 =
            webDriver.findElement(By.xpath("//div[@id='us_business']/div/div[2]/p[2]")).getText();
        ...
        // meaning of the question.
        String actual_Text14 =
            webDriver.findElement(By.xpath("//div[@id='small_naics']/div/div/p")).getText();
        ...
        String actual_Text15 =
            webDriver.findElement(By.xpath("//div[@id='small_naics']/div/div[2]/ul/li")).getText();
        ...
        wait.until(ExpectedConditions.elementSelectionStateToBe(
            By.xpath("//div[@id='naics_fed_set_asides']/div/div/p"), false));
        ...
        String actual_Text22 = webDriver
            .findElement(By.xpath("//div[@id='economically_disadvantaged_wosb']/div/div/p"))
            .getText();
        ...
        String actual_Text25 = webDriver
            .findElement(
                By.xpath("//div[@id='economically_disadvantaged_wosb']/div/div[2]/ul/li[2]"))
            .getText();
        ...
        String actual_Text26 =
            webDriver.findElement(By.xpath("//div[@id='economically_disadvantaged_8a']/div/div/p"))
                .getText();
        ...
        String actual_Text32 = webDriver
            .findElement(By.xpath("//div[@id='socially_disadvantaged']/div/div[2]/ul/li[2]"))
            .getText();
        ...
        // meaning of the question.
        String actual_Text33 =
            webDriver.findElement(By.xpath("//div[@id='socially_disadvantaged_chronic']/div/div/p"))
                .getText();
        ...
        // meaning of the question.
        String actual_Text35 =
            webDriver.findElement(By.xpath("//div[@id='eighta_certified']/div/div/p")).getText();
        ...
        wait.until(ExpectedConditions.elementSelectionStateToBe(
            By.xpath("//div[@id='eighta_one_time_used']/div/div/p"), false));
        // Locate the next question and select NO and verify the More Detail
        // meaning of the question.
        ...
        wait.until(ExpectedConditions.elementSelectionStateToBe(
            By.xpath("//div[@id='address_in_hubzone']/div/div/p"), false));
        // Locate the next question and select NO and verify the More Detail
        // meaning of the question.
        String actual_Text39 =
            webDriver.findElement(By.xpath("//div[@id='address_in_hubzone']/div/div/p")).getText();
        String expected_Text39 =
      ...
      if (webDriver.getCurrentUrl().contains("staging")) {
        try {
          ...
          String actual_Text2 = webDriver
              .findElement(By.cssSelector("div.usa-width-one-half > p.lead-para")).getText();
          String expected_Text2 =
              "Are the qualifying individual(s) of the firm who are applying for SBA small business programs U.S. citizens?";
          assertEquals(actual_Text2, expected_Text2);
          // Validate the meaning for question one.
          ...
          String actual_error = webDriver
              .findElement(
                  By.xpath("//div[@id='unconditional_direct_51_percent']/div/div[2]/ul/li"))
              .getText();
          String expected_error =
              "Qualifying individual(s) mustunconditionally and directly own and controlat least 51% of the business.";
          assertEquals(actual_error, expected_error);
          ...
          String actual_Text15 = webDriver
              .findElement(By.xpath("//div[@id='small_naics']/div/div[2]/ul/li")).getText();
          String expected_Text15 =
              "SBA’s size standards define whether a business entity is small and, thus, eligible for Government programs and preferences reserved for “small business” concerns. Size standards have been established for types of economic activity, or industry, under the North American Industry Classification System (NAICS). To determine the size standard associated with a particular NAICS code, refer to the table of size standards in the Small Business Size Regulations, 13 CFR § 121.201. Size standards are expressed in annual receipts for services NAICS codes and in number of employees for manufacturing NAICS codes. Information about how SBA calculates a firm’s size can be found in the Code of Federal Regulations (CFR) at 13 CFR § 121.104 and 13 CFR § 121.106.";
          assertEquals(actual_Text15, expected_Text15);
          String actual_Text16 = webDriver
          ...
          String actual_Text24 = webDriver
              .findElement(
                  By.xpath("//div[@id='economically_disadvantaged_wosb']/div/div[2]/ul/li"))
              .getText();
          String expected_Text24 =
              "The woman’s total assets must be valued at $6 million or less. This calculation is based on the fair market value of all assets, including the primary residence and the value of the business concern. This calculation excludes funds invested in a qualified IRA account or other official retirement account that are unavailable until retirement age without a significant penalty.";
          assertEquals(actual_Text24, expected_Text24);
          ...
          String actual_Text26 = webDriver
              .findElement(By.xpath("//div[@id='economically_disadvantaged_8a']/div/div/p"))
              .getText();
          String expected_Text26 =
              "Are the individual(s) interested in participating in SBA small business programs economically disadvantaged under 8(a) BD Program guidelines?";
          assertEquals(actual_Text26, expected_Text26);
          ...
          String actual_Text29 = webDriver
              .findElement(
                  By.xpath("//div[@id='economically_disadvantaged_8a']/div/div[2]/ul/li[2]"))
              .getText();
          String expected_Text29 =
              "The individual’s net worth must be less than $250,000. This calculation excludes the individual’s ownership interest in the applicant concern, the individual’s equity interest in his or her primary residence, funds invested in a qualified Individual Retirement Accounts (IRA) or other official retirement account that is unavailable until retirement age without a significant penalty, and income received from an S Corp, LLC or partnership that was reinvested in the business or used for paying taxes arising in the normal course of operations of the business.";
          assertEquals(actual_Text29, expected_Text29);
          String actual_Text30 = webDriver
              .findElement(
                  By.xpath("//div[@id='economically_disadvantaged_8a']/div/div[2]/ul/li[3]"))
              .getText();
          String expected_Text30 =
              "The individual’s personal income must be $250,000 or less. This calculation is based on the individual’s adjusted gross income averaged over the last three years.";
          assertEquals(actual_Text30, expected_Text30);
          ...
          String actual_Text33 = webDriver
              .findElement(By.xpath("//div[@id='socially_disadvantaged_chronic']/div/div/p"))
              .getText();
          String expected_Text33 =
              "Do you consider yourself socially disadvantaged because of you experienced bias of a chronic and substantial nature?";
          assertEquals(actual_Text33, expected_Text33);
          ...
          webDriver.findElement(By.id("no_button_socially_disadvantaged_chronic")).click();
          wait.until(ExpectedConditions.elementSelectionStateToBe(
              By.xpath("//div[@id='eighta_certified']/div/div/p"), false));
          // Locate the next question and select NO and verify the More Detail
          // meaning of the question.
          String actual_Text35 =
              webDriver.findElement(By.xpath("//div[@id='eighta_certified']/div/div/p")).getText();
          ...
          logger.info("Claiming EDWOSB question was validated");
          // Validate the detail meaning.
          String actual_Text38 =
              webDriver.findElement(By.xpath("//div[@id='eighta_one_time_used']/div/div[2]/ul/li"))
                  .getText();
          String expected_Text38 =
              "If you are not a member of a presumed group, you may still be eligible for admission to the 8(a) BD program on a case-by-case basis if you demonstrate you have experienced bias of a chronic and substantial nature.";
          assertEquals(actual_Text38, expected_Text38);
          ...
          String actual_Text39 = webDriver
              .findElement(By.xpath("//div[@id='address_in_hubzone']/div/div/p")).getText();
          String expected_Text39 =
              "Is the address of the location where the majority of the firm’s employees work located in a HUBZone?";
          assertEquals(actual_Text39, expected_Text39);
          logger.info(" question was validated");
          ...
          // Verify searched results.
          wait.until(ExpectedConditions
              .elementSelectionStateToBe(By.cssSelector("div.not_eligible"), false));
          // 8(a)
          String actual_Text4 = webDriver.findElement(By.cssSelector("div.not_eligible")).getText();
          String expected_Text4 =
              "Based on the information you provided, you may not be eligible for the 8(a) BD Program:\nQualifying individuals must meet the economically disadvantaged financial criteria to participate in the program. However, many factors are taken into consideration during application review and it is possible that you may still qualify to participate. Contact your local SBA 8(a) Business Office for more information.\nQualifying individuals must meet socially disadvantaged criteria in order to participate in the program.";
        ...
        if (webDriver.getCurrentUrl().contains("newqa.sba")) {
          try {
            ...
            // Certify.SBA.Gov landing page and click on it.
            webDriver
                .findElement(By.xpath("//div[@id='header_nav']/header/nav/div/ul/li[3]/a/span"))
                .click();
            wait.until(ExpectedConditions.elementSelectionStateToBe(By.xpath(".//*[@id='am-i']/h1"),
                false));
            // Verify that user is navigated to the right page.
            String actual_error6 = webDriver.findElement(By.xpath(".//*[@id='am-i']/h1")).getText();
            String expected_error6 = "Is there an SBA Contracting Program for me?";
            ...
            String actual_Text3 = webDriver
                .findElement(By.cssSelector("div.details.usa-width-one-half > p")).getText();
            String expected_Text3 =
                "A U.S.citizenmeans a person born or naturalized in the United States. Resident aliens and holders of permanent visas are not considered to be citizens for program purposes.";
            assertEquals(actual_Text3, expected_Text3);
            // verify and click on the Yes button.
            ...
            String actual_error3 = webDriver
                .findElement(
                    By.xpath(".//*[@id='unconditional_direct_51_percent']/div[1]/div[1]/p"))
                .getText();
            String expected_error3 = "Is the 51% ownership of the firm unconditional and direct?";
            assertEquals(actual_error3, expected_error3);
            // Verify the detail meaning for the 2nd question.
            ...
            logger.info("Third question was validated");
            // Validate the More details text.
            String actual_Text7 = webDriver
                .findElement(By.xpath("//div[@id='for_profit']/div/div[2]/ul/li")).getText();
            String expected_Text7 =
                "Non-profit entities are ineligible to participate in most SBA small business programs.";
            assertEquals(actual_Text7, expected_Text7);
            String actual_Text8 = webDriver
            ...
            webDriver.findElement(By.id("yes_button_for_profit")).click();
            wait.until(ExpectedConditions.elementSelectionStateToBe(
                By.xpath("//div[@id='non_suspended']/div/div/p"), false));
            // Locate the 4th question and select NO and verify the More Detail
            // meaning of the question.
            String actual_Text10 =
                webDriver.findElement(By.xpath("//div[@id='non_suspended']/div/div/p")).getText();
            ...
            String actual_Text11 = webDriver
                .findElement(By.xpath("//div[@id='non_suspended']/div/div[2]/p")).getText();
            String expected_Text11 =
                "Debarred or suspended firms or firms owned by debarred or suspended individual(s) are ineligible for admission to SBA small business programs.";
            assertEquals(actual_Text11, expected_Text11);
            webDriver.findElement(By.id("yes_button_non_suspended")).click();
            ...
            assertEquals(actual_Text12, expected_Text12);
            logger.info("5th question was validated");
            String actual_Text13 = webDriver
                .findElement(By.xpath("//div[@id='us_business']/div/div[2]/p[2]")).getText();
            String expected_Text13 = "None";
            assertEquals(actual_Text13, expected_Text13);
            webDriver.findElement(By.id("yes_button_us_business")).click();
            wait.until(ExpectedConditions
            ...
            String actual_Text20 =
                webDriver.findElement(By.xpath("//div[@id='naics_fed_set_asides']/div/div[2]/p[2]"))
                    .getText();
            String expected_Text20 =
                "The federal government may restrict competition under the WOSB Program only in certain industries.13 C.F.R. 127.500. SBA has designated those industries applicable to the WOSB Program by North American Industry Classification System (NAICS) code. There are two types of set-asides under the WOSB Program: set asides for Woman Owned Small Businesses and set asides for Economically Disadvantaged Woman Owned Small Businesses. The type of set-aside allowed under the WOSB Program is dictated by the applicable NAICS code of the solicitation. To learn more about the types of set-asides and the designations available via this program, please visitSBA.gov/WOSB.";
            assertEquals(actual_Text20, expected_Text20);
            ...
            String actual_Text23 = webDriver
                .findElement(
                    By.xpath("//div[@id='economically_disadvantaged_wosb']/div/div[2]/p[2]"))
                .getText();
            String expected_Text23 =
                "Firms owned by economically disadvantaged women may qualify as Economically Disadvantaged Women-Owned Small Businesses (EDWOSBs) under the WOSB Program. Under this program, the determination of whether an individual is an economically disadvantaged woman requires an evaluation of her total assets, net worth, and personal income for the past three years. To be considered an economically disadvantaged woman for the WOSB program, the individual must meet the thresholds described below:";
            assertEquals(actual_Text23, expected_Text23);
            ...
            String actual_Text28 = webDriver
                .findElement(
                    By.xpath("//div[@id='economically_disadvantaged_8a']/div/div[2]/ul/li"))
                .getText();
            String expected_Text28 =
                "The individual’s total assets must be valued at $4 million or less. This calculation is based on the fair market value of all assets, including the primary residence and the value of the business concern. This calculation excludes funds invested in a qualified IRA account or other official retirement account.";
            assertEquals(actual_Text28, expected_Text28);
            ...
            String actual_Text34 = webDriver
                .findElement(
                    By.xpath("//div[@id='socially_disadvantaged_chronic']/div/div[2]/p[2]"))
                .getText();
            String expected_Text34 =
                "If you are not a member of a presumed group, you may still be eligible for admission to the 8(a) BD program on a case-by-case basis if you demonstrate you have experienced bias of a chronic and substantial nature.";
            assertEquals(actual_Text34, expected_Text34);
            ...
            String actual_Text35 = webDriver
                .findElement(By.xpath("//div[@id='eighta_certified']/div/div/p")).getText();
            String expected_Text35 =
                "Has the firm previously been certified as an 8(a) participant?";
            assertEquals(actual_Text35, expected_Text35);
            logger.info("15th question was validated");
            // Verify the detail meaning.
            String actual_Text36 =
                webDriver.findElement(By.xpath("//div[@id='eighta_certified']/div/div[2]/ul/li[2]"))
                    .getText();
            String expected_Text36 =
                "This applies to any business that previously participated in the 8(a) BD Program, even if ownership and control of the firm has completely changed.";
            assertEquals(actual_Text36, expected_Text36);
            ...
            // Validate the detail meaning.
            String actual_Text38 = webDriver
                .findElement(By.xpath("//div[@id='eighta_one_time_used']/div/div[2]/ul/li"))
                .getText();
            String expected_Text38 =
                "If you are not a member of a presumed group, you may still be eligible for admission to the 8(a) BD program on a case-by-case basis if you demonstrate you have experienced bias of a chronic and substantial nature.";
            assertEquals(actual_Text38, expected_Text38);
            ...
            logger.info(" question was validated");
            // Verify the detail meaning.
            String actual_Text40 =
                webDriver.findElement(By.xpath("//div[@id='address_in_hubzone']/div/div[2]/ul/li"))
                    .getText();
            String expected_Text40 =
                "The Historically Underutilized Business Zone (HUBZone) program provides federal contracting assistance for qualified small business firms located in HUBZones in an effort to increase employment opportunities, investment, and economic development in such areas.";
            assertEquals(actual_Text40, expected_Text40);
            ...
            // 8(a)
            String actual_Text4 =
                webDriver.findElement(By.cssSelector("div.not_eligible")).getText();
            String expected_Text4 =
                "Based on the information you provided, you may not be eligible for the 8(a) BD Program:\nQualifying individuals must meet the economically disadvantaged financial criteria to participate in the program. However, many factors are taken into consideration during application review and it is possible that you may still qualify to participate. Contact your local SBA 8(a) Business Office for more information.\nQualifying individuals must meet socially disadvantaged criteria in order to participate in the program.";
            assertEquals(actual_Text4, expected_Text4);
            // Women-Owned Small Business (WOSB)
          ...
          if (webDriver.getCurrentUrl().contains("localhost")) {
            ...
            logger.info(
                "Please make sure the env you are running the test is added to the params, fyi env is "
