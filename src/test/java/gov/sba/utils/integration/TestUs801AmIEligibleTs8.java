...
public class TestUs801AmIEligibleTs8 extends TestCase {
  ...
  public void testMainTest() throws Exception {
    try {
      ...
      String actual_Text8 =
          webDriver.findElement(By.xpath("//div[@id='for_profit']/div/div[2]/ul/li[2]")).getText();
      ...
      String actual_Text9 =
          webDriver.findElement(By.xpath("//div[@id='for_profit']/div/div[2]/ul/li[3]")).getText();
      ...
      String actual_Text16 =
          webDriver.findElement(By.xpath("//div[@id='small_naics']/div/div[2]/ul/li[2]")).getText();
      ...
      String actual_Text17 =
          webDriver.findElement(By.xpath("//div[@id='women_owning_business']/div/div/p")).getText();
      ...
      String actual_Text19 =
          webDriver.findElement(By.xpath("//div[@id='naics_fed_set_asides']/div/div/p")).getText();
      ...
      String actual_Text22 =
          webDriver.findElement(By.xpath("//div[@id='economically_disadvantaged_wosb']/div/div/p"))
              .getText();
      ...
      // Verify the detail meaning.
      String actual_Text32 =
          webDriver.findElement(By.xpath("//div[@id='socially_disadvantaged']/div/div[2]/ul/li[2]"))
              .getText();
      ...
      // Locate the next question and select NO and verify the More Detail
      // meaning of the question.
      String actual_Text37 =
          webDriver.findElement(By.xpath("//div[@id='eighta_one_time_used']/div/div/p")).getText();
      ...
      wait.until(
          ExpectedConditions.elementSelectionStateToBe(By.cssSelector("div.not_eligible"), false));
      // 8(a)
