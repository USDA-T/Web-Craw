...
public class Test1234UswdsEdwosbUswdsSoleProprietor extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(Test1234UswdsEdwosbUswdsSoleProprietor.class.getName());
  ...
  public void testMainTest() throws Exception {
    ...
    SoleProprietorReturnCertPage soleProprietorReturnCert =
        new SoleProprietorReturnCertPage(webDriver);
