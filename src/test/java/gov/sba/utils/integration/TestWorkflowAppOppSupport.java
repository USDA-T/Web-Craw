...
@Category({gov.sba.utils.integration.StableTests.class}) public class TestWorkflowAppOppSupport
    extends TestCase {
    ...
    @Test public void testMainTest() throws Exception {
       ...
       */
            ...
            assertEquals("Vendor Support",
                find_Element(webDriver, "Opp_Support_Page_Test_Business_Search").getText()
                    .toString());
