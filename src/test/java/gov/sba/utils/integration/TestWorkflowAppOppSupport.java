  ...
  public void testMainTest() throws Exception {
    ...
    try {
        /* US1280- Search Government ; Get Email,First,Name,Last from the Db to use as serach term in UI Connect SBAONE QA DB -to get data from DB
         TestWorkflowAppOppSupport.info(returned_GovProfile_Rows[1][1]); // pass Government/vendor profile criteria
         TestUserAppProfileSearchType.TestuserProfileSearch(webDriver, // returned_GovProfile_Rows[1][1],Gov_Radio_xpath,Expected_Result);*/
        ...
        TestuserProfileSearch(webDriver, "QA", "Opp_Support_Page_Vendor_Prof_Search", "Vendor user profile");
      ...
      logger.info(e.toString());
        CommonApplicationMethods.take_ScreenShot_TestCaseName(webDriver, new String[]{"TestWorkflowAppOppSupport", "Exception"});
