...
public class TestWorkflowWOSBSupervisor extends TestCase {
    private static final Logger logger = LogManager.getLogger(TestWorkflowWOSBSupervisor.class.getName());
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            List<WebElement> current_Row_WOSB = find_Elements(webDriver, "xpath", "//div[@id='table-search']/table/tbody/tr[  td[position()=2]/a[contains(text(),'" + duns_Number + "')]  ]/td[1]/a", true);
            //List<WebElement> current_Row_WOSB = find_Elements(webDriver, "xpath", "//div[@id='table-search']/table/tbody/tr[  td[position()=2]/a[contains(text(),'146323332')]  ]/td[1]/a");
