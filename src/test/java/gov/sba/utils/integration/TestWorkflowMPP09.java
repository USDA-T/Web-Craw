 ...
 * TestWorkflowMPP + 09 Vendor admin create MPP application with having size detemination, No Active Agreement and without Needs
 * Analyst Review the Submitted MPP application, Supervisor approves it.
 */


@Category({StableTests.class}) public class TestWorkflowMPP09 extends TestCase {
