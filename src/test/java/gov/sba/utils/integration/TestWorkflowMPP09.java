 ...
 * TestWorkflowMPP + 09 Vendor admin create MPP application with having size detemination, No Active
 * Agreement and without Needs Analyst Review the Submitted MPP application, Supervisor approves it.
 */


@Category({StableTests.class})
public class TestWorkflowMPP09 extends TestCase {
  Logger logger = LogManager.getLogger(TestWorkflowMPP09.class.getName());
  ...
  @Test
  public void testWorkflowMPP09() throws Exception {
    try {
      ...
      take_ScreenShot_TestCaseName(webDriver, new String[] {"TestWorkflowMPP09", "Exception"});
      throw e;
