...
public class Test1234US801AmIEligibleTs9 extends TestCase {
	private static final Logger logger = LogManager.getLogger(Test1234US801AmIEligibleTs9.class.getName());
	...
	@Test
	public void test1234US801AmIEligibleTs9() throws Exception {
		...
		wait.until(ExpectedConditions.elementSelectionStateToBe(By.xpath("//div[@id='for_profit']/div/div/p"), false));
		...
		wait.until(
				ExpectedConditions.elementSelectionStateToBe(By.xpath("//div[@id='non_suspended']/div/div/p"), false));
		...
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.id("yes_button_non_suspended")));
		webDriver.findElement(By.id("yes_button_non_suspended")).click();
		wait.until(ExpectedConditions.elementSelectionStateToBe(By.xpath("//div[@id='us_business']/div/div/p"), false));
		...
		// verify and click on the Yes button.
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.id("yes_button_women_owning_business")));
		...
		jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.id("no_button_eighta_certified")));
		...
		// verify and click on the Yes button.
		jse.executeScript("arguments[0].scrollIntoView()",
				webDriver.findElement(By.id("yes_button_employees_in_hubzone")));
		webDriver.findElement(By.id("yes_button_employees_in_hubzone")).click();
		// Verify searched results.
		wait.until(
				ExpectedConditions.elementSelectionStateToBe(By.cssSelector("#edwosb > div.eligible > p > b"), false));
