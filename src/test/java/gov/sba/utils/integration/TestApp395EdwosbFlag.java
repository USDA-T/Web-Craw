...
public class TestApp395EdwosbFlag extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            // questions
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_389_N").getAttribute("outerHTML")
            ...
            // continue.
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_390_Y").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            ...
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_391_Y").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            ...
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_393_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_394_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_395_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_396_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_397_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_398_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_398_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked")); // Locate the
                                                         // Citizenship &
                                                         // Ownership question
                                                         // 1and2, Verify,select
                                                         // //
                                                         // No
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_399_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");

            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_404_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_405_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));

            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_406_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));

            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_407_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");

            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_408_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_409_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_410_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_411_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_412_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            assertTrue(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_413_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
            // Locate the SBA Exam & Daily Operations questions,Verify, select
            // No
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_414_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_414_N");
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
            // NetWorth
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_415_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_415_N");
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
            // Adjusted Gross Income
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_416_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_416_N");
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_417_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_417_N");
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");

            // Assets
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_418_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_418_N");
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_419_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_419_N");
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_420_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_420_N");
            click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");
            // Economic Disadvantage
            assertFalse(find_Element(webDriver, "EDWOSB_Questionnaire_Page_Ans_421_N").getAttribute("outerHTML")
                    .toLowerCase().contains("checked"));
            ...
            // section.
            // assertEquals(find_Element(webDriver,"SBA_EDWOSB_Financial_Title_H2"
            // ).getText(), "Financial
            // Data");
