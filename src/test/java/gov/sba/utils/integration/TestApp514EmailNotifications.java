...
public class TestApp514EmailNotifications extends TestCase {
	...
	private static final Logger logger_App514 = LogManager
			.getLogger(gov.sba.utils.integration.TestApp514EmailNotifications.class.getName());
	...
	public void testMainTest() throws Exception {
		...
		if (flagvalue.contains("0")) {
			...
			try {
				...
				List<WebElement> count_Active = webDriver.findElements(By.xpath(
