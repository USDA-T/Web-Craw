...
WorkFlows for MPP - Accommodating best minimal Workflow Tests
TestWorkflowMPP +  01. Vendor Draft Create , logout. Update draft submit , Analyst Review, Supervisor Approve - 8a Yes
                      ...
                      06. Vendor  Create , Submit, Vendor Create another Submit
                      06. Vendor  Create ......
...
public class TestWorkflowMPP04 extends TestCase {
    Logger logger = LogManager.getLogger(TestWorkflowMPP04.class.getName());
...
//        clear_Env_Chrome();
    ...
    /*Test US1647- MPP financial section link disabled for application not having financial partners information*/
    @Test
    public void testMainTest() throws Exception {
        try {
            ...
            take_ScreenShot_TestCaseName(webDriver, new String[] {"TestWorkflowMPP04", "Exception"});
            throw e;
