...
public class TestApp8AInterimQuestion extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(TestApp8AInterimQuestion.class.getName());
  ...
  public void testMainTest() throws Exception {
    ...
    Expected_Text =
        "By submitting this certification I, Ricky X, am an officer or owner of Entity 10 Legal Business Name authorized to represent it and electronically sign this certification on its behalf.";
    assertEquals(Actual_Text, Expected_Text);
