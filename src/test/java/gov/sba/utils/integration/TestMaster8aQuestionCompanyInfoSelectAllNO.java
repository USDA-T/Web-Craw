...
import junit.framework.TestCase;
  ...
  public class TestMaster8aQuestionCompanyInfoSelectAllNO extends TestCase {
          ...
          public void testMainTest() throws Exception {
              ...
              logger.info("As an 8(a) applicant, I want to enter my business information on an 8(a) application, No with skip to review flow.");
              // Login to dashboard.
              ...
              assertEquals(Actual_Text, Expected_Text);
              //Detail Section.
              Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_prior_naics_code_work']/fieldset/p[2]")).getText();
              ...
              assertEquals(Actual_Text, Expected_Text);
              //Detail Section.
              Actual_Text = webDriver.findElement(By.xpath("//div[@id='answers_small_for_mpp_naics_code']/fieldset/p[2]")).getText();
