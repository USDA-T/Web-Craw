...
TestWorkflowEDWOSB +  01. Vendor  Create  - 8a Yes , logout. Update draft submit , Analyst Review, Supervisor Approve
                      02. Vendor  Create  - 8a No , Submit, Analyst Review, Supervisor Approve
                      03. Vendor  Create  - 8a Yes, Submit, Analyst Review, Supervisor  reject
                      04. Vendor  Create  - 8a Yes, Submit, Analyst return, Vendor Change Draft , Resubmit, Analyst Review, Supervisor Approve
                      05. Vendor  Create  - 8a Yes, Submit, Analyst return, Vendor Change Draft , Resubmit, AAnalyst Review, Supervisor  reject
                      06. Vendor  Create  - 8a Yes, Submit, Annual Review, ReSubmit, Supervisor Review, Supervisor Approve
                      07. Vendor  Create  - 8a No , Submit, Annual Review, ReSubmit, Supervisor Review, Supervisor Reject
*/

@Category({gov.sba.utils.integration.StableTests.class})
public class TestWorkflowWOSB02 extends TestCase {
    private static final Logger logger = LogManager.getLogger(TestWorkflowWOSB02.class.getName());
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            delete_All_Application_Draft    (webDriver, 50, duns_Number);

            new LoginPageWithReference(webDriver, 50).Login_With_Reference();
