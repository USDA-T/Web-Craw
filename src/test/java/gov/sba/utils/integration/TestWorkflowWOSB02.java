...
@Category({gov.sba.utils.integration.StableTests.class}) public class TestWorkflowWOSB02
    extends TestCase {
    ...
    /* Login to dashboard. */
      ...
      /* Verify on Analyst Detremination page -Determination Made, Decision not displayed */
            ...
            assertTrue(find_Element(webDriver, "SBA_Review_Nav").getText()
                .contains("Decision: Self Certified"));
      ...
      /* Verify on Analyst Detremination page -Determination Made, Decision not displayed */
            ...
            take_ScreenShot_TestCaseName(webDriver,
                new String[] {"TestWorkflowEDWOSB01", "Exception"});
            throw e;
