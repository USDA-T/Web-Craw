...
public class Test1234US801AmIEligibleTs3 extends TestCase {
	private static final Logger logger = LogManager.getLogger(Test1234US801AmIEligibleTs3.class.getName());
	...
	@Test
	public void test1234US801AmIEligibleTs3() throws Exception {
		...
		try {
			...
			jse.executeScript("arguments[0].scrollIntoView()",
					webDriver.findElement(By.id("no_button_unconditional_direct_51_percent")));
