...
public class TestApp3748aApplicantAnswerCompanyInfoSection extends TestCase {
  ...
  public void testMainTest() throws Exception {
    try {
      ...
      // set forth in the Small Business Act, U.S. Small Business Administration (SBA) regulations
      // (13 CFR § 124.3), and also any statutory and regulatory provision referenced in those
      ...
      Expected_Text = "Please answer this question";
      assertEquals(Actual_Text, Expected_Text);
      // Verify question and detail section and Select Yes for the 1st question.
      ...
      // Verify question and detail section and Select Yes for the 2nd question.
      Actual_Text =
      ...
      // NO Detail section.
      webDriver.findElement(By.xpath("//div/input")).click();
      // Click on the on the Save and continue button and verify that user is navigated to the
      // review
      // page.
      CoreUtils.clickContinue(webDriver);
      // Review Section.
      ...
      Expected_Text = "Please answer this question";
      assertEquals(Actual_Text, Expected_Text);
      // Verify question and detail section and Select NO for the 1st question.
      Actual_Text = webDriver.findElement(By.cssSelector("h4")).getText();
      Expected_Text =
          "Have you performed work in the NAICS code in which you’re requesting business development assistance?";
      assertEquals(Actual_Text, Expected_Text);
      ...
      assertEquals(Actual_Text, Expected_Text);
      webDriver.findElement(By.xpath("//label[2]")).click();
      // Verify question and detail section and Select NO for the 2nd question.
      Actual_Text =
          webDriver.findElement(By.cssSelector("#answers_small_for_mpp_naics_code > fieldset > h4"))
              .getText();
      Expected_Text =
