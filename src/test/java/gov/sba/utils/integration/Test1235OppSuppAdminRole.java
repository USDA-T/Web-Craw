...
import static gov.sba.automation.CommonApplicationMethods.find_Elements_Optional;
...
public class Test1235OppSuppAdminRole extends TestCase {
  ...
  public void testMainTest() throws Exception {
    ...
    // Log in As OppSupport Staft - validate as per the US1235 Acceptance criteria on Opp Support
    // Staft/Admin page

    try {
      duns_Number = "159165917"; // Opp Supp Staft search vendor records.
      non_Vendor_searchDuns_Number(webDriver, "159165917"); // Click on the Business Name - opp Supp
      ...
      try { // Find Draft,Active,compeleted certification
        List<WebElement> rows_table =
            find_Elements_Optional(webDriver, "SBA_Table_My_Certifications");
