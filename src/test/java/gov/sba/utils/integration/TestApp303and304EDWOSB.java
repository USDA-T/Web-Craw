...
public class TestApp303and304EDWOSB extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        assertFalse(find_Element(webDriver, "Generic_Questionnaire_Page_Ans_Y").getAttribute("outerHTML").toLowerCase()
                .contains("checked"));
        ...
        assertTrue(find_Element(webDriver, "Generic_Questionnaire_Page_Ans_Y").getAttribute("outerHTML").toLowerCase()
                .contains("checked"));
        // Reset to Default
