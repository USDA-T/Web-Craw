...
public class TestUs1674EDWOSBAnalystReview extends TestCase {
  ...
  public void testMainTest() throws Exception {
    ...
    try {
      ...
      List<WebElement> current_Row_EDWOSB = CommonApplicationMethods.find_Elements(webDriver, "xpath", "//div[@id='table-search']/table/tbody/tr[  td[position()=2]/a[contains(text(),'" + duns_Number + "')]  ]/td[1]/a");
