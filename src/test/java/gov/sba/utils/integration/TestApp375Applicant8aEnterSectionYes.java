...
public class TestApp375Applicant8aEnterSectionYes extends TestCase {

  private static final Logger logger =
      LogManager.getLogger(TestApp375Applicant8aEnterSectionYes.class.getName());
  ...
  public void testMainTest() throws Exception {
    ...
    assertEquals(Actual_Text, Expected_Text);
    Actual_Text =
        webDriver.findElement(By.xpath("//form[@id='character']/ul/li/div/div[2]/h3")).getText();
    Expected_Text = "Delinquent Liens";
    assertEquals(Actual_Text, Expected_Text);
    Actual_Text =
        webDriver.findElement(By.xpath("//form[@id='character']/ul/li/div/div[3]/h3")).getText();
    Expected_Text = "Pending Lawsuit";
    assertEquals(Actual_Text, Expected_Text);
    Actual_Text =
        webDriver.findElement(By.xpath("//form[@id='character']/ul/li/div/div[4]/h3")).getText();
    Expected_Text = "Bankruptcy";
    assertEquals(Actual_Text, Expected_Text);
    webDriver.findElement(By.xpath("//input[@name='commit']")).click();
    // Signature Section.
