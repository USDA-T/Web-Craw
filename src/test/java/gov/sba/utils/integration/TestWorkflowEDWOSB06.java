    ...
    public void testMainTest() throws Exception {
        try {
          ...
          /*Create application Edwosb*/
           ...
           //List<WebElement> all_Cells = verify_Row_In_A_Table_And_Return(webDriver, new String[]{"EDWOSB Self-Certification","","Active","","","","Renew"});
           ...
           //List<WebElement> all_Cells_Active = verify_Row_In_A_Table_And_Return(webDriver, new String[]{"EDWOSB Self-Certification","","Active","","","",""});
           //assertNotNull(all_Cells_Active);
           //List<WebElement>  all_Cells_Expired = verify_Row_In_A_Table_And_Return(webDriver, new String[]{"EDWOSB Self-Certification","","Expired","","","",""});
           //assertNotNull(all_Cells_Expired);

        }
        catch (Exception e) {
            logger.info(e.toString());
            take_ScreenShot_TestCaseName(webDriver, new String[]{TestWorkflowEDWOSB06.class.getName(), "Exception"});
            throw e;
        }
    }
