 ...
 * Supervisor Reject
 */
/*@Category({gov.sba.utils.integration.StableTests.class, gov.sba.utils.integration.DeepaTests.class})*/
@Category({gov.sba.utils.integration.StableTests.class}) public class TestWorkflowWOSB06
    extends TestCase {
    ...
    @Test public void testMainTest() throws Exception {
       ...
       */
            ...
            assertNotNull(verify_Row_In_A_Table_And_Return(webDriver,
                new String[] {"WOSB Self-Certification", "Certificate", "Active", "", "", "",
                    "Renew"}));
