...
public class TestWorkflowAppMppPrepareLinkAndCopyUdates extends TestCase {
    private static final Logger logger = LogManager.getLogger(TestWorkflowAppMppPrepareLinkAndCopyUdates.class);
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            logger.info(
                    webDriver.findElement(By.xpath("//div [  ul [ contains(@class, 'ul-level-one' ) ]  ] ")).getText());
            ...
            Actual_Text = webDriver
                    .findElement(By
                            .xpath("//div/p[contains(text(),'ust meet the size standard for small in the NAICS code')]"))
                    .getText();
