 ...
 * TestWorkflowMPPReportDecline Vendor admin create MPP application ,approved by supervisor submit
 * Mpp annual report. Mpp analyst review the MPP annual report and Declined report.
 */
  ...
  public void testWorkflowMPPReportDecline() throws Exception {
    try {
      ...
      take_ScreenShot_TestCaseName(webDriver,
          new String[] {"TestWorkflowMPPReportDecline", "Exception"});
      throw e;
