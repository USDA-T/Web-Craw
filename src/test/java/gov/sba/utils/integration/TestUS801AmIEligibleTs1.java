...
public class TestUS801AmIEligibleTs1 extends TestCase {
  ...
  private static final Logger logger =
      LogManager.getLogger(TestUS801AmIEligibleTs1.class.getName());
  ...
  public void testMainTest() throws Exception {
    try {
      ...
      // Enter valid WOSB NAICS Code.
      webDriver.findElement(By.id("naics_code")).sendKeys("812320");
      // verify and click on the Yes button.
      ...
      String expected_Text0 =
          "Yes, WOSB Federal Contract Program set-asides are available in your primary NAICS code.";
      ...
      wait.until(ExpectedConditions
          .elementSelectionStateToBe(By.cssSelector("#edwosb > div.eligible > p > b"), false));
      ...
      String actual_Text02 =
          webDriver.findElement(By.cssSelector("#eighta > div.eligible > p > b")).getText();
      ...
      String actual_Text04 = webDriver
          .findElement(By.cssSelector("div.usa-width-one-third > #employees_in_hubzone")).getText();
      ...
      // Click on the Clear all responses button and validate the nav page.
