...
public class TestApp309DecisionIneligible_EDWOSB extends TestCase {
  ...
  //Login as vendor and Verfiy the dasboard, certificate,Sba_application table.
  ...
  public void testMainTest() throws Exception {
    ...
    try {
     ...
     //Select Determination -Decision as -Decline Ineligible
       webDriver.findElement(By.xpath("//div[contains(@class,'review_main')]/form[@id='new_determination']/fieldset/ul/li[input[contains(@name,'review[workflow_state]')]]/label[contains(text(),'Determination Made')]")).click();
      Select dropdown = new Select(webDriver.findElement(By.xpath("//select[@id='determination_decision']")));
     ...
     CommonApplicationMethods.navigationMenuClick(webDriver, "Logout");
      ...
      List<WebElement> listOfIneliglebEDWOSB = webDriver.findElements(By.xpath
          ("//*[@id='certifications']/tbody/"
          + "tr[  " + ""
          + "		(td[position()=4 and contains(text(),'neligible')]) "
