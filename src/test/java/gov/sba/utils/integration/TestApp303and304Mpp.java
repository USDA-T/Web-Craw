...
public class TestApp303and304Mpp extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        programs_Page.join_New_Program_CheckBoxes(webDriver, "Mpp");
        assertFalse(find_Element(webDriver, "General_Answer_Page_8A_117_Yes").getAttribute("outerHTML").toLowerCase()
                .contains("checked"));
        ...
        assertTrue(find_Element(webDriver, "General_Answer_Page_8A_117_Yes").getAttribute("outerHTML").toLowerCase()
                .contains("checked"));
        // Reset to Default
