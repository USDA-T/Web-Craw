package gov.sba.utils.integration;
  ...
  public class TestAppAddContributors extends TestCase {
        ...
        private static final Logger logger = LogManager
                .getLogger(TestAppAddContributors.class.getName());
        ...
        public void testMainTest() throws Exception {
            ...
            Actual_Text = webDriver.findElement(By.linkText("Start your individual application now")).getText();
            Expected_Text = "Start your individual application now";
            assertEquals(Actual_Text, Expected_Text);            
            Actual_Text = webDriver.findElement(By.linkText("Add another Disadvantaged Individual, if applicable")).getText();
            ...
            //Details section note.
            Actual_Text = webDriver.findElement(By.xpath("//article[@id='main-content']/p[3]")).getText();
            Expected_Text = "p Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.";
            assertEquals(Actual_Text, Expected_Text);
