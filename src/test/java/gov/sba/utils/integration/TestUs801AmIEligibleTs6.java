...
public class TestUs801AmIEligibleTs6 extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(TestUs801AmIEligibleTs6.class.getName());
  ...
  @Test
  public void testUs801AmIEligibleTs6() throws Exception {
    try {
      ...
      String expected_Text1 =
          "In order to participate in SBA small business programs, the firm must have a place of business in the U.S. or make a significant contribution to the U.S. economy.";
