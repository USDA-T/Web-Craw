...
public class TestEDWOSBRenewal extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            CommonApplicationMethods.take_ScreenShot_TestCaseName(webDriver, new String[]{TestEDWOSBRenewal.class.getName(), "Exception"});
            throw e;
        }
    }
