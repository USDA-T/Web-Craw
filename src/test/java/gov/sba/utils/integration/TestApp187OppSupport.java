...
public class TestApp187OppSupport extends TestCase {
	...
	public void testMainTest() throws Exception {
		...
		try {
			...
			TestuserProfileSearchType.TestuserProfileSearch(webDriver, "QA", "Opp_Support_Page_Vendor_Prof_Search",
					Expected_Result);
			// Click organization
			webDriver.findElement(By.xpath("//table/tbody/tr/td/a[contains(text(),'Business Name')]")).click();
			Expected_Result = "Vendor Support";
			String Actual_Result = webDriver.findElement(By.xpath("//div[@id='business_search']/div/div/a")).getText()
					.toString();
