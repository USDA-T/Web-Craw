...
public class TestUs801AmIEligibleTs10 extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(TestUs801AmIEligibleTs10.class.getName());
  ...
  public void testMainTest() throws Exception {
    try {
      ...
      String actual_error56 = webDriver
          .findElement(By.cssSelector("div.usa-width-one-third.grey-box-text > p")).getText();
      String expected_error56 =
      ...
      String actual_error58 =
          webDriver.findElement(By.xpath("//div[@id='am-i']/div[2]/div[3]/p")).getText();
      String expected_error58 =
      ...
      String expected_Text0 =
          "Yes, EDWOSB Federal Contract Program set-asides are available in your primary NAICS code.";
      ...
      wait.until(
          ExpectedConditions.elementSelectionStateToBe(By.cssSelector("#results > p"), false));
      String actual_Text04 = webDriver.findElement(By.cssSelector("#results > p")).getText();
      String expected_Text04 =
      ...
      String actual_Text01 =
          webDriver.findElement(By.cssSelector("#edwosb > div.eligible > p > b")).getText();
      String expected_Text01 =
          "Based on the information you provided, you may be eligible for the EDWOSB program.";
      ...
      // 8(a).
      String actual_Text02 =
          webDriver.findElement(By.xpath("//div[@id='eighta']/div/p/b")).getText();
      String expected_Text02 =
          "Based on the information you provided, you may be eligible for the 8(a) BD Program.";
      assertEquals(actual_Text02, expected_Text02);
      // Historically Underutilized Business Zone (HUBZone) Program.
      String actual_Text03 =
          webDriver.findElement(By.cssSelector("#hubzone > div.eligible > p > b")).getText();
