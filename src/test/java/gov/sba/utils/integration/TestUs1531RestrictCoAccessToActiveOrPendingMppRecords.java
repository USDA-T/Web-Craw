...
public class TestUs1531RestrictCoAccessToActiveOrPendingMppRecords extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        if (webDriver.getPageSource().contains("Welcome to certify.SBA.gov!")) {
            ...
            webDriver.findElement(By.id("find_business")).click();
            wait.until(ExpectedConditions.elementSelectionStateToBe(By.xpath(".//*[@id='no_vendor_found']/h3"), false));
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Entity 81 Legal Business Name")));
            ...
            webDriver.findElement(By.id("find_business")).click();
            wait.until(
                    ExpectedConditions.elementSelectionStateToBe(By.xpath("//div[@id='no_vendor_found']/h3"), false));
            Thread.sleep(2000);
