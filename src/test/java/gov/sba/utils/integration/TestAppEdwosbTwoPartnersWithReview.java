package gov.sba.utils.integration;
  ...
  public class TestAppEdwosbTwoPartnersWithReview extends TestCase {
      private static final Logger logger = LogManager.getLogger(TestAppEdwosbTwoPartnersWithReview.class.getName());
