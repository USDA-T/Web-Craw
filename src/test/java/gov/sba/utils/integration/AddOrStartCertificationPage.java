...
public class AddOrStartCertificationPage {
  ...
  private static final Logger logger = LogManager
      .getLogger(AddOrStartCertificationPage.class.getName());
  WebDriver webDriver;
  ...
  public void AddOrStartCertification() throws Exception {
    ...
    if (webDriver.getPageSource().contains("Active")) {
      ...
      Actual_Text = webDriver
          .findElement(By.xpath("//div[@id='certificate_choice']/fieldset/label[2]"))
          .getText();
      ...
      Actual_Text = webDriver
          .findElement(By.xpath("//article[@id='main-content']/section/article/div/div"))
          .getText();
