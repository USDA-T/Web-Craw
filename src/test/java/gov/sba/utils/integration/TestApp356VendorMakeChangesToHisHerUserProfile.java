...
public class TestApp356VendorMakeChangesToHisHerUserProfile extends TestCase {
	private static final Logger logger = LogManager.getLogger(TestApp356VendorMakeChangesToHisHerUserProfile.class.getName());
    ...
    public void testMainTest() throws Exception {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//article[@id='main-content']/div/div/div/div/h5")));        
