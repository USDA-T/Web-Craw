...
public class TestWorkflowAppOppSupportAdmin extends TestCase {
    ...
    @Test public void testWorkflowAppOppSupportAdmin() throws Exception {
        try {
            ...
            try {
                ...
                for (int row = 0; row < rows_count; row++) {
                    ...
                    for (int column = 0; column < columns_count; column++) {
                        ...
                        logger.info(
                            "Cell Value Of row number " + row + " and column number " + column
                                + " Is " + celtext);
                    }
                    logger.info("--------------------------------------------------");
                }
      ...
      /* App37 -vendor support link and changing the business type */
            try {
                ...
                new Select(find_Element(webDriver, "Ops_Support_Change_Business_Type"))
                    .selectByIndex(2);
        ...
        /* Verify the Business type is changes to Scorp[from LLC] */
                ...
                assertTrue(
                    find_Element(webDriver, "Vendor_Admin_Dashboard_More_Details_Id").getText()
      ...
      /* US1280 */
            ...
            try {
                ...
                @SuppressWarnings("static-access") String[][] areturned_Rows =
                    dbcall.queryForData(sql_query, 2, 3);
      ...
      /* US1280 -Opp Support Admin should be able to edit help page */
            String handle_Original = webDriver.getWindowHandle();
      /* Help Link- opp supp Staff cannot have edit functionality on Help Page */
            ...
            try {
                ...
                WebDriver webDriver1 =  webDriver.switchTo().window(webDriver.getWindowHandles().iterator().next());
                find_Element(webDriver1, "Main_Page_Help_Page_Link_Edit");
                webDriver1.close();
                /*Switch back to original browser (first window)*/
                webDriver.switchTo().window(handle_Original);
            } catch (Exception e) {
                logger.info("Test case failed-HelpPage_Edit funtionality");
                throw e;
