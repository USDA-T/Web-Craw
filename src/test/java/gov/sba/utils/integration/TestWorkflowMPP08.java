 ...
 * TestWorkflowMPP + 08- Vendor admin create MPP application with no size detemination,Active Agreement and without Needs
 * Analyst Review the Submitted MPP application, Supervisor approves it.
 */


@Category({StableTests.class}) public class TestWorkflowMPP08 extends TestCase {
    ...
    @Test public void testMainTest() throws Exception {
        try {
            ...
            take_ScreenShot_TestCaseName(webDriver,
                new String[] {"TestWorkflowMPP08", "Exception"});
            throw e;
