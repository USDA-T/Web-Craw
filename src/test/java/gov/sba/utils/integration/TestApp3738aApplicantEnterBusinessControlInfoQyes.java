...
public class TestApp3738aApplicantEnterBusinessControlInfoQyes extends TestCase {
  ...
  private static final Logger logger =
      LogManager.getLogger(TestApp3738aApplicantEnterBusinessControlInfoQyes.class.getName());
  ...
  public void testMainTest() throws Exception {
    ...
    logger.info(
        "As an 8(a) applicant, I want to enter my business' Control information on an 8(a) application");
    // Login to dashboard.
