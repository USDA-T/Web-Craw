...
public class delete {
    ...
    public void testMainTest() throws Exception {
        try{
            ...
            disAdvApp_CuurentHomeAddress_Page(webDriver, "mclean", "mclean", "AL", "10002", "USA", "01/01/2019");
            ...
            //disAdvApp_FinancialData_AddPerson(webDriver, "deepa", "Mahesh", "Owner", "123456789", "Married", "d@gmail.com", "m", "1", "MN", "1", "US", "1", "1");
