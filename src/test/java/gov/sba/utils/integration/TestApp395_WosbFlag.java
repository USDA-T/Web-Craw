...
public class TestApp395_WosbFlag extends TestCase {
	...
	public void testMainTest() throws Exception {
		...
		try {
			...
			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_201_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));

			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_202_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));

			CommonApplicationMethods.click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");

			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_203_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));

			CommonApplicationMethods.click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");

			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_204_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));

			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_205_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));

			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_206_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));

			CommonApplicationMethods.click_Element(webDriver, "EDWOSB_Questionnaire_Page_Commit");

			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_207_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));
			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_208_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));
			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_209_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));
			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_210_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));

			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_211_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));

			assertTrue(CommonApplicationMethods.find_Element(webDriver, "WOSB_Questionnaire_Page_Ans_212_N")
					.getAttribute("outerHTML").toLowerCase().contains("checked"));
