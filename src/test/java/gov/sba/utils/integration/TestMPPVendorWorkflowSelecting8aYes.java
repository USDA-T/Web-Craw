...
@Ignore
public class TestMPPVendorWorkflowSelecting8aYes extends TestCase {
        // verify App-220
        private static final Logger logger = LogManager.getLogger(TestMPPVendorWorkflowSelecting8aYes.class.getName());
        WebDriver webDriver;
        ...
        public void testMainTest() throws Exception {
            try {
                ...
                String stext = webDriver
                        .findElement(By.xpath("//h1[contains(text(),'Program Self-Certification Summary')]")).getText();
                logger.info(stext);
                ...
                CommonApplicationMethods.take_ScreenShot_TestCaseName(webDriver, new String[] {"TestMPPVendorWorkflowSelecting8aYes", "Exception"});
                throw e;
            }
        }
