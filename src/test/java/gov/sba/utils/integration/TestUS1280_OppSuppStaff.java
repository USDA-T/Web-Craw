...
public class TestUS1280_OppSuppStaff extends TestCase {
    ...
    public void testMainTest() throws Exception {
        try {
            ...
            TestuserProfileSearch(webDriver, returned_GovProfile_Rows[1][1], "OppSup_Dashboard_Govt_User_Radio_Bt",
                    Expected_Result);
            ...
            TestuserProfileSearch(webDriver, areturned_Rows[1][1], "OppSup_Dashboard_Vend_User_Radio_Bt",
                    Expected_Result1);
