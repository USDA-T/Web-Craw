...
import junit.framework.TestCase;
  ...
  public class Test1234EdwosbAddSecondPartnerAfterReview extends TestCase {
      private static final Logger logger = LogManager.getLogger(Test1234EdwosbAddSecondPartnerAfterReview.class.getName());
      ...
      SoleProprietorReturnCertFirstAndSecondPartnerAfterReview1Page soleProprietorReturnCertFirstAndSecondPartnerAfterReview = new SoleProprietorReturnCertFirstAndSecondPartnerAfterReview1Page(webDriver);
      soleProprietorReturnCertFirstAndSecondPartnerAfterReview.SoleProprietorReturnCertFirstAndSecondPartnerAfterReview1();
      logger.info("Success");
      }
      @After
