...
public class Test1234EdwosbAddSecondPartnerAfterReview extends TestCase {
  private static final Logger logger =
      LogManager.getLogger(Test1234EdwosbAddSecondPartnerAfterReview.class.getName());
  ...
  public void testMainTest() throws Exception {
    ...
    SoleProprietorReturnCertFirstAndSecondPartnerAfterReview1Page soleProprietorReturnCertFirstAndSecondPartnerAfterReview =
        new SoleProprietorReturnCertFirstAndSecondPartnerAfterReview1Page(webDriver);
