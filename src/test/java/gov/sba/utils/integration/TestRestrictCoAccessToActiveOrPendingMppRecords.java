...
public class TestRestrictCoAccessToActiveOrPendingMppRecords extends TestCase {
	...
	private static final Logger logger = LogManager
			.getLogger(TestRestrictCoAccessToActiveOrPendingMppRecords.class.getName());
	...
	public void testRestrictCoAccessToActiveOrPendingMppRecords() throws Exception {
		...
		if (webDriver.getPageSource().contains("Welcome to certify.SBA.gov!")) {
			...
			Expected_Text = "To get started, we'll need to know a little more about your role and responsibilities to grant you access.";
			assertEquals(Actual_Text, Expected_Text);
			webDriver.findElement(By.xpath("//li[3]/label")).click();
			...
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//li[2]/label")));
			webDriver.findElement(By.xpath("//li[2]/label")).click();
			// Click on i accept.
			jse.executeScript("arguments[0].scrollIntoView()", webDriver.findElement(By.xpath("//div/div/label")));
			webDriver.findElement(By.xpath("//div/div/label")).click();
			...
			Actual_Text = webDriver.findElement(By.linkText("EDWOSB")).getText();
			...
			jse.executeScript("arguments[0].scrollIntoView()",
					webDriver.findElement(By.id("contracting_officer_certification")));
			Thread.sleep(2000);
