...
public class TestWorkflowMPPVendorSelecting8aYes extends TestCase {
        // verify App-220
        private static final Logger logger = LogManager.getLogger(TestWorkflowMPPVendorSelecting8aYes.class.getName());
        WebDriver webDriver;
        ...
        public void testMainTest() throws Exception {
            try {
                ...
                CommonApplicationMethods.take_ScreenShot_TestCaseName(webDriver, new String[] {"TestWorkflowMPPVendorSelecting8aYes", "Exception"});
                throw e;
            }
        }
