...
public class Test1234WosbTestWithReview extends TestCase {
	...
	public void setUp() throws Exception {
		...
		get_The_Row_From_Login_Data = 97;
	}
	...
	public void test1234WosbTestWithReview() throws Exception {
		...
		try {
			...
			SignAndSubmitWOSBApplicationPage signAndSubmitWOSBApplication = new SignAndSubmitWOSBApplicationPage(
					webDriver);
