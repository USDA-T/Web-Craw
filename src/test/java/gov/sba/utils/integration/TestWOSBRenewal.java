...
public class TestWOSBRenewal extends TestCase {
  ...
  public void testMainTest() throws Exception {
    ...
    try {
      ...
      List<WebElement> count_Active = find_Elements_Locators(webDriver, "xpath",
      ...
      List<WebElement> count_ReNew = find_Elements_Locators(webDriver, "xpath",
      ...
      List<WebElement> count_Edwosb_Active = find_Elements_Locators(webDriver, "xpath",
      ...
      List<WebElement> count_Edwosb_Expire = find_Elements_Locators(webDriver, "xpath",
