...
public class TestWOSBRenewal extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        try {
            ...
            List<WebElement> count_Active = find_Elements_Locators(webDriver,"xpath","//table[@id='certifications']/tbody/tr[ td[1]/a[ contains(text(),'EDWOSB') ] and td[5][ contains(text(),'Active') ]]");
            ...
            List<WebElement> count_ReNew = find_Elements_Locators(webDriver,"xpath","//table[@id='certifications']/tbody/tr[ td[1]/a[ contains(text(),'EDWOSB') ] and td[7]/a[ contains(text(),'Renew')] ]");
            ...
            List<WebElement> count_Edwosb_Active = find_Elements_Locators(webDriver,"xpath","//table[@id='certifications']/tbody/tr[ td[1]/a[ contains(text(),'EDWOSB Self-Certification') ] and td[5][ contains(text(),'Active') ]]");
            assertTrue(count_Edwosb_Active.size() > 0);
            List<WebElement> count_Edwosb_Expire = find_Elements_Locators(webDriver,"xpath","//*[@id='certifications']/tbody/tr" + "["
