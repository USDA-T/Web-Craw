...
public class Test1234VendorMakeChangesToHisHerUserProfile extends TestCase {
	private static final Logger logger = LogManager
			.getLogger(Test1234VendorMakeChangesToHisHerUserProfile.class.getName());
	...
	public void test1234VendorMakeChangesToHisHerUserProfile() throws Exception {
		try {
			...
			webDriver.findElement(By.xpath("//li[6]/a/span")).click();
			...
			assertEquals(Actual_Text, Expected_Text);
			// Verify to make sure user cannot continue profile update with no
			// data.
			...
			Actual_Text = webDriver.findElement(By.xpath("//article[@id='main-content']/div/div/div/div/h5")).getText();
			Expected_Text = "2 errors prohibited this user from being saved:";
			assertEquals(Actual_Text, Expected_Text);
			Actual_Text = webDriver.findElement(By.xpath("//article/div/div/div/div/ul/li")).getText();
			Expected_Text = "First name can't be blank";
			assertEquals(Actual_Text, Expected_Text);
			Actual_Text = webDriver.findElement(By.xpath("//article/div/div/div/div/ul/li[2]")).getText();
