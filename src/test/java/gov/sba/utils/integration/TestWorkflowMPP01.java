...
@Category({gov.sba.utils.integration.StableTests.class}) public class TestWorkflowMPP01
    extends TestCase {
    ...
    @Test public void testMainTest() throws Exception {
      ...
      /* Supervisor Flow - Approve */
            ...
            if (stop_Exec == 1) {
                return;
            } /* TODO Remove Hard coded duns_Number */
            assertTrue(
            ...
            take_ScreenShot_TestCaseName(webDriver,
                new String[] {"TestWorkflowMPP01", "Exception"});
            throw e;
        }
    }
