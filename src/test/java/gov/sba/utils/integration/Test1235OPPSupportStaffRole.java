...
public class Test1235OPPSupportStaffRole extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        /*
         * Need to submit the application in EDWosb, Wosb,MPP Log in As
         * OppSupport Staft - validate as per the US1235 AC on Opp Support
         * Staft/Admin page
         */
        try {
            non_Vendor_searchDuns_Number(webDriver, "159165917"); // Opp Supp
                                                                  // Staft
                                                                  // search
                                                                  // vendor
                                                                  // records.
            click_Element(webDriver, "SBA_Business_Search_Business_Name"); // Click
                                                                           // on
                                                                           // the
                                                                           // Business
                                                                           // Name
            ...
            click_Element(webDriver, "Main_Page_Help_Page_Link"); // Help Link-
                                                                  // opp supp
                                                                  // Staff
                                                                  // cannot have
                                                                  // edit
            ...
            take_ScreenShot_TestCaseName(webDriver, new String[] { "Test1235OPPSupportStaffRole", "Exception" });
            throw e;
        }
    }
