...
public class TestMppBuildQuestionnaireTs3 extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        act4.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform(); // Management/Technical
                                                                                      // Needs
                                                                                      // Section,
                                                                                      // verifying
                                                                                      // questions.
        ...
        assertEquals(Actual_Text, Expected_Text);
            ...
            Expected_Text = "By submitting this certification I, QA User, am an officer or owner of Entity 179 Legal Business Name authorized to represent it and electronically sign this certification on its behalf.";
            assertEquals(Actual_Text, Expected_Text);
