...
public class SuperVisorReviewPage extends TestCase {
    ...
    public void testMainTest() throws Exception {
        try {
            ...
            List<WebElement> dropdown11 = new Select(webDriver.findElement(By.xpath("//select[@id='assessments__status']"))).getOptions();
            ...
            text_CheckBox_Labels = webDriver.findElement(By.xpath("//div[contains(@class,'review_main')]/form[@id='new_determination']/fieldset/ul/li[input[contains(@name,'review[workflow_state]')]]/label[contains(text(),'Determination Made')]")).getText();
            Assert.assertEquals(text_CheckBox_Labels, "Determination Made");

            text_CheckBox_Labels = webDriver.findElement(By.xpath("//div[contains(@class,'review_main')]/form[@id='new_determination']/fieldset/ul/li[input[contains(@name,'review[workflow_state]')]]/label[contains(text(),'Decision')]")).getText();
