...
public class LlcquestionsPage {
	...
	public void Llcquestions() throws Exception {
		...
		// continue.
		webDriver.findElement(By.xpath(".//*[@id='answers[78][value]']/label[2]")).click();
		webDriver.findElement(By.xpath(".//*[@id='answers_78_comment']")).sendKeys("Testing");
		webDriver.findElement(By.xpath(".//*[@id='answers[79][value]']/label[2]")).click();
		webDriver.findElement(By.xpath(".//*[@id='answers_79_comment']")).sendKeys("Testing");
		webDriver.findElement(By.xpath(".//*[@id='edwosb']/input[4]")).click();
		...
		// String
		assertElementpresent(webDriver.findElement(By.id("answers_99_value_new_button")));
		...
		// enter record2.
		String actual_Text51 = webDriver.findElement(By.cssSelector("div.DTE_Header_Content")).getText();
