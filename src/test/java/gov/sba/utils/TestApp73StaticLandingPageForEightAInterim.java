...
public class TestApp73StaticLandingPageForEightAInterim extends TestCase {
	private static final Logger logger = LogManager.getLogger(TestApp73StaticLandingPageForEightAInterim.class.getName());
	...
	public void testMainTest() throws Exception {
		...
		assertEquals(Actual_Text, Expected_Text);
		Actual_Text = webDriver.findElement(By.xpath("//article[@id='main-content']/div/section/article/p[2]")).getText();
		...
		assertEquals(Actual_Text, Expected_Text);
		WebElement QuideForCert = webDriver.findElement(By.cssSelector("div.textLayer > div"));
		HighLight.highLightElement(webDriver, QuideForCert);
		webDriver.close();
