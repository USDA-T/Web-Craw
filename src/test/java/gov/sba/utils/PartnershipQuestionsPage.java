...
public class PartnershipQuestionsPage {
	...
	public void Partnershipquestions() throws Exception {
		...
		String actual_Text51 = webDriver.findElement(By.cssSelector("fieldset > p")).getText();
		...
		// section.
		String actual_Text52 = webDriver.findElement(By.cssSelector("h2")).getText();
		String expected_Text52 = "Financial Data";
		assertEquals(actual_Text52, expected_Text52);
		String actual_Text53 = webDriver.findElement(By.cssSelector("p")).getText();
		...
		// enter record2.
		String actual_Text54 = webDriver.findElement(By.className("DTE_Header_Content")).getText();
		String expected_Text54 = "Create new record";
		...
		webDriver.findElement(By.cssSelector("#answers_100_value_no")).click();
		webDriver.findElement(By.cssSelector("#answers_100_value_no")).click();
