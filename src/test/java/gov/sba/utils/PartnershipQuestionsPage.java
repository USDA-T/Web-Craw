...
public class PartnershipQuestionsPage {
	...
	public void Partnershipquestions() throws Exception {
		...
		String actual_Text50 = mydriver.findElement(By.xpath("//li[@id='answers_partn_q1']/div/fieldset/legend"))
				.getText();
		...
		// String
		// actual_Text50=mydriver.findElement(By.cssSelector("p..firepath-matching-node")).getText();
