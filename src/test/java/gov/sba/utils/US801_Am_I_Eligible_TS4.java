...
public class US801_Am_I_Eligible_TS4 {
	...
	public void mainTest() throws Exception {
		...
		// page.
		logger.info("User is NOT eligible for Any of the programs (Due to NO for Qs3) 8(a), WOSB, EDWOSB & Hob-zone");
		...
		Thread.sleep(4000);
		webDriver.findElement(By.xpath(".//*[@id='for_profit']/div[1]/div[1]/div/button[2]")).click();
