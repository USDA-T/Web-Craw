...
public class TestUS1499TurnCaseReview extends TestCase {
     ...
     */
			...
			WebElement current_Row_EDWOSB_Link = current_Row_EDWOSB_Parent	.findElement(By.xpath("//td/a[contains(text(),'Entity ')]"));
			...
			WebElement current_Page_Title = webDriver.findElement(By.xpath(
		          "//article[@id='main-content']//h1[contains(text(),'Case Overview')]"));
