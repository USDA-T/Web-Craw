...
public class TestMppBuildQuestionnaireTs10 extends TestCase {

    private static final Logger logger = LogManager.getLogger(TestMppBuildQuestionnaireTs10.class.getName());
    ...
    public void testMainTest() throws Exception {
        ...
        act.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform(); // Eligibility
                                                                                     // Section,
                                                                                     // Verifying
                                                                                     // Question.
        ...
        act13.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
        ...
        act1.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
        ...
        act12.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
        ...
        Thread.sleep(2000);
        Actions act9 = new Actions(webDriver);
        act9.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
      ...
      Thread.sleep(3000);
        ...
        Actions act10 = new Actions(webDriver);
        act10.doubleClick(webDriver.findElement(By.id("answers_141_value_no"))).build().perform();
        Thread.sleep(2000);
        Actions act11 = new Actions(webDriver);
        act11.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
        ...
        assertEquals(Actual_Text, Expected_Text);
            ...
            act3.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
            Actual_Text = webDriver.findElement(By.id("duns-value-167-error")).getText();
            Expected_Text = "Please answer this question";
            assertEquals(Actual_Text, Expected_Text);
            Thread.sleep(2000);
            Actions act22 = new Actions(webDriver);
            act22.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
            ...
            act5.doubleClick(webDriver.findElement(By.className("usa-button"))).build().perform();
            logger.info(webDriver.switchTo().alert().getText());
            webDriver.switchTo().alert().accept();
