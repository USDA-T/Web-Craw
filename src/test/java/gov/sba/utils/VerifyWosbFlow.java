...
public class VerifyWosbFlow {
    ...
    public void VerifyWOSBFlowLogic() throws Exception {
        ...
        try {
            ...
            WebElement current_Row_Active = webDriver
                    .findElement(By.xpath("//article[@id='main-content']//td[contains(text(),'Active')]"));
            ...
            webDriver.findElement(By.xpath("//*[@id='query']"))
                    .sendKeys(LoginHelpers.getLoginDataWithIndex(10).getDunsNumber());
