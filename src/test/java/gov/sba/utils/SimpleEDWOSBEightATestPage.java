...
public class SimpleEDWOSBEightATestPage {
    private static final Logger logger = LogManager.getLogger(SimpleEDWOSBEightATestPage.class.getName());
    WebDriver webDriver;

    public SimpleEDWOSBEightATestPage(WebDriver webDriver) {
        this.webDriver = webDriver;
    }

    public void SimpleEDWOSBEightATest() throws Exception {
