	...
	import java.sql.*;
	 public class Test1235OppSuppAdminRole extends TestCase {
		...
		public void testMainTest() throws Exception {
			...
			// Log in As OppSupport Staft - validate as per the US1235 cceptance criteria
			...
			try {
				...
				WebElement business_Name=webDriver.findElement(By.xpath("//article[@id='main-content']/div[@id='business_search']//div[contains(@class,'business_search_result_per_entry')]//h4/a[contains(text(),'Legal Business Name')]"));
				business_Name.click();	
