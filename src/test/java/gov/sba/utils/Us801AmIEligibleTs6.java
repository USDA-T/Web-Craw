...
public class Us801AmIEligibleTs6 {
	...
	public void mainTest() throws Exception {
		...
		// page.
		logger.info("User is NOT eligible for Any of the programs (Due to NO for Qs5) 8(a), WOSB, EDWOSB & Hob-zone");
		...
		Thread.sleep(4000);
		webDriver.findElement(By.xpath(".//*[@id='us_business']/div[1]/div[1]/div/button[2]")).click();
