...
public class TestApp99App90App100 extends TestCase {
    ...
    public void testMainTest() throws Exception {
        ...
        AddOrStartEightACertificationPage addOrStartEightACertification = new AddOrStartEightACertificationPage(
                webDriver);
        ...
        assertEquals(Actual_Text, Expected_Text);
        // verify that 8(a) analyst sees only 8(a) application on the all case
        // page or can not access WOSB and MPP certs.
        webDriver.findElement(By.linkText("Cases")).click();
        // WOSB
        if (webDriver.getPageSource().contains("WOSB")) {
            logger.info(
                    "8(a) analyst could see or access application from WOSB vendor applicants, Responsibility Failed");
            webDriver.quit();
        } else {
            logger.info(
                    "8(a) analyst could not see or access application from WOSB vendor applicants, Responsibility Passed");
        }
        ...
        if (webDriver.getPageSource().contains("EDWOSB")) {
            logger.info(
                    "8(a) analyst could see or access application from EDWOSB vendor applicants, Responsibility Failed");
            webDriver.quit();
        } else {
            logger.info(
                    "8(a) analyst could not see or access application from EDWOSB vendor applicants, Responsibility Passed");
        }
        Actual_Text = webDriver.findElement(By.xpath("//div[@id='table-search']/table/tbody/tr/td[3]")).getText();
        ...
        if (webDriver.getPageSource().contains("MPP")) {
            logger.info(
                    "8(a) analyst could see or access application from MPP vendor applicants, Responsibility Failed");
            webDriver.quit();
        } else {
            logger.info(
                    "8(a) analyst could not see or access application from MPP vendor applicants, Responsibility Passed");
        }
        Actual_Text = webDriver.findElement(By.xpath("//div[@id='table-search']/table/tbody/tr/td[3]")).getText();
        Expected_Text = "MPP";
        assertNotSame(Actual_Text, Expected_Text);
        ...
        if (webDriver.getPageSource().contains("8(a) Document Upload")) {
            logger.info(
                    "8(a) analyst could see or access application from 8(a) Document Upload vendor applicants, Responsibility Passed");
            Actual_Text = webDriver.findElement(By.xpath("//div[@id='table-search']/table/tbody/tr/td[3]")).getText();
            Expected_Text = "8(a) Document Upload";
            assertEquals(Actual_Text, Expected_Text);
            ...
            logger.info(
                    "8(a) analyst could not see or access application from 8(a) Document Upload vendor applicants, Responsibility Failed");
        }
