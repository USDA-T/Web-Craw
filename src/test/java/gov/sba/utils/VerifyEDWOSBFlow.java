...
public class VerifyEDWOSBFlow {
  ...
  public void VerifyEDWOSBFlowLogic() throws Exception {
      ...
      Actual_Text = webDriver.findElement(By.xpath("//article[@id='main-content']//section/article/h1[contains(text(),'Start a new certification')]")).getText();
      ...
      try {
          WebElement ElementEDWOSBRadio = webDriver.findElement(By.xpath("//a[@class='delete-cert'][@data-method='delete'][text()='Delete']"));
     ...
     // WebElement LinkForCert = all_Cells.get(0).findElement(By.xpath("//a[text()='EDWOSB Self-Certification']"));
      WebElement LinkForDelete = all_Cells.get(3).findElement(By.xpath("//a[@class='delete-cert'][@data-method='delete'][text()='Delete']"));

      //logger.info(current_Row.GetParent());
      Boolean FlagForAddEDWOSBNotPresent = false;
      try {
          radio_Element = webDriver.findElement(By.xpath("//a[@class='delete-cert'][@data-method='delete'][text()='Delete']"));
          //webDriver.findElement(By.xpath("//a[@class='delete-cert' ][@data-method='delete'][text()='Delete']")).click();
      } catch (Exception e) {
