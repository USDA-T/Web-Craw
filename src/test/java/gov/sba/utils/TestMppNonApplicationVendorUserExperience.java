...
public class TestMppNonApplicationVendorUserExperience extends TestCase {
    ...
    private static final Logger logger = LogManager
            .getLogger(TestMppNonApplicationVendorUserExperience.class.getName());
    ...
    public void testMainTest() throws Exception {
        ...
        if (webDriver.getPageSource().contains("Active")) {
            ...
            Actual_Text = webDriver
                    .findElement(By.xpath(".//*[@id='main-content']/section/article[1]/div[1]/div[4]/div[3]/p[2]"))
                    .getText();
        ...
        // Verify that the top navigation link Certifications is changed to
        // Programs.
        ...
        if (webDriver.getPageSource().contains("Active")) {
            ...
            Actual_Text = webDriver.findElement(By.xpath("//article[@id='main-content']/div/section/article/h1[2]"))
                    .getText();
        ...
        // Click on the Business nav and select Manage employee access to verify
        // test Certification changed to programs.
        ...
        Thread.sleep(3000);
        // Verify that all text, certification on Home page is being changed to
        // Programs.
        Actual_Text = webDriver.findElement(By.cssSelector("div.usa-font-lead")).getText();
        ...
        // Verify opening text: words Certification has been updated to
        // programs.
        Actual_Text = webDriver.findElement(By.cssSelector("h1")).getText();
        ...
        // Verify the opening message, text Certification is being updated to
        // Programs.
        Actual_Text = webDriver.findElement(By.cssSelector("h1")).getText();
