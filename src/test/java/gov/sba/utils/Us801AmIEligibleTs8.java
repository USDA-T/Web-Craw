...
public class Us801AmIEligibleTs8 {
	...
	public void mainTest() throws Exception {
		...
		String actual_Text19 = webDriver.findElement(By.xpath("//div[@id='naics_fed_set_asides']/div/div/p")).getText();
		...
		// Verify the detail meaning.
		String actual_Text36 = webDriver.findElement(By.xpath("//div[@id='eighta_certified']/div/div[2]/ul/li[2]"))
				.getText();
		...
		String expected_Text39 = "Is the firm’s business address located in a HUBZone?";
		assertEquals(actual_Text39, expected_Text39);
		logger.info(" question was validated");
		// Verify the detail meaning.
		String actual_Text40 = webDriver.findElement(By.xpath("//div[@id='address_in_hubzone']/div/div[2]/ul/li"))
				.getText();
		...
		String actual_Text41 = webDriver.findElement(By.xpath("//div[@id='address_in_hubzone']/div/div[2]/ul/li[2]"))
				.getText();
