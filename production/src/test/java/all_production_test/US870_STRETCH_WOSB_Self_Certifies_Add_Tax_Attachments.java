...
public class US870_STRETCH_WOSB_Self_Certifies_Add_Tax_Attachments {
	...
	public void US870_STRETCH_WOSB_Self_Certifies_Add_Tax_Attachments_Setup() throws Exception {
		...
		File file = new File(
				"C:\\Users\\Derec Nguni\\Documents\\QA_Automation\\QA_Acceptance\\lib\\IEDriverServer32b.exe");
	...
	public void US870_STRETCH_WOSB_Self_Certifies_Add_Tax_Attachments_Maintest() throws Exception {
		...
		if (mydriver.getPageSource().contains("test pdf.pdf")) {
			System.out.println("attachment was successfully for the Net Worth question");
		} else {
			System.out.println("attachment Not was successfully for the Net Worth question");
			mydriver.quit();
		}
		...
		// section.
		String actual_Text49 = mydriver.findElement(By.xpath(".//*[@id='main-content']/h2")).getText();
		String expected_Text49 = "Financial Data";
		assertEquals(actual_Text49, expected_Text49);
		// Validate the Personal Information.
		String actual_Text50 = mydriver.findElement(By.xpath(".//*[@id='answers_owners']/div/fieldset/p[1]")).getText();
