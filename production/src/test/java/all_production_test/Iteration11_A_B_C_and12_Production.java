...
public class Iteration11_A_B_C_and12_Production {
	...
	@Before
	public void Iteration11_A_B_C_Production_Test1_setup() throws Exception {
	...
	@Test
	public void Iteration11_A_B_C_Production_Test1_mymaintest() throws Exception {
		...
		for (int k = 1; k < myRows; k++) {
			...
			if (mydriver.getPageSource().contains("Continue")) {
				mydriver.findElement(By.xpath(".//*[@id='dashboard-index']/div[4]/div[2]/table/tbody/tr/td[4]/a[2]"))
						.click();
			...
			// attached a document.
			mydriver.findElement(By.xpath(".//*[@id='answers[78][value]']/label[1]")).click();
			mydriver.findElement(By.xpath(".//*[@id='answers[18][attachment]']/div/label/div")).click();
			mydriver.findElement(By.xpath(".//*[@id='70832']/td[1]/input")).click();
			mydriver.findElement(By.xpath(".//*[@id='document_library_attach']")).click();
			Thread.sleep(4000);
			mydriver.findElement(By.xpath(".//*[@id='answers[79][value]']/label[1]")).click();
			mydriver.findElement(By.xpath(".//*[@id='answers[19][attachment]']/div/label/div")).click();
			Thread.sleep(4000);
			mydriver.findElement(By.xpath("(//input[@name='selector'])[8]")).click();

			Thread.sleep(3000);
			mydriver.findElement(By.xpath("(//button[@id='document_library_attach'])[2]")).click();
			Thread.sleep(3000);
	...
	@After
	public void Iteration11_A_B_C_Production_Test1_teardown() throws Exception {
		mydriver.quit();
	}
