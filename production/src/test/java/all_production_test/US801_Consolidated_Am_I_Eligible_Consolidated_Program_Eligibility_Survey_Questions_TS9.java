...
public class US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS9 {
	...
	public void US801_Consolidated_Am_I_Eligible_Consolidated_Program_Eligibility_Survey_Questions_TS9_MainTest()
		...
		System.out.println("User is eligible for ALL programs, 8(a), WOSB, EDWOSB & Hob-zone");
		...
		String actual_error10 = mydriver.findElement(By.xpath("//div[@id='for_profit']/div/div[2]/ul/li[2]")).getText();
		...
		String actual_error11 = mydriver.findElement(By.xpath("//div[@id='for_profit']/div/div[2]/ul/li[3]")).getText();
		...
		Thread.sleep(4000);
		// verify and click on the Yes button.
		mydriver.findElement(By.cssSelector(
		...
		String actual_Text13 = mydriver.findElement(By.xpath("//div[@id='us_business']/div/div[2]/p[2]")).getText();
		...
		String actual_Text16 = mydriver.findElement(By.xpath("//div[@id='small_naics']/div/div[2]/ul/li[2]")).getText();
		...
		String actual_Text22 = mydriver.findElement(By.xpath("//div[@id='naics_fed_set_asides']/div/div[2]/p[2]"))
				.getText();
		...
		String actual_Text23 = mydriver.findElement(By.xpath("//div[@id='naics_fed_set_asides']/div/div[2]/p[3]"))
				.getText();
		...
		mydriver.findElement(By.id("naics_code")).sendKeys("335932");
		// verify and click on the Yes button.
		mydriver.findElement(By.id("naics_button")).click();
		Thread.sleep(5000);
		// Locate the 9th question and select Yes and verify the More Detail
		// meaning of the question.
		String actual_Text24 = mydriver
				.findElement(By.cssSelector(
		...
		String actual_Text36 = mydriver.findElement(By.xpath("//div[@id='socially_disadvantaged']/div/div[2]/ul/li[2]"))
				.getText();
		...
		String actual_Text38 = mydriver.findElement(By.xpath("//div[@id='socially_disadvantaged']/div/div/ul/li[2]"))
				.getText();
		String expected_Text38 = "Asian Pacific American";
		assertEquals(actual_Text38, expected_Text38);
		String actual_Text39 = mydriver.findElement(By.xpath("//div[@id='socially_disadvantaged']/div/div/ul/li[3]"))
				.getText();
		String expected_Text39 = "Hispanic American";
		assertEquals(actual_Text39, expected_Text39);
		String actual_Text40 = mydriver.findElement(By.xpath("//div[@id='socially_disadvantaged']/div/div/ul/li[4]"))
				.getText();
		String expected_Text40 = "Native American";
		assertEquals(actual_Text40, expected_Text40);
		String actual_Text41 = mydriver.findElement(By.xpath("//div[@id='socially_disadvantaged']/div/div/ul/li[5]"))
				.getText();
		...
		String actual_Text46 = mydriver.findElement(By.xpath("//div[@id='eighta_certified']/div/div[2]/ul/li[2]"))
				.getText();
		...
		String actual_Text51 = mydriver.findElement(By.xpath("//div[@id='address_in_hubzone']/div/div[2]/ul/li[2]"))
				.getText();
		...
		String actual_Text54 = mydriver.findElement(By.xpath("//div[@id='employees_in_hubzone']/div/div[2]/ul/li[2]"))
				.getText();
		...
		Thread.sleep(4000);
		String actual_Text0 = mydriver.findElement(By.cssSelector("div.eligible > p > b")).getText();
		...
		String actual_Text5 = mydriver.findElement(By.cssSelector("#hubzone > div.eligible > p > b")).getText();
		...
		String actual_Text6 = mydriver.findElement(By.cssSelector("#wosb > div.eligible > p > b")).getText();
		...
		String actual_Text7 = mydriver.findElement(By.cssSelector("#edwosb > div.eligible > p > b")).getText();
